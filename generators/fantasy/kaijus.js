function generator$fantasy$kaijus() {
  const nm1 = ['Aby', 'Abys', 'Ae', 'Aeri', 'Aethe', 'Amphi', 'Ana', 'Anar', 'Aqu', 'Aqua', 'Ata', 'Ataxi', 'Au', 'Aura', 'Bar', 'Barba', 'Barbar', 'Bas', 'Bla', 'Bli', 'Boul', 'Bri', 'Bru', 'Bruta', 'Canni', 'Canniba', 'Carni', 'Cata', 'Catacly', 'Chao', 'Cin', 'Coba', 'Cobal', 'Cor', 'Corp', 'Cra', 'Crim', 'Cro', 'Crown', 'Cry', 'Cryo', 'Cryp', 'Crys', 'Daw', 'Dia', 'Diablo', 'Diabo', 'Diamo', 'Ebo', 'Ebon', 'Elec', 'Elepha', 'Elu', 'Em', 'Eme', 'Emera', 'Eter', 'Ethe', 'Ether', 'Eva', 'Fera', 'Fero', 'Fi', 'Fie', 'Fla', 'Fren', 'Fri', 'Fro', 'Garga', 'Gargan', 'Giga', 'Gigan', 'Gla', 'Grie', 'Grim', 'Gris', 'Griz', 'Hanniba', 'Infer', 'Iro', 'Ivo', 'Levi', 'Levia', 'Male', 'Malevo', 'Mas', 'Matri', 'Mon', 'Mons', 'Mour', 'Neth', 'Nethe', 'Obsi', 'Obsidi', 'Ony', 'Ore', 'Patri', 'Pha', 'Phan', 'Phanto', 'Phibi', 'Pri', 'Prima', 'Prime', 'Primi', 'Pyro', 'Ra', 'Rabi', 'Rava', 'Raz', 'Saphi', 'Sava', 'Scar', 'Sco', 'Scor', 'Scree', 'Sha', 'Shado', 'Sil', 'Slen', 'Som', 'Spec', 'Spi', 'Spiri', 'Stal', 'Sten', 'Ston', 'Stor', 'Storm', 'Sty', 'Su', 'Supre', 'Tacly', 'Talo', 'Ter', 'Thor', 'Thun', 'Tita', 'Titan', 'Tor', 'Tox', 'Tran', 'Tus', 'Ven', 'Veno', 'Vi', 'Vic', 'Vici', 'Vole', 'Vor', 'War'];
