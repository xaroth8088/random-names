export default function aliens() {
  ...
  const nm5 = ['b', 'd', 'g', 'gh', 'hr', 'ht', 'hn', 'hm', 'hz', 'hx', 'hq', 'k', 'ks', 'kx', 'lk', 'lz', 'lp', 'lt', 'm', 'mt', 'nt', 'p', 'pt', 'q', 'r', 'rs', 'rt', 'rq', 'rk', 'rc', 'rb', 'rd', 'sk', 't', 'th', 'ts', 'wth', 'x', 'z'];
  ...
  const nm8 = ['b', 'c', 'f', 'g', 'h', 'k', 'l', 'm', 'n', 'p', 'q', 'r', 's', 'w', 'bb', 'bl', 'cl', 'ff', 'fl', 'gl', 'gn', 'ks', 'll', 'lh', 'kh', 'bh', 'ch', 'dh', 'lm', 'ln', 'lph', 'ls', 'lf', 'mm', 'mn', 'ms', 'nn', 'ns', 'p', 'ph', 'ps', 'rf', 'ss', 'st', 'sh', 'th', 'ts', 's\'', 'l\'', 'n\'', 'm\'', 'f\'', 'h\''];
  const nm10 = ['', 'b', 'd', 'g', 'gh', 'h', 'hs', 'ht', 'hn', 'hm', 'hl', 'k', 'l', 'll', 'kh', 'lh', 'lm', 'ln', 'lph', 'ls', 'lf', 'm', 'mm', 'n', 'nn', 'ns', 'p', 'ms', 'ph', 'ps', 's', 'ss', 'sh', 'th', 'ts', 'w'];
  const nm11 = ['a', 'e', 'i', 'o', 'u', 'y', 'ae', 'ea', 'eo', 'oe', 'ie', 'ue', 'ua', '', '', '', '', '', '', '', '', '', '', '', ''];

  const nm12 = ['b', 'bl', 'br', 'c', 'ch', 'cl', 'cr', 'd', 'dr', 'f', 'fl', 'fr', 'g', 'gl', 'gn', 'gr', 'h', 'j', 'k', 'kl', 'km', 'kn', 'kr', 'm', 'n', 'p', 'ph', 'pl', 'pr', 'q', 'ql', 'qr', 'r', 's', 'sl', 'sr', 'st', 'str', 't', 'tl', 'tr', 'v', 'vl', 'vr', 'w', 'wr', 'x', 'xr', 'z', 'zr', '', '', '', '', '', '', ''];
  const nm13 = ['a', 'ae', 'au', 'e', 'ea', 'ei', 'eo', 'i', 'ie', 'o', 'oe', 'ou', 'u', 'ua', 'ue', 'uo', 'uy', 'y'];
  const nm14 = ['b', 'bb', 'bh', 'bl', 'br', 'c', 'ch', 'cl', 'cr', 'd', 'dd', 'dh', 'dr', 'f', 'ff', 'fl', 'g', 'gl', 'gn', 'gr', 'h', 'hh', 'hl', 'hm', 'hn', 'hs', 'hsh', 'j', 'k', 'k\'', 'kh', 'kk', 'km', 'kr', 'ks', 'l', 'lf', 'lh', 'll', 'lm', 'ln', 'lph', 'ls', 'm', 'mm', 'mn', 'ms', 'n', 'nn', 'ns', 'p', 'ph', 'pr', 'ps', 'q', 'q\'', 'qr', 'r', 'r\'', 'rf', 'rr', 's', 'sh', 'ss', 'st', 't', 't\'', 'th', 'tr', 'ts', 'tt', 'v', 'v\'', 'vr', 'vv', 'w', 'wr', 'x', 'x\'', 'xx', 'z', 'zz'];
