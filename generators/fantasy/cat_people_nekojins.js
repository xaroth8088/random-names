function generator$fantasy$cat_people_nekojins() {
  ...
  const nm3 = ['Aiko', 'Aki', 'Akira', 'Aoi', 'Asa', 'Ayame', 'Chi', 'Chie', 'Chikako', 'Dai', 'Daiki', 'Domo', 'Eiko', 'Eri', 'Fuyu', 'Haiku', 'Haru', 'Haruki', 'Haruko', 'Hikari', 'Hikaru', 'Hiro', 'Hiroki', 'Hisoka', 'Honcho', 'Hoshi', 'Hotaru', 'Isamu', 'Jun', 'Junko', 'Kabuki', 'Kaede', 'Kameko', 'Katsu', 'Katsumi', 'Kei', 'Keiko', 'Ken', 'Kin', 'Kio', 'Kioko', 'Kioshi', 'Ko', 'Kohaku', 'Kohana', 'Koko', 'Kou', 'Kyo', 'Kyoko', 'Leiko', 'Madoka', 'Maeko', 'Mai', 'Makoto', 'Masa', 'Masaaki', 'Masako', 'Masumi', 'Masuru', 'Matsui', 'Michi', 'Mika', 'Minoru', 'Mitsuru', 'Miyoshi', 'Momo', 'Nami', 'Nao', 'Naoki', 'Naoko', 'Nari', 'Nariko', 'Natsu', 'Nobu', 'Nori', 'Oki', 'Rei', 'Reiko', 'Rin', 'Ryoko', 'Saki', 'Shig', 'Shin', 'Sho', 'Sora', 'Suzaku', 'Taiki', 'Tanaka', 'Tora', 'Toshi', 'Usagi', 'Yoi', 'Yoko', 'Yori', 'Yoshi', 'Yuki', 'Yukiko', 'Yukio', 'Yumi', 'Yumiko'];
  const nm4 = ['ch', 'c', 'f', 'g', 'h', 'k', 'm', 'n', 'pr', 'r', 's', 'sh', 'th', 'x', 'z'];
  const nm5 = ['a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'ea', 'ia', 'au', 'iau', 'aa', 'ee', 'ie', 'y', 'y'];
  const nm6 = ['ch', 'c', 'f', 'fr', 'cr', 'k', 'ks', 'cs', 'kr', 'm', 'mm', 'mn', 'ms', 'mz', 'kz', 'n', 'nm', 'ns', 'nz', 'nx', 'nch', 'mch', 'pr', 'gr', 's', 'ss', 'sh', 'sz', 'shr', 'sr', 'th', 'tr', 't', 'x', 'z', 'zz', 'zs', 'zr', 'c', 'f', 'k', 'm', 'n', 's', 't', 'x', 'z', 'c', 'f', 'k', 'm', 'n', 's', 't', 'x', 'z'];
  const nm7 = ['', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'ea', 'ia', 'au', 'iau', 'aa', 'ee', 'ie', 'y', 'y'];
  const nm8 = ['', 'ch', 'c', 'f', 'fr', 'cr', 'k', 'ks', 'cs', 'kr', 'm', 'mm', 'mn', 'ms', 'mz', 'kz', 'n', 'nm', 'ns', 'nz', 'nx', 'nch', 'mch', 'pr', 'gr', 's', 'ss', 'sh', 'sz', 'shr', 'sr', 'th', 'tr', 't', 'x', 'z', 'zz', 'zs', 'zr', 'c', 'f', 'k', 'm', 'n', 's', 't', 'x', 'z', 'c', 'f', 'k', 'm', 'n', 's', 't', 'x', 'z'];
