export default function kobolds() {
  ...
  const nm4 = ['c', 'd', 'g', 'k', 'c', 'd', 'g', 'k', 'n', 'nk', 'ng', 'nd', 'r', 'rk', 'rc', 'rg', 's', 'sk', 'sz', 'x'];
  const nm5 = ['', '', '', 'b', 'bhr', 'bh', 'cy', 'cl', 'ch', 'chr', 'd', 'dh', 'g', 'gh', 'ghr', 'k', 'khr', 'kh', 'kn', 'kl', 'khn', 'sh', 'shr', 'sc', 'sl', 'sn', 'shn', 'sht', 'str', 'sz', 't', 'th', 'thr', 'v', 'vr', 'z', 'zh', 'zr'];
  const nm6 = ['a', 'e', 'i', 'a', 'e', 'i', 'a', 'e', 'i', 'a', 'e', 'i', 'a', 'e', 'i', 'a', 'e', 'i', 'a', 'e', 'i', 'a', 'e', 'i', 'o', 'u', 'o', 'o', 'u', 'u', 'ai', 'ei', 'ee', 'ea', 'aa'];
  const nm7 = ['b', 'bb', 'd', 'dd', 'g', 'gg', 'k', 'kk', 'r', 'rr', 'tt', 'zz', 'b', 'bb', 'd', 'dd', 'g', 'gg', 'k', 'kk', 'r', 'rr', 'tt', 'zz', 'b', 'bn', 'bb', 'd', 'dd', 'dj', 'dn', 'g', 'gg', 'gl', 'gn', 'gm', 'gr', 'ggn', 'ggv', 'gv', 'k', 'kk', 'kl', 'ks', 'ksh', 'kg', 'kn', 'lz', 'lv', 'lg', 'lgr', 'lkh', 'ldj', 'lbl', 'mg', 'mgl', 'mkh', 'mch', 'mdj', 'ms', 'msz', 'msr', 'ng', 'nd', 'ndr', 'ngd', 'ngl', 'nsh', 'nsz', 'r', 'rr', 'rg', 'rgl', 'rdh', 'rdj', 'rsz', 'rl', 'rkh', 'rch', 'th', 'tsz', 'thr', 'tt', 'zs', 'zsr', 'zhk', 'zkh', 'zz', 'zsz', 'zd'];
  const nm8 = ['', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'h', 'hl', 'hn', 'hs', 'l', 'n', 'ng', 's', 'y', 'z'];
  const nm9 = ['ash', 'barb', 'barbed', 'bitter', 'blood', 'bone', 'boulder', 'brew', 'brick', 'broad', 'bronze', 'brown', 'claw', 'cliff', 'coal', 'cold', 'common', 'coven', 'crag', 'crow', 'dark', 'dim', 'dust', 'ember', 'far', 'fern', 'fist', 'flask', 'flat', 'fog', 'fool', 'fore', 'full', 'gore', 'grass', 'gray', 'green', 'grey', 'grime', 'grumble', 'hard', 'haze', 'heavy', 'hill', 'horn', 'iron', 'keen', 'krag', 'large', 'lead', 'leather', 'lone', 'molten', 'moon', 'morning', 'mountain', 'mud', 'muk', 'nether', 'night', 'oat', 'orb', 'pale', 'pebble', 'pine', 'plate', 'rain', 'rapid', 'red', 'river', 'rock', 'rough', 'rumble', 'sharp', 'shatter', 'silent', 'simple', 'skull', 'spider', 'star', 'steel', 'stone', 'storm', 'stout', 'strong', 'tusk', 'wild', 'wind'];
  const nm10 = ['arm', 'ash', 'back', 'bane', 'bash', 'basher', 'belly', 'belt', 'bender', 'blade', 'blood', 'blower', 'bluff', 'bone', 'born', 'bough', 'bow', 'brace', 'branch', 'brand', 'breaker', 'breath', 'bringer', 'brow', 'buckle', 'buster', 'chaser', 'chest', 'chew', 'chewer', 'chin', 'claw', 'cleaver', 'coat', 'crag', 'crest', 'crusher', 'cut', 'cutter', 'delver', 'digger', 'drifter', 'dust', 'eye', 'eyes', 'fall', 'fang', 'feather', 'feet', 'finger', 'fist', 'flare', 'flaw', 'foot', 'gaze', 'gazer', 'grip', 'grog', 'guard', 'gut', 'hammer', 'head', 'hide', 'horn', 'hunter', 'jaw', 'lash', 'mail', 'mane', 'mark', 'master', 'maul', 'maw', 'pelt', 'punch', 'rage', 'ripper', 'runner', 'scar', 'seeker', 'snarl', 'snout', 'spine', 'splinter', 'stalker', 'stride', 'strike', 'surge', 'thorn', 'tongue', 'watcher', 'wound'];
  const nm11 = ['', '', '', '', '', 'b', 'bhr', 'cr', 'cl', 'ch', 'chr', 'd', 'g', 'ghr', 'k', 'kh', 'kn', 'sh', 'shr', 'sc', 'sn', 'str', 'sz', 'thr', 'v', 'vr', 'x', 'z', 'zr'];
