function generator$fantasy$centaurs() {
  ...
  const nm4 = ['aemon', 'aenon', 'aeon', 'aestus', 'aeus', 'agos', 'aios', 'anes', 'anos', 'antos', 'aon', 'arus', 'as', 'ates', 'atos', 'aumas', 'eas', 'eidon', 'er', 'erion', 'erus', 'es', 'etheus', 'etus', 'eus', 'ias', 'ibos', 'ion', 'ios', 'is', 'iton', 'ius', 'o', 'oeis', 'oeus', 'olus', 'on', 'onos', 'or', 'os', 'oteus', 'otos', 'otus', 'ous', 'us', 'yrus', 'ys', 'ytion'];
  const nm5 = ['bor', 'ban', 'bran', 'cron', 'carn', 'crin', 'dral', 'dor', 'dall', 'fin', 'furn', 'fan', 'gran', 'gone', 'glan', 'hum', 'hurn', 'harm', 'krol', 'kall', 'kule', 'lorn', 'lans', 'lath', 'moth', 'morn', 'merth', 'nirn', 'noth', 'nall', 'pas', 'poth', 'pos', 'rall', 'roth', 'rorn', 'sal', 'sor', 'sul', 'stral', 'storn', 'stag', 'thorn', 'tral', 'turn', 'vral', 'vor', 'vil', 'will', 'wor', 'warn', 'zran', 'zorn', 'zark'];
