function generator$fantasy$cavemens() {
  ...
  const nm3 = ['cr', 'cc', 'ch', 'd', 'dd', 'dr', 'dh', 'dv', 'g', 'gg', 'gr', 'gn', 'gv', 'gz', 'k', 'kn', 'kz', 'kv', 'kk', 'l', 'll', 'lr', 'lk', 'mg', 'mk', 'n', 'ng', 'nk', 'nd', 'nr', 'rg', 'rd', 'rb', 'rl', 'rr', 'rz', 'rv', 'rk', 'sk', 'sg', 'sv', 't', 'tk', 'tz', 'tt', 'v', 'vv', 'vr', 'vk', 'vd', 'z', 'zz', 'zk', 'zd', 'zc', 'zg'];
  const nm4 = ['', '', 'b', 'c', 'd', 'g', 'h', 'k', 'kk', 'lk', 'll', 'n', 'r', 'rc', 'rk', 'rv', 't'];
  const nm5 = ['', '', '', '', '', 'b', 'bh', 'c', 'ch', 'd', 'dh', 'f', 'fl', 'gh', 'gn', 'h', 'j', 'jh', 'l', 'm', 'n', 'r', 's', 'sc', 'sk', 'sn', 'st', 't', 'th', 'tr', 'ts', 'v', 'z'];
  const nm6 = ['a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'a', 'e', 'o', 'aa', 'ae', 'ai', 'ee', 'oe', 'ua'];
  const nm7 = ['b', 'b', 'd', 'd', 'g', 'g', 'k', 'k', 'l', 'l', 'n', 'n', 'r', 'r', 's', 's', 't', 't', 'z', 'z', 'b', 'b', 'd', 'd', 'g', 'g', 'k', 'k', 'l', 'l', 'n', 'n', 'r', 'r', 's', 's', 't', 't', 'z', 'z', 'b', 'br', 'bh', 'bn', 'bb', 'ch', 'cn', 'cl', 'cr', 'd', 'dd', 'dn', 'dl', 'fr', 'fn', 'fl', 'g', 'gg', 'gl', 'gn', 'gr', 'gy', 'k', 'kk', 'ky', 'kl', 'kn', 'km', 'l', 'll', 'lg', 'ly', 'ln', 'lm', 'lv', 'mg', 'ml', 'n', 'nn', 'ng', 'nk', 'nd', 'nz', 'r', 'rr', 'rb', 'rl', 'rt', 'rth', 's', 'sz', 'sr', 'st', 'sh', 'ss', 't', 'ty', 'yl', 'yr', 'yn', 'yg', 'yr', 'vr', 'vn', 'vl', 'vk', 'z', 'zh', 'zn'];
  const nm8 = ['', '', '', '', '', '', '', '', 'h', 'l', 'n', 's'];
  const nm9 = ['', '', '', 'br', 'bh', 'cr', 'd', 'dr', 'dh', 'fr', 'g', 'gr', 'gn', 'gh', 'j', 'kr', 'kh', 'n', 'r', 't', 'v', 'z', '', '', '', '', '', 'b', 'bh', 'c', 'ch', 'd', 'dh', 'f', 'fl', 'gh', 'gn', 'h', 'j', 'jh', 'l', 'm', 'n', 'r', 's', 'sc', 'sk', 'sn', 'st', 't', 'th', 'tr', 'ts', 'v', 'z'];
