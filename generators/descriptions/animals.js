export default function animals() {
  ...
  let names3 = [' bear', ' cat', ' cow', ' deer', ' dog', 'n elephant', ' fox', ' goat', ' hippo', ' horse', ' human', ' leopard', ' lion', ' mouse', ' pig', ' rabbit', ' rat', ' rhino', ' tiger', ' wolf'];
  ...
  let names11 = ['relatively small', 'relatively large', 'fairly small', 'fairly large', 'small, long', 'large, long', 'small, thin', 'large, wide', 'small, narrow', 'long, narrow'];
  ...
  const names17 = ['not that great', 'not very reliable', 'not impressive', 'a bit poor', 'not too great', 'lacking', 'underdeveloped', 'relatively poor'];
  ...
  let names25 = ['once a year', 'twice a year', 'once every two years', 'once every 18 months', 'once every three years', 'twice to three times a year', 'once or twice a year', 'once every nine to ten months', 'once every five years', 'once every four years'];
