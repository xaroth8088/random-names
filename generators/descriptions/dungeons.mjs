export default function dungeons() {
  ...
  const nm4 = ['large', 'small', 'massive', 'grand', 'modest', 'scanty', 'narrow'];
  const nm5 = ['broken', 'clammy', 'crumbling', 'damp', 'dank', 'dark', 'deteriorated', 'dusty', 'filthy', 'foggy', 'grimy', 'humid', 'putrid', 'ragged', 'shady', 'timeworn', 'weary', 'worn'];
  const nm6 = ['ash', 'bat droppings', 'broken pottery', 'broken stone', 'cobwebs', 'crawling insects', 'dead insects', 'dead vermin', 'dirt', 'large bones', 'moss', 'puddles of water', 'rat droppings', 'remains', 'roots', 'rubble', 'small bones'];
  const nm7 = ['a broken statue part of a fountain', 'a broken tomb', 'a pillaged treasury', 'an altar', 'an overgrown underground garden', 'broken arrows, rusty swords and skeletal remains', 'broken cages and torture devices', 'broken mining equipment', 'broken vats and flasks', 'carved out openings filled with pottery', 'cases of explosives and mining equipment', 'drawings and symbols on the walls', 'empty chests and broken statues', 'empty shelves and broken pots', 'locked chests, vats, crates and pieces of broken wood', 'prison cells', 'remnants of a small camp', 'remnants of sacks, crates and caskets', 'remnants of statues', 'remnants of what once must\'ve been a mess hall of sorts', 'remnants of what was once a decorated room with a now unknown purpose', 'rows of statues', 'rows of tombs and several statues', 'rows of vertical tombs', 'ruins of what seems to be a crude throne room', 'the remnants of a pillaged burial chamber', 'triggered traps and skeletal remains', 'warped and molten metal remnants', 'weapons racks and locked crates', 'what seems like some form of a sacrificial chamber'];
  const nm8 = ['is a single path', 'are two paths, you take the right', 'are two paths, but the right is a dead end', 'are two paths, you take the left', 'are two paths, but the left is a dead end', 'are three paths, you take the right', 'are three paths, you take the left', 'are three paths, you take the middle'];
  const nm9 = ['downwards', 'onwards', 'passed broken and pillaged tombs', 'passed collapsed rooms and pillaged treasuries', 'passed countless other pathways', 'passed countless rooms', 'passed long lost rooms and tombs', 'passed lost treasuries, unknown rooms and armories', 'passed pillaged rooms', 'passed several empty rooms'];
  const nm10 = ['clammy', 'crumbled', 'damp', 'dank', 'dark', 'dusty', 'filthy', 'foggy', 'ghastly', 'ghostly', 'grimy', 'humid', 'putrid', 'ragged', 'shady', 'timeworn', 'weary', 'worn'];
  ...
  const nm12 = ['advance carefully', 'carefully continue', 'cautiously proceed', 'continue', 'move', 'press', 'proceed', 'slowly march', 'slowly move', 'tread'];
  const nm13 = ['darkness', 'depths', 'expanse', 'mysteries', 'secret passages', 'secrets', 'shadows'];
  const nm14 = ['a few more passages', 'a few more rooms and passages', 'countless passages', 'dozens of similar rooms and passages', 'many different passages', 'many rooms and passages', 'various different rooms and countless passages', 'various passages'];
  const nm15 = ['A big', 'A grand', 'A huge', 'A large', 'A massive', 'A mysterious', 'A tall', 'A thick', 'A vast', 'A wide', 'An enormous', 'An immense', 'An ominous'];
  const nm16 = ['wooden', 'granite', 'metal'];
  const nm17 = ['some are dead ends, others lead to who knows where, or what', 'some have collapsed, others are dead ends or too dangerous to try', 'most of which are far too ominous looking to try out', 'most of which have collapsed or were dead ends to begin with', 'some of them have collapsed, others seem to go on forever', 'some are dead ends, others seem to have no end at all', 'each leading to who knows where, or what', 'most of which probably lead to other depths of this dungeon', 'most of which look just like the other', 'they all look so similar, this whole place is a maze', 'each seem to go on forever, leading to who knows what', 'some look awfully familiar, others stranger everything else', 'each with their own twists, turns and destinations', 'most lead to nowhere or back to this same path', 'it\'s one big labyrinth of twists and turns'];
  const nm18 = ['Ash and soot is', 'Countless odd symbols are', 'Countless runes are', 'Dire warning messages are', 'Dried blood splatters are', 'Intricate carvings are', 'Large claw marks are', 'Messages in strange languages are', 'Ominous symbols are', 'Strange writing is', 'Various odd symbols are'];
  const nm19 = ['did something just move behind this door?', 'you\'re sure you saw a shadow under the cracks of the door.', 'did the door just change its appearance?', 'what was that sound?', 'you\'re pretty sure you\'re being watched.', 'was that a growl coming from behind the door?', 'did somebody just knock on the door?', 'you hear the faint sound of footsteps behind you.', 'is that a scratching sound coming from behind the door?', 'you think you can hear a whisper coming from behind the door.', 'light\'s coming through the gap below the door.', 'you hear a loud bang in the distance from which you came.', 'you hear a faint laugh coming from behind the door.', 'suddenly the door slowly opens on its own.', 'something just grabbed your shoulder.'];
