function generator$descriptions$citys() {﻿
  ...
  const nm12 = ['Various cultures', 'New cultures', 'Many new cultures', 'A few new cultures', 'Countless cultures', 'Many different cultures'];
  const nm13 = ['the architecture', 'education', 'the city\'s development', 'business', 'the city\'s history', 'education', 'trade and relations', 'international relations', 'the city\'s people', 'the city\'s cuisine'];
  const nm14 = ['few differences', 'plain, ordinary people', 'little diversity', 'no variation', 'monotony', 'little contrast', 'few cultures', 'predictability'];
  const nm15 = ['a large melting pot', 'a fusion of everything', 'a new culture of variety', 'a multicultural hub', 'an amalgamation of differences'];
