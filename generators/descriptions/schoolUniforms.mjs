export default function schoolUniforms() {
  const nm1 = ['straight', 'striped', 'lined', 'finely striped',
    'thickly striped', 'plain', 'checkered', 'loose fitting', 'narrow fitting',
  ];
  const nm2 = ['Dacron', 'cotton', 'nylon', 'polycotton', 'polyester', 'cotton',
    'nylon'];
  const nm3 = ['down to about their calves and thus reveal',
    'down to just above', 'down to just under their knees, clearly revealing',
  ...
  const nm3s = ['loafers', 'single strap shoes', 'double strap shoes',
    'triple strap shoes', 'sporty loafers', 'lace-up shoes', 'slip-in shoes',
    'Chelsea boots'];
  const nm5 = ['almond', 'amber', 'apricot', 'aquamarine', 'auburn', 'azure',
    'baby blue', 'beige', 'black', 'bronze', 'brown', 'burgundy', 'cardinal',
    'cerulean', 'cobalt', 'crimson', 'denim', 'forest green', 'ginger',
    'indigo', 'jade', 'jasmine', 'jasper', 'khaki', 'lavender', 'lilac',
    'mahogany', 'maroon', 'navy', 'ochre', 'onyx', 'orchid', 'peach',
    'rosewood', 'russet', 'scarlet', 'sepia', 'sienna', 'sinopia',
    'tangerine', 'tawny', 'teal', 'vanilla', 'vermilion', 'viridian', 'wheat'];
  const nm6 = ['long', 'short', 'regular'];
  const nm7 = ['and a simple belt ', 'and a thick belt ',
    ' and a regular belt ', '', ''];
  const nm8 = ['A white', 'An almond', 'A beige', 'A cream', 'A floral white',
    'A ghost white', 'An ivory'];
  const nm8b = ['long sleeved', 'short sleeved', 'fairly short sleeved',
    'long sleeved'];
  const nm9 = ['neatly tucked into', 'gently tucked into',
    'almost perfectly tucked into', 'barely tucked into',
    'roughly tucked into', 'loosely hanging over', 'neatly hanging over',
    'playfully hanging over', 'somewhat messily hanging over',
    'carelessly hanging over'];
  const nm10 = ['basic', 'charming', 'classic', 'clear-cut', 'comfortable',
    'diligent', 'discrete', 'fairly long', 'fancy', 'formal', 'graceful',
    'heavy', 'humble', 'lavish', 'light', 'lined', 'long', 'loose',
    'luxurious', 'moderate', 'modest', 'mundane', 'narrow', 'navy', 'neat',
    'plain', 'regular', 'short', 'simple', 'slim', 'standard', 'stylish',
    'thick', 'thin', 'tight', 'wide'];
  const nm11 = ['long', 'short', 'thin', 'wide', 'narrow', 'slim', 'lean',
    'light', 'fine', 'broad'];
  const nm12 = ['splits right down', 'hangs gently in', 'playfully dangles in',
    'neatly rests in', 'divides', 'neatly splits', 'drops freely down',
    'hangs neatly in', 'playfully hangs in', 'hangs down', 'is tucked in',
    'is neatly tucked behind'];
  const nm13 = ['buttoned up', 'half buttoned up', 'unbuttoned',
    'mostly buttoned up', 'barely buttoned up', 'rarely buttoned up',
    'often unbottoned', 'half unbottoned'];
  const nm14 = ['striped', 'dotted', 'thinly striped', 'broadly striped',
    'thinly dotted', 'diagonally striped', 'horizontally striped',
    'vertically striped', 'gingerly dotted', 'moderately dotted', 'patterned',
    'checkered', 'broadly checkered', 'thinly checkered', 'crisscrossed',
    'broadly crisscrossed', 'thinly crisscrossed', 'plain and undecorated'];
  const nm15 = ['straight', 'circle', 'accordion', 'pleated', 'box pleated',
    'paneled', 'wrap', 'bubble', 'layered', 'tiered', 'pencil'];
  const nm16 = ['reach down to just above their calves',
    ...
    'reveal their legs from the knees down', 'just reveal their calves',
    'reach down to well below their knees',
    'dangle down to about their calves', 'reach to just above their ankles',
    'dangle down to about their ankles'];
  const nm16s = ['Mary Jane shoes', 'toe cap shoes', 'brogue shoes',
    'plimsolls', 'pumps', 'wedge shoes'];
  const nm17 = ['knee high', 'striped', 'dotted', 'crisscrossed', 'regular',
    'over the calf', 'thigh high'];
  const nm18 = ['while not mandatory', 'although slightly frowned upon',
    'although forbidden by regulations', 'while not really encouraged',
    'although discouraged by teachers', 'while it\'s completely up to them',
    'although completely optional', 'while up to their discretion',
    'although non-compulsory', 'although slightly disapproved'];
  const nm19 = ['school-colored', 'all sorts of', 'varied', 'matching',
    'uniform matching', 'various', 'distinct', 'individual', 'separate',
    'corresponding'];
  const nm20 = ['mostly as a form of self expression',
  ...
  const nm21 = ['are emblazoned with the school logo',
