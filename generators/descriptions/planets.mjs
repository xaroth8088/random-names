export default function planets() {
  ...
  const names1 = ['Omicron Persei 8', 'Amazonia', 'Wormulon', 'Eternium',
  ...
  const names2a = [', as it\'s called by most of the natives, ',
  ...
  const names3 = [];
  const names3a = [' terrestial', ' carbon', ' desert', 'n earth-like',
    'n iron', 'n ice'];
  const names3b = ['n ocean', ' gas dwarf', ' gas giant', ' rogue', 'n iron',
    'n ice', 'n ice giant', ' desert', ' terrestial'];
  const names3c = ['n ocean', ' terrestial', 'n iron', 'n earth-like', ' rogue',
    ' carbon', ' diamond', 'n ice', 'n ice giant', ' terrestial', 'n iron',
    'n earth-like', ' rogue', ' carbon', ' diamond', 'n ice', 'n ice giant',
  ...
  const names4 = ['a small solar system with ',
    ...
    'a fairly small solar system with ', 'a fairly large solar system with ',
    'a densely populated solar system with ',
    'a huge solar system filled with ', 'a vast solar system with '];
  let names5 = ['five', 'six', 'seven', 'eight', 'nine', 'ten'];
  let names6 = Math.random() * (maxSize - minSize) + minSize; // Size
  names6 = names6.toFixed(1);
  let names7 = Math.random() * (maxGrav - minGrav) + minGrav; // Gravity
  names7 = names7.toFixed(2);
  let names8 = Math.random() * 40 + 10; // Day Length
  names8 = names8.toFixed(2);
  ...
  const names14 = [' circular orbit', 'n almost perfectly circular orbit',
    ' slightly elliptic orbit', ' wide, elliptic orbit', 'n elliptic orbit',
  ...
  if (random4 > 3) {
    names5 = ['twelve', 'thirteen', 'fourteen', 'fifteen', 'sixteen',
