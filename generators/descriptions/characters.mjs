function charactersMale() {
  ...
  let names4 = ['thin', 'chiseled', 'craggy', 'fine', 'fresh', 'full', 'furrowed', 'handsome', 'sculpted', 'weak', 'strong', 'long', 'round', 'bony', 'lean', 'skinny', 'fat'];
  const names5 = ['time-worn', 'cheerful', 'friendly', 'charming', 'radiant', 'warm', 'anguished', 'menacing', 'lively', 'tense', 'wild', 'gloomy', 'frowning', 'worried', 'sad', 'lived-in'];
  const names6 = ['Beady', 'Big, round', 'Bloodshot', 'Bright', 'Bulging', 'Clear', 'Dancing', 'Darting', 'Dead', 'Expressive', 'Gentle', 'Glinting', 'Glistening', 'Glittering', 'Heavy', 'Hollow', 'Hooded', 'Lidded', 'Narrow', 'Piercing', 'Round', 'Shining', 'Shuttered', 'Small', 'Smart', 'Sparkling', 'Squinting', 'Wide', 'Woeful'];
  let names7 = ['blue', 'brown', 'hazel', 'black', 'green', 'amber', 'gray'];
  const names8 = ['deep', 'narrowly', 'buried', 'far', 'rooted', 'well', 'low', 'high', 'sunken', 'lightly', 'thightly', 'graciously', 'concealed', 'delicately', 'elegantly', 'handsomely', 'a-symmetrically', 'gracefully', 'seductively', 'appealingly', 'charmingly', 'dreadfully', 'wickedly'];
  ...
  let names16 = ['a pleasant memory', 'an aching memory', 'a burning memory', 'a stinging memory', 'a tormenting memory', 'an aching burden', 'a stinging burden', 'a tormenting burden', 'a painful burden', 'a lasting punishment', 'a lasting burden', 'an amusing memory', 'a delightful memory', 'a gracious memory', 'a pleasurable memory', 'a bittersweet memory', 'a heartbreaking memory', 'an agonizing memory', 'a grievous memory', 'a beautiful memory', 'a satisfying memory', 'a fascinating memory', 'a captivating memory', 'an intriguing memory', 'a compelling memory'];
  let names17 = ['a former life', 'a great reputation', 'a new life', 'a reclaimed home', 'an unusual alliance', 'battles long forgotten', 'battles past', 'companionship', 'deceased love', 'deceased loved ones', 'defended homes', 'defended honor', 'defended lands', 'departed love', 'departed loved ones', 'famed glory', 'forbidden adventures', 'forbidden love', 'former lives', 'former love', 'fortunate adventures', 'heroic liberations', 'hidden talents', 'his adventurous love life', 'his ex-love', 'his former lover', 'his fortunate destiny', 'his fortunate past', 'his fortunate survival', 'his fortunate upbringing', 'his love', 'his luck in battles', 'his luck in love', 'his luck', 'his reckless luck', 'his unfortunate past', 'his unfortunate upbringing', 'innocence long lost', 'lands long forgotten', 'liberated love', 'lost comrades', 'lost friends', 'lost honor', 'lost love', 'reclaimed honor', 'reclaimed lands', 'redeemed honor', 'redeemed love', 'redemption', 'restored honor', 'return to home', 'true friendship', 'unexpected friendship', 'unfortunate adventures'];
  let names18 = ['Adam', 'Adan', 'Addison', 'Brock', 'Brodie', 'Brody', 'Brooks', 'Bruce', 'Bruno', 'Bryan', 'Bryant', 'Bryce', 'Brycen', 'Bryson', 'Byron', 'Cade', 'Caden', 'Cael', 'Caiden', 'Cale', 'Gunnar', 'Irving', 'Isaac', 'Jamal', 'Jamar', 'Kade', 'Maverick', 'Max', 'Orion', 'Orlando'];
  let names19 = ['Adwell', 'Afton', 'Barnett', 'Barney', 'Barnfield', 'Chilson', 'Chilton', 'Cawthorn', 'Davenport', 'Davey', 'Dallin', 'Eustice', 'Eustis', 'Evatt', 'Falcon', 'Faley', 'Falkner', 'Geary', 'Gedman', 'Gedney', 'Hanshaw', 'Hansley', 'Hanson', 'Lamkin', 'Lamkins', 'Lamm', 'Lockridge', 'Locks', 'Lockwood', 'Masser', 'Massey', 'Massingale', 'Rosemond', 'Shepherd', 'Shepley', 'Wakeley', 'Wakelin'];
  const names20 = ['hero', 'friend', 'leader', 'pioneer', 'romancer', 'fortune-hunter', 'explorer', 'daredevil', 'globetrotter', 'mercenary', 'dreamer', 'visionary', 'idealist', 'genius', 'champion', 'master', 'prodigy', 'spectacle', 'guardian', 'angel', 'paladin', 'warrior', 'hunter', 'warden', 'defender', 'sentinel', 'victor', 'winner', 'challenger', 'ally', 'protector', 'vanquisher', 'vindicator', 'romanticist', 'stargazer', 'nobleman', 'utopian', 'adventurer', 'opportunist', 'pioneer'];
  const names21 = ['humans', 'humans', 'humans', 'humans', 'elves', 'night elves', 'blood elves', 'high elves', 'wood elves', 'dark elves', 'gnomes', 'trolls', 'orcs', 'goblins', 'dwarves', 'giants', 'halflings', 'vampires', 'werewolves'];
  const names22 = ['tall among', 'short among', 'towering among', 'towering above', 'tall above', 'big among', 'high among', 'small among', 'average among', 'ordinary among', 'common among', 'oddly among', 'awkwardly among', 'gracefully among', 'graciously among', 'elegantly among', 'easily among', 'tiny among', 'seductively among', 'alluringly among'];
  const names23 = ['thin', 'big', 'fragile', 'delicate', 'lean', 'narrow', 'skinny', 'slim', 'light', 'subtle', 'scraggy', 'bulky', 'heavy', 'hefty', 'athletic', 'brawny', 'sturdy', 'strong', 'muscled', 'tough'];
  const names24 = ['alluring', 'ambiguous', 'appealing', 'bewildering', 'bizarre', 'captivating', 'charming', 'curious', 'different', 'enigmatic', 'enthralling', 'enticing', 'extraordinary', 'fascinating', 'incomprehensible', 'inexplicable', 'intriguing', 'irregular', 'misleading', 'mystifying', 'obscure', 'odd', 'puzzling', 'seductive', 'wonderful'];
...
function charactersFemale() {
  ...
  let names10 = ['village', 'city', 'lands', 'people', 'town', 'families', 'ships', 'armies', 'homes', 'castle', 'palace', 'natives', 'wildlife', 'farms', 'country', 'haven', 'mountains', 'rivers', 'river', 'sea', 'woods', 'wastelands', 'clan', 'folk', 'tribe', 'ancestors', 'children', 'deserts', 'mines', 'spirits', 'stronghold'];
  const names11 = ['protected', 'sworn to protect', 'come to love', 'loved', 'fought for', 'bled for', 'nearly died for', 'looked after', 'cared for', 'defended', 'safeguarded', 'kept safe', 'watched over', 'stood guard for', 'come to appreciate', 'grown affactionate of', 'become enchancted by', 'worshipped', 'befriended', 'grieved with', 'shown mercy on', 'sought solace in', 'felt at home at', 'rarely felt at home at', 'barely related to', 'disassociated with', 'felt disconnected from', 'have been seperated from', 'been seperated from', 'been isolated from'];
  const names12 = ['A scar', 'Scars', 'A sword left a mark', 'A gunshot left a mark', 'Fallen debry left a mark', 'Fire has left a mark', 'A birthmark', 'An old tattoo', 'A tattoo', 'Tribal marks', 'Several moles', 'Freckles', 'Smooth skin', 'Soft skin', 'Fair skin'];
  let names13 = ['stretching from just under the right eye', 'stretching from just under the left eye', 'stretching from just under the right eyebrow', 'stretching from just under the left eyebrow', 'stretching from just under the right eye', 'stretching from the top of the right cheek', 'stretching from the top of the left cheek', 'stretching from the bottom of the right cheek', 'stretching from the bottom of the left cheek', 'stretching from the bottom of the right cheekbone', 'stretching from the bottom of the left cheekbone', 'stretching from the right side of the forehead', 'stretching from the left side of the forehead', 'reaching from just under the right eye', 'reaching from just under the left eye', 'reaching from just under the right eyebrow', 'reaching from just under the left eyebrow', 'reaching from just under the right eye', 'reaching from the top of the right cheek', 'reaching from the top of the left cheek', 'reaching from the bottom of the right cheek', 'reaching from the bottom of the left cheek', 'reaching from the bottom of the right cheekbone', 'reaching from the bottom of the left cheekbone', 'reaching from the right side of the forehead', 'reaching from the left side of the forehead'];
  let names14 = [', running across the nose', ', running towards the other eye', ', first running towards thin lips', ', first running towards her fairly big lips', ', running towards the right side of her lips', ', running towards the left side of her lips', ', running towards the tip of the nose', ', running towards her left nostril', ', running towards her right nostril', ', running towards her upper lip'];
  let names15 = ['and ending on her left cheek', 'and ending on her left cheekbone', 'and ending on her right cheek', 'and ending on her right cheekbone', 'and ending on her upper lip', 'and ending on her chin', 'and ending on her forehead', 'and ending on her right nostril', 'and ending on her left nostril', 'and ending under her left eye', 'and ending under her right eye', 'and ending above her right eye', 'and ending above her left eye'];
  let names16 = ['a pleasant memory', 'an aching memory', 'a burning memory', 'a stinging memory', 'a tormenting memory', 'an aching burden', 'a stinging burden', 'a tormenting burden', 'a painful burden', 'a lasting punishment', 'a lasting burden', 'an amusing memory', 'a delightful memory', 'a gracious memory', 'a pleasurable memory', 'a bittersweet memory', 'a heartbreaking memory', 'an agonizing memory', 'a grievous memory', 'a beautiful memory', 'a satisfying memory', 'a fascinating memory', 'a captivating memory', 'an intriguing memory', 'a compelling memory'];
  ...
  let names18 = ['Allyson', 'Allyssa', 'Camille', 'Camryn', 'Daphne', 'Elyse', 'Elyssa', 'Emily', 'Faith', 'Jayde', 'Julie', 'Juliet', 'Kylee', 'Melinda', 'Melissa', 'Sarina', 'Sasha'];
  let names19 = ['Adwell', 'Afton', 'Barnett', 'Barney', 'Barnfield', 'Chilson', 'Chilton', 'Cawthorn', 'Davenport', 'Davey', 'Dallin', 'Eustice', 'Eustis', 'Evatt', 'Falcon', 'Faley', 'Falkner', 'Geary', 'Gedman', 'Gedney', 'Hanshaw', 'Hansley', 'Hanson', 'Lamkin', 'Lamkins', 'Lamm', 'Lockridge', 'Locks', 'Lockwood', 'Masser', 'Massey', 'Massingale', 'Rosemond', 'Shepherd', 'Shepley', 'Wakeley', 'Wakelin'];
