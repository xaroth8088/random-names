export default function battlefields() {
  ...
  let rnd27b = Math.floor(Math.random() * nm27.length);
  while (rnd27b === rnd27a) {
    rnd27b = Math.floor(Math.random() * nm27.length);
  }
  let rnd27c = Math.floor(Math.random() * nm27.length);
  while (rnd27c === rnd27a || rnd27c === rnd27b) {
    rnd27c = Math.floor(Math.random() * nm27.length);
  }
  const rnd28a = Math.floor(Math.random() * nm28.length);
  let rnd28b = Math.floor(Math.random() * nm28.length);
  while (rnd3b === rnd3a) {
    rnd28b = Math.floor(Math.random() * nm28.length);
  }
  let rnd28c = Math.floor(Math.random() * nm28.length);
