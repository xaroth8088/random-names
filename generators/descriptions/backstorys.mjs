export default function backstorys() {
    ...
    let nm3 = ['anxious', 'arrogant', 'bewildered', 'bossy', 'conceited', 'confused', 'facetious', 'foolish', 'greedy', 'grouchy', 'harsh', 'ignorant', 'immature', 'impatient', 'impulsive', 'jealous', 'lonely', 'mean', 'naive', 'nervous', 'opinionated', 'pompous', 'rash', 'restless', 'rude', 'selfish', 'snobbish', 'stubborn', 'timid', 'uncontrolled'];
    const nm4 = ['This is to be expected from somebody', 'But what\'d you expect from somebody', 'This isn\'t surprising considering for someone', 'Which isn\'t out of the ordinary for someone', 'But this is all just a facade, a mechanism to deal', 'But there\'s more than this to somebody', 'But there\'s more than meets the eye, not surprising for somebody'];
    let nm5 = ['n average', ' wealthy', ' royal', 'n ordinary', ' fairly rich', ' high class', ' middle class', ' loving', ' large', ' small', ' decent', ' successful'];
    let nm6 = ['n average', ' normal', ' large', ' wealthy', ' major', 'n important', ' merchant', ' developing', ' developed'];
    const nm7 = ['town', 'city', 'village', 'port', 'community', 'capital'];
    const nm8 = ['without worry', 'out of trouble', 'free of worries', 'free of trouble', 'in peace', 'comfortably', 'happily'];
    let nm9 = Math.floor(Math.random() * 10) + 10;
    let nm10 = ['things changed', 'things began to change', 'life changed', 'life began to change'];
    let nm11 = ['gained responsibilities', 'gained new responsibilities', 'became more important', 'became more important to society', 'got an important job', 'started to travel a lot', 'started to travel the world', 'started to experience the world', 'started working for the family company', 'studied a lot', 'went to college', 'explored the country', 'moved out', 'moved in with a friend', 'did volunteering work', 'did a lot of small jobs', 'moved to another country', 'became a travelling adventurer', 'went on an adventure', 'improved upon existing powers', 'got a new pet', 'got a new companion'];
    let nm12 = ['among the most popular people', 'becoming quite desirable', 'very successful', 'growing up fast', 'meeting a lot of influential people', 'making many new friends', 'learning a lot of new skills', 'gaining a little fame', 'making some great new friends', 'about to meet \'Mr(s). Right\'', 'learning a new language', 'becoming more cultured', 'slowly improving upon existing skills', 'learning how to cook in new styles', 'strengthening the relationships with friends', 'strengthening the relationship with both parents', 'competing in large tournaments'];
    let nm12b = ['managed to bloom', 'succeeded', 'managed to thrive', 'boomed', 'went beyond expectations', 'reached for the stars', 'lives the dream', 'blossomed', 'reached the top', 'made a fortune', 'fulfilled dreams', 'thrived', 'enjoys life', 'loves life', 'struggles to make it', 'is going on a journey', 'is part of an adventure', 'is trying to reach the top', 'is unstoppable', 'is on top of the world', 'is exploring new areas', 'is discovering hidden secrets', 'is discovering hidden treasures', 'is venturing out', 'is trying to help others'];
    let nm13 = ['With the support of great friends', 'With the support of great parents', 'With plenty of money and connections', 'Alongside great friends', 'With amazing, new friends', 'With a great deal of determination', 'With determination and some luck', 'Alongside trusted friends', 'With a great companion', 'Through hard work', 'Through plenty of trial and error', 'By never giving up', 'After an astonishing adventure', 'With the help of great friends', 'Having overcome plenty of obstacles'];
    let nm14 = ['strange', 'weird', 'crazy', 'ever changing', 'fast', 'fast changing', 'amazing', 'fantasy', 'fantastic', 'wacky', 'absurd', 'strange', 'mad', 'wild', 'remarkable', 'wonderful', 'outlandish', 'astonishing', 'extraordinary', 'mystifying'];
    let nm15 = ['bravery', 'brilliance', 'capability', 'charm', 'compassion', 'curiosity', 'determination', 'diligence', 'eagerness', 'sense of humor', 'wits', 'cunning', 'perseverance', 'persistence', 'skills', 'powers', 'talents', 'wisdom', 'intrepidness', 'honesty'];
    let nm16 = ['reaching great success', 'finding a way to the top', 'fulfilling all dreams', 'accomplish all goals', 'improving the world', 'going beyond expectations', 'climbing to the top', 'staying ahead of the game', 'reaching full potential', 'doing anything'];
    let nm17 = ['a force to be reckoned with', 'a true inspiration for many', 'a true friend for life', 'an ally you\'d want by your side', 'somebody we can expect great things of', 'somebody who could change the world', 'a great leader, perhaps even of the nation', 'an unstoppable force', 'a friend you\'d want by your side', 'a person of (great) importance'];
    let nm18 = ['Despite all this success,', 'However,', 'But there may be more to it than this;', 'But for now that\'s speculation;', 'But only time will tell;', 'But who really knows what will happen;', 'But anything could happen;', 'But things could change quickly;'];
    let nm19 = ['searching for a higher purpose', 'still studying', 'enjoying the simpler life', 'having fun with friends', 'travelling the world', 'exploring everything', 'still growing up and learning new things', 'still finding the right place in the world', 'still looking for a true calling', 'still trying to perfect skills', 'improving upon skills and talents', 'learning how to reach full potential', 'enjoying the world and its beauty', 'looking for a place to truly call home', 'still learning, exploring and discovering'];
