export default function weapons() {
  ...
  const nm3 = ['straight', 'smooth', 'slightly curved', 'warped', 'curved',
    'jagged', 'barbed'];
  const nm4 = ['ceramic', 'diamond', 'copper', 'bronze', 'glass', 'ivory',
    'silver', 'adamantium', 'cystal', 'folded steel', 'iron', 'mithril',
    'obsidian', 'steel', 'titanium'];
  const nm5 = ['common', 'dull', 'elegant', 'expensive', 'extravagant',
    'extremely rare', 'fairly common', 'gilded', 'high quality', 'lavish',
    'low-cost', 'ordinary', 'rare', 'regular', 'strange', 'uncommon'];
  const nm6 = ['black', 'bronze', 'brown', 'dark brown', 'deep orange',
    'emerald green', 'forest green', 'gold colored', 'green', 'grey', 'ivory',
    'jade green', 'light brown', 'maroon', 'navy blue', 'onyx', 'red',
    'royal blue', 'ruby red', 'sapphire blue', 'scarlet', 'white'];
  const nm7 = ['bear leather', 'boar hide', 'buffalo skin', 'cow leather',
    'crocodile leather', 'deerskin', 'goat leather', 'pig leather',
    'ray skin', 'salmon leather', 'scaled leather', 'shark skin',
    'smooth leather', 'snake leather', 'sting ray leather', 'wolf leather'];
  const nm8 = ['One sharp edge', 'A single, sharp edge',
    'With just one razor-sharp edge', 'Because its sharp on just one edge',
    'With a single, sharp edge', 'A sharp, dual-edged blade',
    'The sharp, dual-edged blade', 'Dual-edged and razor-sharp',
    'With its sharp, dual-edged blade', 'Because its sharp on both its edges',
    'A fine, sharp point', 'The razor-sharp point',
  ...
  const nm9 = [
    ...
    'makes this weapon the best choice if you want to pierce, prick, puncture and peforate your enemies.',
    'this weapon is the ideal choice to turn your enemies into Swiss cheese. ',
    'this weapon will make sure your enemies are full of holes with deadly speed and precision.',
    'this weapon will cause your enemies to leak from thousands of holes before they even know what happened.',
  ];
  const nm10 = ['small', 'thin', 'narrow', 'wide', 'broad', 'large', 'barbed',
    'jagged', 'spiked'];
  ...
  const nm13 = ['a simple', 'a plain', 'a basic', 'an intricate',
    ...
    'a jeweled', 'a gilded'];
  const nm14 = ['sphere', 'curl', 'coil', 'twist', 'loop', 'orb', 'ring',
    'cross', 'dragon head', 'lion head', 'bear paw', 'hawk beak', 'eye',
    'wolf head', 'skull', 'flame', 'eagle wing', 'horn', 'bear head',
    'lion paw', 'panther head', 'claw', 'tooth', 'crow head', 'fish scale',
    'snake head', 'owl head', 'dragon tail', 'snake', 'spider'];
  const nm15 = ['which is common on many weapons',
    ...
    'this weapon is clearly meant to be taken care of with dedication',
    'a unique design for a unique weapon'];
  ...
  const nm19 = ['a symbol one can be proud of', 'a symbol of true greatness',
    'a symbol many are jealous of', 'a famous symbol and rightfully so',
    ...
    'fine details which prove how carefully this weapon was crafted',
    'this weapon is clearly meant for an important figure'];
  const nm20 = ['bare', 'simple', 'fairly simple', 'unadorned', 'engraved',
    'engraved'];
  const nm21 = ['No markings can be found',
    'No decorations or engraved patterns',
    'No markings, no decorations and no engravings',
    'No decorations of any sorts are on it',
    'Several runes are etched into the blade',
    'A line of text is engraved on the blade',
    'Seemingly strange markings are carved into the blade',
    'Ancient symbols are engraved on the blade',
  ...
  const nm22 = [
    ...
    '. While the hilt is as elegant as its owner, the blade has to be as strong as its owner',
    ', the blade needs no decorations, it only needs to be strong and sharp',
    '. A seathed sword has a hidden blade and a sword in use will be dirty and bloody, so only the hilt needs decorations',
    ...
    '. This weapon is clearly a priced possession owned by somebody important',
    '. A weapon this magnificent is not meant for battle',
    ', which further adds to the uniqueness of this valuable weapon',
    ', which hints at the purpose, as well as the age of this elegant weapon',
    '. This weapon must be old and incredibly valuable, who knows what it has seen',
    ', which just shows how special this weapon truly is',
    '. This weapon is no ordinary weapon, that much is clear',
    '. This weapon and its master are both famous and infamous throughout the world',
    '. This weapon is feared and admired throughout the lands and rightfully so',
    '. You would not want to meet this blade, let alone its owner, in battle'];
  const nm23 = ['only during celebrations', 'only during special occassions',
    'only on rare occassions', 'only for ceremonial purposes',
    'only as a bragging object', 'only as a decorational piece',
    'only as a display of wealth', 'by royalty and the noble',
    'only by those with vast amounts of wealth', 'by just about anybody',
    'by anybody with a decent amount of money', 'the lower ranked guards',
    'by the royal guard', 'by higher ranked guards',
    'by champions and proven fighters'];
  const nm24 = ['A decent weapon which serves its purpose',
    'Whatever the purpose of its owner, this weapon will be sufficient',
    'A respectable weapon for mostly respectable people',
    ...
    'Perhaps not great in battle, but definitely great at showing off wealth and power',
    'An exceptional weapon carried by exceptional people, for better and worse',
