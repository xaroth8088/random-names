export default function weapons() {
  ...
  const nm4 = ['ceramic', 'diamond', 'copper', 'bronze', 'glass', 'ivory', 'silver', 'adamantium', 'cystal', 'folded steel', 'iron', 'mithril', 'obsidian', 'steel', 'titanium'];
  const nm5 = ['common', 'dull', 'elegant', 'expensive', 'extravagant', 'extremely rare', 'fairly common', 'gilded', 'high quality', 'lavish', 'low-cost', 'ordinary', 'rare', 'regular', 'strange', 'uncommon'];
  const nm6 = ['black', 'bronze', 'brown', 'dark brown', 'deep orange', 'emerald green', 'forest green', 'gold colored', 'green', 'grey', 'ivory', 'jade green', 'light brown', 'maroon', 'navy blue', 'onyx', 'red', 'royal blue', 'ruby red', 'sapphire blue', 'scarlet', 'white'];
  const nm7 = ['bear leather', 'boar hide', 'buffalo skin', 'cow leather', 'crocodile leather', 'deerskin', 'goat leather', 'pig leather', 'ray skin', 'salmon leather', 'scaled leather', 'shark skin', 'smooth leather', 'snake leather', 'sting ray leather', 'wolf leather'];
  const nm8 = ['One sharp edge', 'A single, sharp edge', 'With just one razor-sharp edge', 'Because its sharp on just one edge', 'With a single, sharp edge', 'A sharp, dual-edged blade', 'The sharp, dual-edged blade', 'Dual-edged and razor-sharp', 'With its sharp, dual-edged blade', 'Because its sharp on both its edges', 'A fine, sharp point', 'The razor-sharp point', 'With a point as sharp as a razor', 'With just a razor-sharp point', 'Because it only has a razor-sharp point'];
  const nm9 = ['makes this weapon ideal for both blocking and slicing, your enemies won\'t stand a chance.', 'makes this a perfect weapon to block attacks and slice enemies to tiny, little pieces.', 'makes sure this weapon is not just for hacking and slashing, but also great to block incoming attacks.', 'this weapon is ideal for both cleaving enemies as well as blocking their attacks.', 'this weapon will protect you from incoming blows while also giving you the ability to shred your enemies to pieces.', 'this weapon is the perfect choice for slicing and dicing while also offering you a way to effectively block attacks.', 'makes this weapon the best choice for both cleaving and stabbing your enemies with ferocious power.', 'makes this the ideal weapon if you\'re looking to slice, dice, stab and jab your enemies.', 'makes this weapon the choice for any warrior looking for a versatile weapon ideal for any combat style.', 'this weapon will slice, dice, stab and jab your enemies and shred whatever\'s left of them.', 'this weapon is the champion\'s choice. It\'ll crush your enemies with cleaving hacks and piercing stabs.', 'this weapon makes for the best choice for those looking for power, versatility and general awesomeness.', 'makes this weapon ideal to pierce your enemies and turn them into a sieve.', 'makes this weapon a perfect choice if you wish to puncture your enemies to death with ruthless speed and precision.', 'makes this weapon the best choice if you want to pierce, prick, puncture and peforate your enemies.', 'this weapon is the ideal choice to turn your enemies into Swiss cheese. ', 'this weapon will make sure your enemies are full of holes with deadly speed and precision.', 'this weapon will cause your enemies to leak from thousands of holes before they even know what happened.'];
  const nm10 = ['small', 'thin', 'narrow', 'wide', 'broad', 'large', 'barbed', 'jagged', 'spiked'];
  const nm11 = ['slightly curved', 'straight', 'curved', 'warped', 'twisted', 'curled'];
  const nm12 = ['just large enough to protect the owner\'s fingers', 'just large enough to prevent it from slipping from your hands', 'just large enough to make sure your fingers are safe and the blade will remain firmly in your hands', 'just large enough to give the blade the perfect weight balance', 'offering just enough protection to the owner\'s hands, as well as adding a weight balance to the blade', 'offering plenty of protection to the owner\'s hands and thus his or her life', 'adding weight to the blade for a better weight balance, as well as offering hand protection during battle', 'creating the ideal weight balance to allow for smooth and accurate swings with this blade', 'adding just enough weight to make sure the blade sits firmly in the owner\'s hand and protecting those same hands as well', 'which makes sure the blade is both balanced and capable of protecting the owner\'s hands against any sliding sword'];
  const nm13 = ['a simple', 'a plain', 'a basic', 'an intricate', 'an elaborate', 'a decorative', 'a lavish', 'an ornamented', 'an elegant', 'a jeweled', 'a gilded'];
  const nm14 = ['sphere', 'curl', 'coil', 'twist', 'loop', 'orb', 'ring', 'cross', 'dragon head', 'lion head', 'bear paw', 'hawk beak', 'eye', 'wolf head', 'skull', 'flame', 'eagle wing', 'horn', 'bear head', 'lion paw', 'panther head', 'claw', 'tooth', 'crow head', 'fish scale', 'snake head', 'owl head', 'dragon tail', 'snake', 'spider'];
  ...
  if (rnd8 === 0 || rnd8 === 1) {} else if (rnd8 > 1 && rnd8 < 5) {} else if (rnd8 === 5 || rnd8 === 6) {} else if (rnd8 > 6 && rnd8 < 10) {} else if (rnd8 === 10 || rnd8 === 11) {} else {}
  ...
  if (rnd17 < 2) {} else if (rnd13 < 3) {} else {}
  if (rnd18 < 4) {
    if (rnd13 < 3) {} else {}
  } else if (rnd13 < 3) {} else {}
  const rnd20 = Math.floor(Math.random() * nm20.length);
  if (rnd20 < 4) {} else {}
  if (rnd21 < 4) {
    if (rnd13 < 3) {} else {}
  } else if (rnd21 < 12 && rnd21 > 3) {} else if (rnd21 > 11) {}
  if (rnd22 < 6) {} else if (rnd22 < 11 && rnd22 > 5) {} else if (rnd22 > 10 && rnd22 < 16) {} else if (rnd22 > 15 && rnd22 < 22) {} else {}
  if (rnd23 < 3) {} else if (rnd23 > 2 && rnd23 < 9) {} else if (rnd23 > 8 && rnd23 < 12) {} else {}
