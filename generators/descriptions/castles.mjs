export default function castles() {
  const nm1 = ['Four', 'Five', 'Six', 'Seven', 'Eight', 'Nine', 'Ten', 'Eleven',
    'Twelve', 'Thirteen', 'Fourteen', 'Fifteen'];
  const nm2 = ['broad', 'lean', 'massive', 'narrow', 'skinny', 'slim', 'solid',
    'strong', 'thick', 'thin'];
  const nm3 = ['round', 'square'];
  const nm4 = ['piercing the sky are the first you\'ll see of this castle',
  ...
  const nm5 = ['big', 'enormous', 'fairly low', 'fortified', 'giant', 'high',
    'huge', 'large', 'lower', 'reinforced', 'strengthened', 'tall', 'towering',
  ];
  const nm6 = ['thick', 'massive', 'chunky', 'heavy', 'solid', 'firm', 'thin',
    'narrow', 'wide', 'vast'];
  const nm7 = ['basalt', 'black stone', 'blue stone', 'bronze stone',
    'brown stone', 'dark brown stone', 'dark green stone', 'dark grey stone',
    'dark red stone', 'golden stone', 'granite', 'green stone', 'grey stone',
    'light brown stone', 'light green stone', 'light grey stone',
    'light pink stone', 'light red stone', 'obsidian', 'red stone',
    'sandstone', 'silver stone', 'white marble', 'white stone', 'yellow stone',
  ];
  const nm8 = ['Small', 'Tall', 'Wide', 'Tall, wide', 'Stylish', 'Refined',
    'Elegant', 'Simple', 'Grand', 'Ornate', 'Crude', 'Dull', 'Rough'];
  const nm9 = ['generously across the walls in a seemingly random pattern',
  ...
  const nm10 = ['holes of various sizes', 'symmetric holes', 'same-sized holes',
    'small holes', 'symmetric crenelations', 'asymmetric crenelations',
    'overhanging crenelations', 'huge crenelations'];
  const nm11 = ['sizable', 'huge', 'moderate', 'regular', 'great', 'vast'];
  const nm12 = ['broad', 'colossal', 'enormous', 'giant', 'great', 'heavy',
    'hefty', 'huge', 'large', 'massive', 'tall', 'thick', 'wide'];
  const nm13 = ['metal', 'wooden'];
  const nm14 = [', a draw bridge', ', a regular bridge', ''];
  const nm15 = ['hot oil pots', 'archer holes', 'a moat', 'strong defenses',
    'large crenelations', 'various artillery equipment'];
  const nm16 = ['guards the only easy way across the river',
