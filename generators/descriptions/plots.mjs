export default function plots() {
  const nm1 = ['calm', 'carefree', 'casual', 'fast-paced', 'hectic',
    'laid-back', 'nonchalant', 'normal', 'ordinary', 'peaceful', 'quiet',
    'relaxed', 'rough', 'secluded', 'smooth', 'stable', 'stressful',
    'unexciting'];
  const nm2 = ['teenage girl', 'young girl', 'woman', 'girl', 'elderly woman',
    'man', 'boy', 'teenage boy', 'young guy', 'elderly man'];
  const nm3 = ['is going the complete opposite way', 'changes in an instant',
    'changes for better or worse', 'is going in a different direction',
    'will change forever', 'might be changing forever',
    'has a chance to change, for better or worse,',
    'will be changed completely', 'take a sharp turn',
    'might turn out differently', 'will be permanently altered'];
  const nm4 = ['strange man', 'strange woman', 'lost friend', 'strange girl',
    'strange boy', 'new friend', 'childhood friend', 'friendly acquaintance',
    'neighbor', 'stranger'];
  let nm5 = ' his ';
  const nm6 = [
  ...
  const nm7 = ['Unsure about everything, including',
  ...
  const nm8 = ['hesitantly', 'cautiously', 'somewhat reluctantly', 'warily',
    'tentatively', 'somewhat hesitantly', 'somewhat grudgingly',
    'somewhat keenly', 'oddly enthusiastically', 'hastily', 'oddly willingly',
    'unusually eagerly', 'somewhat gladly'];
  const nm9 = ['if only to satisfy the nagging feeling of curiosity',
  ...
  const nm10 = ['can\'t be trusted', 'is trying to manipulate the situation',
    'is not speaking the truth', 'is just a crazy person',
    'cannot be relied upon', 'speaks only lies', 'is a con artist',
    'is trying be misleading', 'is wrong about all this', 'is pulling a prank',
  ];
  const nm11 = ['all this is an elaborate trap',
    'the complete opposite is true', 'everything told is completely true',
    'this is all far bigger than what has been told',
    'the situation has changed or will change', 'there\'s a change of mind',
  ...
  const nm12 = ['be this important to the situation',
    'be needed for a situation like this',
    'be this lucky, or unlucky, depending on the turnout',
    'end up in a situation like this', 'play a part in all this',
  ...
  const nm13 = ['Time will tell', 'Only one way to find out',
    'We\'re about to find out', 'No turning back now though',
    'Time to find out', 'Either way, the choice has been made'];
