function generator$descriptions$houses() {
  ...
  const nm20 = ['two bedrooms', 'three bedrooms', 'four bedrooms', 'five bedrooms'];
  const nm21 = ['a small', 'a large', 'a cozy', 'a snug', 'a spacious', 'a modest', 'a grand', 'a roomy'];
