export default function towns() {
  ...
  const names4 = ['village', 'town', 'city', 'metropolis', 'hamlet', 'megalopolis', 'outpost', 'port', 'township', 'settlement', 'crossroad', 'burg'];
  let names5 = ['Barnemouth', 'Paethsmouth', 'Pernrith', 'Perthlochry', 'Pitmerden', 'Coalfell', 'Cullfield', 'Darkwell', 'Deathfall', 'Doonatel', 'Dry Gulch', 'Easthaven', 'Ecrin', 'Erast', 'Far Water', 'Firebend', 'Fool\'s March', 'Frostford', 'Goldcrest', 'Goldenleaf', 'Greenflower', 'Garen\'s Well', 'Haran', 'Hillfar', 'Hogsfeet', 'Hollyhead', 'Hull', 'Hwen'];
  const names6 = ['humans', 'elves', 'orcs', 'dwarves', 'fairies', 'trolls', 'vampires', 'werewolves', 'humans', 'humans', 'humans', 'night elves', 'blood elves', 'gnomes', 'goblins', 'high elves', 'wood elves', 'dark elves', 'halflings', 'giants', 'pirates', 'barbarians', 'vikings'];
  let names7 = ['Agent', 'Baron', 'Captain', 'Chief', 'Colonel', 'Commander', 'Director', 'Duchess', 'Duke', 'Earl', 'General', 'Governor', 'Judge', 'Knight', 'Lady', 'Lord', 'Major', 'Marshal', 'Master', 'Mayor', 'Minister', 'Mr.', 'Mrs.', 'Ms.', 'Officer', 'Ruler', 'Sergeant', 'Supervisor', 'Warlord'];
  let names8 = ['Adwell', 'Ady', 'Afton', 'Barnett', 'Barney', 'Barnfield', 'Chilson', 'Chilton', 'Cawthorn', 'Davenport', 'Davey', 'Dallin', 'Eustice', 'Eustis', 'Evatt', 'Falcon', 'Faley', 'Falkner', 'Geary', 'Gedman', 'Gedney', 'Hanshaw', 'Hansley', 'Hanson', 'Lamkin', 'Lamkins', 'Lamm', 'Lockridge', 'Locks', 'Lockwood', 'Masser', 'Massey', 'Massingale', 'Rosemond', 'Shepherd', 'Shepley', 'Wakeley', 'Wakelin'];
  const names9 = ['magical properties', 'fertile soils', 'ancient histories', 'a cultural history', 'hidden secrets', 'healing properties', 'an abundance of minerals', 'a dark history', 'rare resources', 'precious gems', 'ancient burial grounds', 'old tombs', 'a broken, hidden library', 'an ancient water source', 'dark ruins', 'rare plants', 'medicinal plants', 'strong metal ores', 'natural defences', 'hidden tunnels', 'ambush positions', 'escape routes', 'an abundance of wildlife', 'ancient, lost technologies', 'a comfortable weather system', 'unique wildlife', 'spiritual significance', 'ancestral grounds', 'ancient, unexplained statues', 'body enhancing properties'];
  const names10 = ['n advancing', ' booming', ' breaking', ' damaged', ' declining', ' developing', ' failing', ' feeble', ' flourishing', ' growing', ' healthy', ' hurting', 'n improving', ' mending', ' poor', ' progressing', ' prospering', ' prosperous', ' thriving', ' tormented', ' troubled', 'n unhealthy', ' wounded'];
  ...
  const names17 = ['gorgeous', 'beautiful', 'majestic', 'elegant', 'glorious', 'impressive', 'flamboyant', 'luxuriant', 'stunning', 'impressive', 'delightful', 'graceful', 'magnificent', 'imposing', 'sublime', 'grandiose', 'humble', 'crude', 'rough', 'mediocre', 'dull', 'plain', 'ordinary', 'hideous', 'gruesome', 'dreadful', 'macabre', 'ghastly', 'unattractive', 'unexciting', 'worn', 'mundane'];
  let names18 = ['oak wood', 'maple wood', 'yew wood', 'cypress wood', 'pine wood', 'spruce  wood', 'redwood', 'ash wood', 'birch wood', 'blackwood', 'ebony wood', 'elm wood', 'ironwood', 'mahogany wood', 'silky oak wood', 'willow wood', 'bamboo', 'tatchet', 'shingle', 'slate tile', 'wheat straw', 'seagrass', 'ceramic tile', 'copper'];
