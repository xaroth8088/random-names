export default function houses() {
  const nm1 = ['magnificent', 'cozy', 'warm and cozy', 'stylish',
    'very elegant', 'gorgeous', 'grandiose', 'impressive', 'lavish',
    'snug and comfortable', 'intimate and cozy', 'luxurious',
    'posh and extravagant', 'nice and traditional', 'old, but wonderful'];
  const nm2 = ['blue stones', 'bricks covered in render', 'brown bricks',
    'brown stones', 'burgandy bricks', 'cypress wood', 'fir wood',
    'grey bricks', 'grey stones', 'oak wood', 'poplar wood', 'red bricks',
    'red pine wood', 'sandstone', 'spruce wood', 'tan bricks', 'tan stones',
    'walnut wood', 'wheat colored bricks', 'white bricks', 'white cedar wood',
    'white pine wood', 'white stones', 'wood covered in render',
    'yellow pine wood'];
  const nm3 = ['blue stone', 'brown brick', 'brown stone', 'burgandy brick',
    'cypress wooden', 'fir wooden', 'grey brick', 'grey stone', 'oak wooden',
    'poplar wooden', 'red brick', 'red pine wooden', 'sandstone',
    'spruce wooden', 'tan brick', 'tan stone', 'marble', 'granite',
    'mahogany wooden', 'walnut wood', 'white brick', 'white cedar wooden',
    'white pine wooden', 'white stone', 'yellow pine wooden'];
  const nm4 = ['Tall, large', 'Tall, wide', 'Short, wide', 'Small, rounded',
    'Tall, rounded', 'Small, squared', 'Tall, squared', 'Small, rectangular',
    'Tall, rectangular', 'Small, half rounded', 'Tall, half rounded',
    'Small, octagon', 'Large, octagon', 'Small, triangular',
    'Large, triangular'];
  const nm5 = ['let in plenty of light', 'brighten up the house',
    'add to the overall style of the house',
    'add to the overall look of the house',
    'allow enough light to enter the home'];
  const nm6 = ['in a very symmetric way', 'in a mostly symmetric way',
    'in a very asymmetric way', 'in a mostly asymmetric way',
    'in a fairly symmetrical pattern', 'in a fairly asymmetrical pattern'];
  const nm7 = ['shaped like a T', 'shaped like an L', 'shaped like a short U',
    'shaped like a squared S', 'square shaped', 'rectangular shaped',
    'fairly rounded in shape', 'shaped like a circle'];
  const nm8a = [
  ...
  const nm8c = ['The two extensions are linked by a patio',
  ...
  const nm8e = ['The house is half surrounded by a patio',
  ...
  const nm9 = ['bigger than the first', 'smaller than the first',
    'the same size as the first'];
  const nm10a = ['which creates a stylish overhang around the entire house',
  ...
  const nm10b = ['which allowed for a large balcony on one side of the house',
  ...
  const nm10c = ['which has been built exactly on top of the floor below it',
    'but part of it hangs over the edge of the floor below, creating an overhang on one side and a balcony on the other',
  ];
  const nm11 = ['follows the same style as',
    'has a slightly different style than', 'has a different style than',
    'has a very different style than', 'has roughly the same style as'];
  const nm12 = ['high and triangular', 'low and triangular',
    'high and pyramid shaped', 'low and pyramid shaped', 'flat',
    'low and slanted to one side', 'high and slanted to one side',
    'high, triangular and layered', 'low, triangular and layered',
    'high, triangular, but one side is longer than the other',
    'low, triangular, but one side is longer than the other',
    'high and v-shaped', 'low and v-shaped', 'low and square shaped',
    'high and square shaped', 'high and rounded', 'low and rounded'];
  const nm13 = ['black ceramic tiles', 'black roof tiles',
    'brown ceramic tiles', 'brown roof tiles', 'brown wood shingles',
    'dark ceramic tiles', 'flat roof tiles', 'grey ceramic tiles',
    'grey roof tiles', 'grey wood shingles', 'overlapping roof tiles',
    'red ceramic tiles', 'red roof tiles', 'red wood shingles',
    'rounded roof tiles', 'seagrass', 'slate shingles', 'stone slabs',
    'wheat straw', 'wood shingles'];
  const nm14 = ['One large chimney pokes out the center of the roof',
  ...
  const nm17 = ['a large', 'a small', 'a modern', 'a huge', 'an average',
    'an old-fashioned'];
  const nm18 = ['two bathrooms', 'one large bathroom', 'one small bathroom',
    'one average bathroom', 'one modern bathroom', 'two modern bathrooms',
    'three bathrooms'];
  const nm19 = ['large', 'cozy', 'small', 'warm', 'huge', 'fairly small',
    'comfortable', 'snug', 'generous', 'spacious'];
  const nm20 = ['two bedrooms', 'three bedrooms', 'four bedrooms',
    'five bedrooms'];
  const nm21 = ['a small', 'a large', 'a cozy', 'a snug', 'a spacious',
    'a modest', 'a grand', 'a roomy'];
  const nm22 = ['dining room', 'dining area'];
  const nm23 = ['', '', '', '', '', ', a lounge area', ', a study',
    ', a library', ', a game room', ', a bar', ', a sun room', ', a playroom',
    ', a multimedia room', ', an office'];
