export default function staffs() {
  ...
  const nm2 = ['elegant', 'exceptional', 'exclusive', 'expensive',
    ...
    'magnificent', 'marvelous', 'primal', 'rare', 'refined', 'solid',
    'superior', 'supreme', 'the finest', 'unique', 'wicked'];
  const nm3 = ['iron', 'steel', 'mithril', 'gold', 'silver', 'brass', 'bronze',
    'titanium', 'adamantium', 'obsidian', 'acacia', 'alder', 'ash', 'aspen',
    'baobab', 'basswood', 'baywood', 'beech', 'birch', 'bitterwood',
    'blackthorn', 'blackwood', 'buckeye', 'cedar', 'cherry', 'chestnut',
    'cycad', 'cypress', 'dogwood', 'ebony wood', 'elder wood', 'elm',
    'fiddlewood', 'fir', 'firethorn', 'hackberry', 'hawthorn', 'hazel',
    'hazelnut wood', 'hemlock', 'hickory', 'hornbeam', 'inkwood', 'ironbark',
    'ironwood', 'juniper wood', 'kingwood', 'lancewood', 'larch', 'laurel',
    'magnolia', 'mahogany', 'maidenwood', 'mangrove wood', 'maple', 'medlar',
    'oak', 'oleander', 'pine', 'poisonwood', 'poplar', 'redbud', 'redwood',
    'reed', 'rosewood', 'rowan', 'sandalwood', 'senna', 'sequoia', 'spruce',
    'strongbark', 'sycamore', 'toadwood', 'vine', 'walnut', 'willow', 'yew',
    'yucca'];
  const nm4 = ['astonishing', 'elegant', 'exalted', 'glorious', 'grand',
    'grandiose', 'imposing', 'impressive', 'incredible', 'magnificent',
    'majestic', 'marvelous', 'monumental', 'noble', 'sensational',
    'spectacular', 'stunning', 'sublime', 'superb', 'terrific', 'wonderful'];
  const nm5 = [
    ...
    'A scaled cord wraps tightly around the entire staff like a snake, only opening up to leave enough room at the handle',
    ...
    'Crystal-like shards are merged into the staff, allowing light to flow through and making it glow. Only the handle is kept smooth',
    ...
    'Most of the staff has been polished and smoothened. Cloth ribbons with runes have been attached just below the handle',
    'Most of the staff is simple, except for round extensions at various points, including above and below the handle',
    ...
    'The entire length of this staff has been carefully painted with intricate patterns, leaving only the handle untouched',
    ...
    'The entirety of this straight staff has been carved with seemingly glowing runes, with the exception of the handle',
  ...
  const nm6 = ['wrapped in a strong, but smooth silk',
    'wrapped in tight leather for a firm grip',
    'wrapped in emblazoned leather', 'wrapped in embellished cloth',
    'decorated with small carved runes', 'wrapped in an inscribed cloth cord',
    'strengthened and polished', 'strengthened with a metal coating',
    'decorated with a crosshatched cord', 'left untouched completely',
    'adorned with tiny gems for a firm grip',
    'decorated with an ancient text carved into it',
    'painted with a simplistic style', 'smoothened and strengthened',
    'emblazoned with magical runes', 'wrapped in reptilian leather',
    'decorated with scale-like stubs', 'strengthened with decorated metal',
    'wrapped in leather with gilded linings',
    'wrapped in cloth with gilded linings',
    'covered in thick bulges for more grip', 'wrapped in exotic animal skin',
    'covered in a marble pattern', 'decorated with carved patterns',
    'decorated with a few crystals'];
  const nm7 = ['a barbed shield shape', 'a bird wing shaped decoration',
    'a bone shape', 'a claw-like ornament', 'a crafted animal claw',
    'a crafted animal skull', 'a crafted dragon head', 'a crafted raven head',
    'a crafted reptilian tail', 'a crafted skull', 'a crafted wolf head',
    'a crown-shaped ornament', 'a curved blade shape', 'a curvy twirl',
    'a decorative eye', 'a decorative floral ornament',
    'a decorative handle-shape', 'a decorative reptilian tail',
    'a decorative snake', 'a decorative, flame-shaped piece',
    'a dull blade shape', 'a dull tip', 'a fan-shape',
    'a gnarled, root-like stub', 'a hammerhead', 'a heart shape',
    'a key shape', 'a leaf-like ornament', 'a lightning bolt',
    'a long scythe shape', 'a mirrored marquise shape', 'a pointed fan',
    'a rounded cross', 'a rounded feather shape', 'a shield shape',
    'a short marquise shape', 'a simple orb', 'a simple stub',
    'a simple twirl', 'a simple, reinforced stub',
    'a skull-shaped decorative piece', 'a smooth crescent',
    'a smooth spearhead', 'a spiked crescent', 'a spiky cross',
    'a spiky feather shape', 'a spiky wing shape', 'a spiral shape',
    'a star shape', 'a talon shape', 'a teardrop shape',
    'a thick decorated cylinder', 'a thick decorated prism',
    'a thick diamond shape', 'a thick ring', 'a thick sphere',
    'a tightly twisted stub', 'a twisting tip',
    'an angel wing shaped decoration', 'an angular hook-shape',
    'an elaborate intertwining art piece', 'an elongated crescent',
    'an elongated crystal shape', 'an elongated marquise shape',
    'an open diamond', 'an ornate snowflake', 'an ornate, crafted spider',
    'an ornate, gilded decorative piece', 'intertwining crafted feathers',
    'intertwining wave shapes', 'layered scythe shapes',
    'root-like decorations', 'several intertwining spikes', 'three spikes',
    'two decorative, intertwining snakes', 'two small wings'];
  const nm8 = ['wood', 'mithril', 'adamantium', 'metal', 'glass', 'crystal',
    'wood', 'wood', 'obsidian'];
  const nm9 = [
  ...
  const nm10 = ['a barbed crescent shape', 'a bird claw', 'a butterfly shape',
    'a crescent shape', 'a cross', 'a crown', 'a curved point',
    'a demonic skull', 'a dragon head', 'a floral shape', 'a fork-like shape',
    'a harpoon-shape', 'a heart shape', 'a horned animal skull',
    'a horned skull', 'a jagged crescent shape', 'a key shape',
    'a kite shape', 'a lantern-like shape', 'a laurel shape',
    'a perfect circle', 'a pointy star shape', 'a quatrefoil shape',
    'a raven head', 'a reptilian tail', 'a rhombus shape',
    'a root-like shape', 'a rounded star shape', 'a scythe-like shape',
    'a sharp, jagged fan', 'a shield shape', 'a skull', 'a smooth hook',
    'a smooth oval', 'a smooth point', 'a spider-like shape', 'a spiky cross',
    'a spiky laurel shape', 'a sun shape', 'a tentacled orb',
    'a twirling laurel shape', 'a winged eye', 'a winged orb',
    'a winged skull', 'a winged star shape', 'a wrapped orb',
    'a wreath shape', 'an abstract design of curves',
    'an abstract design of spikes', 'an abstract design of twirls',
    'an abstract symmetrical design', 'an animal claw', 'an animal head',
    'an elongated crescent', 'an elongated ellipse shape',
    'an elongated marquise shape', 'an elongated scythe-like shape',
    'an encased cross', 'an encased crystal', 'an encased heart',
    'an encased shield', 'an encased sphere', 'an encased star', 'an eye',
    'an eye in a star', 'an insect-like shape', 'an open heart shape',
    'an open sphere', 'angel wings', 'animal horns', 'bird wings',
    'blade-like wings', 'demonic wings', 'long, thin spikes',
    'stacked crescent shapes', 'stacked crowns', 'stacked scythe shapes',
  ...
  let rnd13 = Math.floor(Math.random() * nm9.length);
  while (rnd13 === rnd9) {
    rnd13 = Math.floor(Math.random() * nm9.length);
  }
