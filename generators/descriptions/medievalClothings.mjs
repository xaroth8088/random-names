export default function medievalClothings() {
  ...
  const nm2 = ['Queen Anne neckline', 'court neckline', 'cowl neckline',
    'draped neckline', 'halter neckline', 'jewel neckline',
    'keyhole neckline', 'round neckline', 'scoop neckline',
    'semi-sweethear neckline', 'square neckline', 'sweetheart neckline',
    'v-neck'];
  const nm3 = ['charmingly', 'daintily', 'delicately', 'elegantly',
    'entrancingly', 'gracefully', 'graciously', 'harmoniously', 'lightly',
    'subtly', 'tastefully', 'wonderfully'];
  const nm4 = ['comfortable', 'delectable', 'delicate', 'exquisite', 'fine',
    'flowing', 'gentle', 'ornate', 'satiny', 'silky', 'smooth', 'soft',
    'velvety'];
  const nm5 = ['buttoned up fabric', 'loosely tied fabric',
    'tightly tied fabric', 'corset-like tied fabric', 'corset'];
  const nm6 = ['thin', 'thick', 'simple', 'small', 'slender', 'light', 'dark',
    'large', 'long', 'wide', 'small'];
  const nm7 = ['leather belt', 'ribbon', 'cloth belt', 'rope belt',
    'cloth band'];
  const nm8 = ['fairly high', 'quite high', 'low', 'high', 'fairly low',
    'quite low'];
  const nm9 = ['opens up slightly and reveals',
    'opens up to the right and reveals', 'opens up to the left and reveals',
    'opens up and reveals', 'opens up wide and reveals',
    'flows down and hides', 'opens up left and right and reveals',
    'flows down wide and hides'];
  const nm10 = ['is shorter at the front and curves outwards',
    'is much shorter at the front and curves outwards',
    'is shorter at the front and flows straight down',
    'reaches the ground generously', 'easily reaches the ground in the front',
  ...
  const nm12 = ['broad curve', 'narrow curve', 'narrow tip', 'broad tip',
    'narrow rectangle', 'broad rectangle'];
  const nm13 = ['very long', 'quite long', 'a little too long',
    'purposely too long', 'incredibly long', 'the length of her arms',
    'longer than her arms', 'slightly shorter than her arms',
    'almost the length of her arms', 'fairly short', 'a little short'];
  const nm14 = ['incredibly wide', 'very wide', 'quite wide', 'wide',
    'a little wide', 'narrow', 'quite narrow', 'a little narrow',
    'a comfortable fit', 'a loose fit'];
  const nm15 = ['just below the shoulder', 'just below the elbow',
    'just above the elbow', 'below the shoulder', 'below the elbow',
    'above the elbow', 'well below the shoulder', 'well below the elbow',
    'well above the elbow', 'at the elbow', 'at the shoulder'];
  const nm16 = ['they change color and where ', ''];
  const nm17 = ['decorative', 'elegant', 'ornamental', 'cosmetic',
    'embellishing', 'ornate', 'delicate', 'graceful', 'luxurious', 'simple',
    'modest', 'refined', 'stylish'];
  const nm18 = ['edges', 'sleeves', 'sleeves and bottom', 'bottom', 'neckline',
    'bottom and neckline', 'sleeves, bottom and neckline',
    'sleeves and neckline'];
  const nm19 = ['long', 'very long', 'fairly long', 'short', 'very short',
    'fairly short'];
  const nm20 = ['leather', 'hide', 'furred', 'cloth', 'animal skin', 'silky',
    'velvety'];
  const nm21 = ['just below his waist', 'well below his waist',
    'just below his groin', 'well below his groin', 'just below his knees',
    'well below his knees', 'just above his waist', 'well above his waist',
    'just above his groin', 'well above his groin', 'just above his knees',
    'well above his knees', 'his waist', 'his knees', 'his groin'];
  const nm22 = ['tightly tied with string', 'loosely tied with string',
    'buttoned up completely', 'almost completely buttoned up',
    'half buttoned up', 'barely tied with string', 'barely buttoned up',
    'bound'];
  const nm23 = ['at the center', 'at the left side', 'at the right side',
    'at the top left side', 'at the top right side',
    'at the bottom left side', 'at the bottom right side',
    'slightly off-center'];
  const nm24 = ' jacket ';
  const nm25 = ['incredibly wide', 'very wide', 'quite wide', 'wide',
    'a little wide', 'narrow', 'quite narrow', 'a little narrow',
    'a comfortable fit', 'a loose fit'];
  const nm26 = ['his hands', 'just above his hands', 'well below his hands',
    'below his hands', 'well above his hands', 'his wrists',
    'just below his wrists', 'just above his wrists', 'well above his wrists',
    'well below his wrists'];
  const nm27 = ['a single thread lining from top to bottom',
    ...
    'a decorative band at the edges', 'a decorative band almost at the edges',
    'a single thread lining and a decorative band'];
  const nm28 = ['round neckline', 'wide, round neckline',
    'narrow, round neckline', 'deep, round neckline', 'wide v-neck',
    'narrow v-neck', 'deep v-neck', 'rectangular neckline',
    'wide, rectangular neckline', 'narrow, rectangular neckline',
    'deep, rectangular neckline'];
  const nm29 = ['rough', 'elegant', 'fancy', 'graceful', 'luxurious',
    'relatively simple', 'majestic', 'modest', 'noble', 'ornate',
    'rather simple', 'refined', 'stylish', 'traditional'];
  const nm30 = ['thin', 'thick', 'simple', 'small', 'big', 'light', 'dark',
    'large', 'long', 'wide', 'small'];
  const nm31 = ['leather belt', 'cloth belt', 'rope belt', 'cloth band'];
  const nm32 = ['a big belt buckle', 'a simple knot', 'a small belt buckle',
    'an intricate knot', 'an ornate pin', 'a decorative pin'];
  const nm33 = ['purely decorative and a sign of wealth',
    ...
    'almost entirely a functional addition', 'purely a functional addition',
    'a functional addition, but does have some decorative value'];
  const nm35 = ['leather', 'hide', 'furred', 'soft leather', 'hard leather',
    'bound cloth'];
  const nm36 = ['rare', 'very rare', 'fairly rare', 'fairly uncommon',
    'very uncommon', 'pretty uncommon', 'pretty rare', 'pretty unusual',
    'pretty unique'];
  const nm37 = ['quite simple', 'a simple design', 'an ordinary design',
    'a common design', 'a common type', 'not that special',
    'a design found commonly', 'not any different from others'];
