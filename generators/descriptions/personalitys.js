function generator$descriptions$personalitys() {
  ...
  const nm21 = [
    ...
    ['ambitious', 'ambitions'],
    ['amusing', 'amusing nature'],
    ['anticipative', 'anticipative nature'],
    ['appreciative', 'appreciative nature'],
    ['aspiring', 'aspirations'],
    ['athletic', 'athleticism'],
    ['balanced', 'sense of balance'],
    ['brilliant', 'brilliance'],
    ['calm', 'calm nature'],
    ['capable', 'capabilities'],
    ['captivating', 'captivating nature'],
    ['caring', 'caring nature'],
    ['charismatic', 'charisma'],
    ['charming', 'charm'],
    ['cheerful', 'cheerfulness'],
    ['clear-headed', 'clear-headedness'],
    ['clever', 'clever nature'],
    ['companionably', 'companionship'],
    ['compassionate', 'compassion'],
    ['confident', 'confidence'],
    ['considerate', 'considerate nature'],
    ['contemplative', 'contemplative nature'],
    ['cooperative', 'cooperation'],
    ['courageous', 'courage'],
    ['courteous', 'courtesy'],
    ['creative', 'creativity'],
    ['curious', 'curiosity'],
    ['daring', 'daring nature'],
    ['decisive', 'decisive nature'],
    ['dedicated', 'dedication'],
    ['determined', 'determination'],
    ['disciplined', 'discipline'],
    ['discreet', 'discretion'],
    ['dutiful', 'dutiful nature'],
    ['dynamic', 'dynamic nature'],
    ['earnest', 'earnestness'],
    ...
    ['forthright', 'forthright nature'],
    ['freethinking', 'freethinking nature'],
    ['friendly', 'friendliness'],
    ['fun-loving', 'fun-loving nature'],
    ['generous', 'generosity'],
    ['gentle', 'gentleness'],
    ['good-natured', 'good nature'],
    ['gracious', 'grace'],
    ['hardworking', 'hardworking nature'],
    ['helpful', 'helping hand'],
    ['heroic', 'heroic nature'],
    ['honest', 'honesty'],
    ['honorable', 'honor'],
    ['humble', 'humbleness'],
    ['humorous', 'sense of humor'],
    ['idealistic', 'idealism'],
    ['imaginative', 'imagination'],
    ['incisive', 'incisive nature'],
    ['incorruptible', 'incorruptible nature'],
    ['independent', 'independence'],
    ['individualistic', 'individualism'],
    ['innovative', 'innovative nature'],
    ['insightful', 'insight'],
    ['intelligent', 'intelligence'],
    ['intuitive', 'intuition'],
    ['kind', 'kindness'],
    ['leaderly', 'leadership'],
    ['lovable', 'loving nature'],
    ['loyal', 'loyalty'],
    ['methodical', 'methodical nature'],
    ['modest', 'modesty'],
    ['objective', 'objectivity'],
    ['observant', 'observant nature'],
    ['open', 'openness'],
    ['optimistic', 'optimism'],
    ['orderly', 'sense of order'],
    ['organized', 'organization skills'],
    ['outspoken', 'outspoken nature'],
    ['passionate', 'passion'],
    ['patient', 'patience'],
    ['perceptive', 'perceptive nature'],
    ['persuasive', 'persuasive nature'],
    ['planful', 'planning'],
    ['playful', 'playfulness'],
    ...
    ['realistic', 'realism'],
    ['reflective', 'reflective thinking'],
    ['relaxed', 'relaxed nature'],
    ...
    ['sensitive', 'sensitive nature'],
    ['sentimental', 'sentimentality'],
    ['sharing', 'sharing nature'],
    ['sociable', 'sociable nature'],
    ['spontaneous', 'spontaneity'],
    ['stable', 'stable nature'],
    ['surprising', 'surprising nature'],
    ['sweet', 'sweet nature'],
    ['sympathetic', 'sympathetic nature'],
    ['tolerant', 'tolerance'],
    ['trusting', 'trusting nature'],
    ['understanding', 'understanding nature'],
    ['upright', 'upright nature'],
    ['warm', 'warmness'],
    ['wise', 'wisdom'],
    ['witty', 'wit'],
  ];
  const nm22 = [
    ...
    ['agonizing', 'agonizing nature'],
    ['amoral', 'amoral nature'],
    ['angry', 'anger'],
    ['apathetic', 'apathetic nature'],
    ['argumentative', 'argumentativeness'],
    ['arrogant', 'arrogant nature'],
    ['barbaric', 'barbaric nature'],
    ['blunt', 'blunt nature'],
    ['brutal', 'brutish ways'],
    ['callous', 'callous nature'],
    ['careless', 'carelessness'],
    ['childish', 'childish nature'],
    ['coarse', 'coarseness'],
    ['cold', 'coldness'],
    ['conceited', 'conceited nature'],
    ['crass', 'crassness'],
    ['crazy', 'craziness'],
    ['criminal', 'criminal nature'],
    ['crude', 'crude ways'],
    ['cruel', 'cruelty'],
    ['cynical', 'cynical nature'],
    ['deceitful', 'deceitful ways'],
    ['demanding', 'demanding nature'],
    ['desperate', 'desperation'],
    ['destructive', 'destructive nature'],
    ['devious', 'deviousness'],
    ['difficult', 'difficult nature'],
    ['disconcerting', 'disconcerting nature'],
    ['dishonest', 'dishonesty'],
    ['disloyal', 'disloyalty'],
    ['disorderly', 'disorderliness'],
    ['disrespectful', 'disrespectful nature'],
    ['disruptive', 'disruptive nature'],
    ['disturbing', 'disturbing nature'],
    ['dominating', 'dominating nature'],
    ['egocentric', 'ego'],
    ['envious', 'envy'],
    ['extreme', 'extreme nature'],
    ['frightening', 'frightening nature'],
    ['greedy', 'greed'],
    ['grim', 'grim ways'],
    ['hateful', 'hatred'],
    ['hostile', 'hostility'],
    ...
    ['insulting', 'insulting nature'],
    ['intolerant', 'intolerance'],
    ['irrational', 'irrational nature'],
    ['irresponsible', 'irresponsibility'],
    ['irritable', 'irritable nature'],
    ['lazy', 'laziness'],
    ['malicious', 'maliciousness'],
    ['miserable', 'miserable nature'],
    ['monstrous', 'monstrous nature'],
    ['morbid', 'morbid nature'],
    ['narcissistic', 'narcissistic nature'],
    ['narrow-minded', 'narrow-mindedness'],
    ['negativistic', 'negativity'],
    ['neglectful', 'neglectful nature'],
    ['obnoxious', 'obnoxious nature'],
    ['obsessive', 'obsessive nature'],
    ['opportunistic', 'opportunistic ways'],
    ['pedantic', 'pedantic nature'],
    ['perverse', 'perversions'],
    ['petty', 'petty nature'],
    ['pompous', 'pompous nature'],
    ['possessive', 'possessive nature'],
    ['power-hungry', 'power-hungry ways'],
    ['predatory', 'predatory nature'],
    ['prejudiced', 'prejudices'],
    ['pretentious', 'pretentiousness'],
    ['provocative', 'provocative nature'],
    ['sadistic', 'sadistic ways'],
    ['scornful', 'scornful nature'],
    ['self-indulgent', 'self-indulgence'],
    ['selfish', 'selfishness'],
    ['shallow', 'shallowness'],
    ['sly', 'slyness'],
    ['superficial', 'superficial nature'],
    ['tactless', 'tactlessness'],
    ['thievish', 'thievish nature'],
    ['thoughtless', 'thoughtlessness'],
    ['treacherous', 'treachery'],
    ['troublesome', 'troublesome nature'],
    ['uncaring', 'uncaring nature'],
  ...
  if (tp === 1) {
    ...
    var rnd7 = Math.floor(Math.random() * nm17.length);
    var rnd8 = Math.floor(Math.random() * nm18.length);
    var rnd9 = Math.floor(Math.random() * nm19.length);
    var rnd10 = Math.floor(Math.random() * nm20.length);
    var rnd11 = Math.floor(Math.random() * nm22.length);
    var rnd12 = Math.floor(Math.random() * nm22.length);
    var rnd13 = Math.floor(Math.random() * nm22.length);
    var rnd14 = Math.floor(Math.random() * nm22.length);
    var rnd15 = Math.floor(Math.random() * nm22.length);
    var rnd16 = Math.floor(Math.random() * nm21.length);
    ...
    var rnd11 = Math.floor(Math.random() * nm21.length);
    var rnd12 = Math.floor(Math.random() * nm21.length);
    var rnd13 = Math.floor(Math.random() * nm21.length);
    var rnd14 = Math.floor(Math.random() * nm21.length);
    var rnd15 = Math.floor(Math.random() * nm21.length);
    var rnd16 = Math.floor(Math.random() * nm22.length);
