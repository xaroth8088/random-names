function generator$warhammer$beastmens() {
  const nm1 = ['b', 'd', 'g', 'gh', 'k', 'kn', 'kh', 'm', 'n', 't', 'th', 'v', 'z', 'zh'];
  const nm2 = ['a', 'o', 'u', 'a', 'o', 'u', 'a', 'o', 'u', 'a', 'o', 'u', 'a', 'o', 'u', 'e', 'i', 'e', 'i', 'au', 'ao', 'aa', 'oo'];
  const nm3 = ['cr', 'cn', 'cc', 'cv', 'cth', 'g', 'gh', 'gth', 'gd', 'gdh', 'k', 'kh', 'kz', 'kk', 'kr', 'kt', 'kth', 'l', 'lg', 'lgh', 'lgr', 'ltr', 'lc', 'n', 'ng', 'nk', 'nc', 'r', 'rr', 'rz', 'rg', 'rk', 'rkr', 'rgh', 'rth', 'zr', 'zg', 'zc', 'zk', 'zz'];
  const nm4 = ['c', 'g', 'k', 'r', 'x', 'z'];
  const nm5 = ['amber', 'ashen', 'battle', 'bitter', 'black', 'blazing', 'bleeding', 'blood', 'bright', 'bristle', 'broad', 'brown', 'chaos', 'cinder', 'dark', 'dawn', 'dead', 'death', 'ember', 'fallen', 'fiery', 'fire', 'flame', 'frozen', 'giant', 'gloom', 'gore', 'grand', 'gray', 'great', 'grim', 'grizzly', 'heavy', 'hell', 'iron', 'keen', 'lightning', 'lone', 'metal', 'molten', 'moon', 'morning', 'moss', 'mountain', 'nether', 'night', 'onyx', 'plain', 'proud', 'pyre', 'rage', 'rapid', 'rough', 'rumble', 'serpent', 'shadow', 'sharp', 'shatter', 'silent', 'silver', 'slug', 'solid', 'spring', 'star', 'steel', 'stern', 'stone', 'storm', 'strong', 'swift', 'thunder', 'wild'];
