export default function boots() {
  ...
  let names5 = ['Boots', 'Greaves', 'Stompers', 'Greatboots', 'Treads', 'Spurs',
    'Warboots', 'Sabatons', 'Feet', 'Walkers', 'Footguards'];
  const names7 = ['Absorption', 'Steadiness', 'Water Walking', 'Perseverance',
    'Firmness', 'Stability', 'the Elephant', 'the Mammoth', 'Fidelity',
