export default function pauldrons() {
  ...
  const names3 = ['Ancient', 'Arcane', 'Atuned', 'Bandit\'s', 'Baneful',
    ...
    'Zealous', '', '', '', '', '', '', '', '', ''];
  let names4 = [];
  const names5 = ['Spaulders', 'Shoulders', 'Shoulderguards', 'Shoulderwraps',
    'Mantle'];
  const names6 = ['Armament', 'Bane', 'Bond', 'Boon', 'Call', 'Champion',
    ...
    'Ender', 'Favor', 'Foe', 'Gift', 'Glory', 'Guard', 'Guardian', 'Heirloom',
    'Hero', 'Hope', 'Incarnation', 'Keeper', 'Last Hope', 'Last Stand',
    'Legacy', 'Memory', 'Might', 'Oath', 'Pact', 'Pledge', 'Promise',
    'Protection', 'Protector', 'Reach', 'Shepherd', 'Soul', 'Steward',
    'Terror', 'Token', 'Tribute', 'Vengeance', 'Vindicator', 'Visage',
    'Voice', 'Ward', 'Warden', 'Whisper', 'Wit', 'Spaulders', 'Shoulders',
    'Shoulderguards', 'Shoulderwraps', 'Mantle'];
