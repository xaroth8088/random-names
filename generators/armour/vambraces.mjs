export default function vambraces() {
  ...
  let names5 = ['Bracers', 'Wristguards', 'Armbands', 'Vambraces', 'Armguards'];
  const names7 = ['Absorption', 'Grips', 'Thight grip', 'Perseverance',
    'Firmness', 'Stability', 'Steady Hands', 'Fidelity', 'Silence',
    'Muffled Steps', 'Fleet Feet', 'the Phoenix', 'Adventure', 'Agony',
  ...
  if (type === 2) {
    names4 = ['Cloth', 'Heavy Hide', 'Heavy Leather', 'Hide', 'Leather',
      ...
      'Wool', 'Embroided'];
    names5 = ['Bracers', 'Armwraps', 'Bindings', 'Vambraces', 'Wristbands',
      'Armguards', 'Cuffs', 'Wristwraps', 'Sleeves', 'Grasps'];
  } else {
