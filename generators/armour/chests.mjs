export default function chests() {
  ...
  const nm3 = ['Ancient', 'Arcane', 'Atuned', 'Bandit\'s', 'Baneful',
    ...
    'Zealous', '', '', '', '', '', '', '', '', ''];
  let nm4 = ['Adamantite', 'Scaled', 'Bone', 'Bronze', 'Bronzed', 'Ivory',
    'Ebon', 'Golden', 'Iron', 'Mithril', 'Obsidian', 'Silver', 'Skeletal',
    'Steel', 'Mail', 'Chain', 'Chainmail', 'Titanium', 'Demon'];
  let nm5 = ['Vest', 'Chestguard', 'Armor', 'Tunic', 'Breastplate',
    'Chestplate', 'Batteplate', 'Chestpiece', 'Cuirass', 'Greatplate'];
  let nm6 = ['Armament', 'Scales', 'Guard', 'Bastion', 'Steel', 'Defense',
    'Bane', 'Bond', 'Boon', 'Call', 'Champion', 'Conqueror', 'Crusader',
    'Cry', 'Curator', 'Dawn', 'Fall', 'End', 'Demise', 'Birth', 'Death',
    'Edge', 'Blight', 'Burden', 'Blessing', 'Fortune', 'Defender', 'Defiler',
    'Deflector', 'Destroyer', 'Emissary', 'Ender', 'Favor', 'Foe', 'Gift',
    'Glory', 'Guard', 'Guardian', 'Heirloom', 'Hero', 'Hope', 'Incarnation',
    'Keeper', 'Last Hope', 'Last Stand', 'Legacy', 'Memory', 'Might', 'Oath',
    'Pact', 'Pledge', 'Promise', 'Protection', 'Protector', 'Reach',
    'Shepherd', 'Soul', 'Steward', 'Terror', 'Token', 'Tribute', 'Vengeance',
    'Vindicator', 'Visage', 'Voice', 'Ward', 'Warden', 'Whisper', 'Wit',
    'Vest', 'Chestguard', 'Armor', 'Tunic', 'Breastplate', 'Chestplate',
    'Batteplate', 'Chestpiece', 'Cuirass', 'Greatplate'];
  const nm7 = ['Absorption', 'the Phoenix', 'Adventure', 'Agony',
    'Ancient Power', 'Ancient Powers', 'Anger', 'Anguish', 'Annihilation',
    'Arcane Magic', 'Arcane Power', 'Arcane Resist', 'Archery', 'Ashes',
    'Assassination', 'Assassins', 'Assaults', 'Auras', 'Awareness',
    'Barriers', 'Beginnings', 'Binding', 'Black Magic', 'Blast Protection',
    'Blessed Fortune', 'Blessed Fortunes', 'Blessings', 'Blight', 'Blood',
    'Bloodlust', 'Bloodshed', 'Bravery', 'Broken Bones', 'Broken Dreams',
    'Broken Families', 'Broken Worlds', 'Burdens', 'Carnage', 'Cataclysms',
    'Chaos', 'Clarity', 'Conquered Worlds', 'Corruption', 'Courage',
    'Creation', 'Cunning', 'Danger', 'Dark Magic', 'Dark Powers',
    ...
    'the Wretched'];
  if (type === 1) {
    nm4 = ['Cloth', 'Heavy Hide', 'Heavy Leather', 'Hide', 'Leather', 'Linen',
      'Padded', 'Quilted', 'Rugged Leather', 'Scaled', 'Silk', 'Wool',
      'Embroided'];
    nm5 = ['Breastplate', 'Tunic', 'Wraps', 'Vest', 'Vestment', 'Robes',
      'Chestguard', 'Jerkin', 'Raiment', 'Garments'];
    nm6 = ['Armament', 'Bane', 'Bond', 'Boon', 'Call', 'Champion', 'Conqueror',
      'Crusader', 'Cry', 'Curator', 'Dawn', 'Fall', 'End', 'Demise', 'Birth',
      'Death', 'Edge', 'Blight', 'Burden', 'Blessing', 'Fortune', 'Defender',
      'Defiler', 'Deflector', 'Destroyer', 'Emissary', 'Ender', 'Favor',
      'Foe', 'Gift', 'Glory', 'Guard', 'Guardian', 'Heirloom', 'Hero', 'Hope',
      'Incarnation', 'Keeper', 'Last Hope', 'Last Stand', 'Legacy', 'Memory',
      'Might', 'Oath', 'Pact', 'Pledge', 'Promise', 'Protection', 'Protector',
      'Reach', 'Shepherd', 'Soul', 'Steward', 'Terror', 'Token', 'Tribute',
      'Vengeance', 'Vindicator', 'Visage', 'Voice', 'Ward', 'Warden',
      'Whisper', 'Wit', 'Breastplate', 'Tunic', 'Wraps', 'Vest', 'Vestment',
      'Robes', 'Chestguard', 'Jerkin', 'Raiment', 'Garments'];
  } else {
    nm4 = ['Adamantite', 'Scaled', 'Bone', 'Bronze', 'Bronzed', 'Ivory', 'Ebon',
      'Golden', 'Iron', 'Mithril', 'Obsidian', 'Silver', 'Skeletal', 'Steel',
      'Mail', 'Chain', 'Chainmail', 'Titanium', 'Demon'];
    nm5 = ['Vest', 'Chestguard', 'Armor', 'Tunic', 'Breastplate', 'Chestplate',
      'Batteplate', 'Chestpiece', 'Cuirass', 'Greatplate'];
    nm6 = ['Armament', 'Scales', 'Guard', 'Bastion', 'Steel', 'Defense', 'Bane',
      'Bond', 'Boon', 'Call', 'Champion', 'Conqueror', 'Crusader', 'Cry',
      'Curator', 'Dawn', 'Fall', 'End', 'Demise', 'Birth', 'Death', 'Edge',
      'Blight', 'Burden', 'Blessing', 'Fortune', 'Defender', 'Defiler',
      'Deflector', 'Destroyer', 'Emissary', 'Ender', 'Favor', 'Foe', 'Gift',
      'Glory', 'Guard', 'Guardian', 'Heirloom', 'Hero', 'Hope', 'Incarnation',
      'Keeper', 'Last Hope', 'Last Stand', 'Legacy', 'Memory', 'Might',
      'Oath', 'Pact', 'Pledge', 'Promise', 'Protection', 'Protector', 'Reach',
      'Shepherd', 'Soul', 'Steward', 'Terror', 'Token', 'Tribute',
      'Vengeance', 'Vindicator', 'Visage', 'Voice', 'Ward', 'Warden',
      'Whisper', 'Wit', 'Vest', 'Chestguard', 'Armor', 'Tunic', 'Breastplate',
      'Chestplate', 'Batteplate', 'Chestpiece', 'Cuirass', 'Greatplate'];
  }
