export default function legs() {
  ...
  const names3 = ['Ancient', 'Arcane', 'Atuned', 'Bandit\'s', 'Baneful',
    ...
    'Zealous', '', '', '', '', '', '', '', '', ''];
  const names7 = ['Absorption', 'the Phoenix', 'Adventure', 'Agony',
  ...
  if (type === 2) {
    names4 = ['Cloth', 'Heavy Hide', 'Heavy Leather', 'Hide', 'Leather',
      ...
      'Wool', 'Embroided'];
    names5 = ['Legwraps', 'Legguards', 'Kilt', 'Skirt', 'Pants', 'Robes',
      'Breeches', 'Leggings', 'Britches'];
    names6 = ['Armament', 'Bane', 'Bond', 'Boon', 'Call', 'Champion',
      'Conqueror', 'Crusader', 'Cry', 'Curator', 'Dawn', 'Fall', 'End',
      'Demise', 'Birth', 'Death', 'Edge', 'Blight', 'Burden', 'Blessing',
      'Fortune', 'Defender', 'Defiler', 'Deflector', 'Destroyer', 'Emissary',
      'Ender', 'Favor', 'Foe', 'Gift', 'Glory', 'Guard', 'Guardian',
      'Heirloom', 'Hero', 'Hope', 'Incarnation', 'Keeper', 'Last Hope',
      'Last Stand', 'Legacy', 'Memory', 'Might', 'Oath', 'Pact', 'Pledge',
      'Promise', 'Protection', 'Protector', 'Reach', 'Shepherd', 'Soul',
      'Steward', 'Terror', 'Token', 'Tribute', 'Vengeance', 'Vindicator',
      'Visage', 'Voice', 'Ward', 'Warden', 'Whisper', 'Wit', 'Legwraps',
      'Legguards', 'Kilt', 'Skirt', 'Pants', 'Robes', 'Breeches', 'Leggings',
      'Britches'];
  } else {
    names4 = ['Adamantite', 'Scaled', 'Bone', 'Bronze', 'Bronzed', 'Ivory',
      'Ebon', 'Golden', 'Iron', 'Mithril', 'Obsidian', 'Silver', 'Skeletal',
      'Steel', 'Mail', 'Chain', 'Chainmail', 'Titanium', 'Demon'];
    names5 = ['Legguards', 'Platelegs', 'Legplates', 'Greaves', 'Skirt',
      'Leggings', 'Kilt'];
    names6 = ['Armament', 'Scales', 'Guard', 'Bastion', 'Steel', 'Defense',
      'Bane', 'Bond', 'Boon', 'Call', 'Champion', 'Conqueror', 'Crusader',
      'Cry', 'Curator', 'Dawn', 'Fall', 'End', 'Demise', 'Birth', 'Death',
      'Edge', 'Blight', 'Burden', 'Blessing', 'Fortune', 'Defender',
  ...
  const i = Math.floor(Math.random() * 10); {
    if (i < 2) {
      ...
      names = `${names6[rnd]} of ${names7[rnd1]}`;
    }
    return names;
  }
}
