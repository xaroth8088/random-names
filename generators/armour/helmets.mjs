export default function helmets() {
  ...
  if (type === 2) {
    names4 = ['Cloth', 'Heavy Hide', 'Heavy Leather', 'Hide', 'Leather',
      'Linen', 'Padded', 'Quilted', 'Rugged Leather', 'Scaled', 'Silk', 'Wool',
    ];
    names5 = ['Bandana', 'Cap', 'Coif', 'Cowl', 'Facemask', 'Headguard',
      'Headpiece', 'Helm', 'Hood', 'Mask'];
    names6 = ['Armament', 'Bandana', 'Bane', 'Birth', 'Blessing', 'Blight',
      'Bond', 'Boon', 'Burden', 'Call', 'Cap', 'Champion', 'Coif',
      'Conqueror', 'Cowl', 'Crusader', 'Cry', 'Curator', 'Dawn', 'Death',
      'Defender', 'Defiler', 'Deflector', 'Demise', 'Destroyer', 'Edge',
      'Emissary', 'End', 'Ender', 'Facemask', 'Fall', 'Favor', 'Foe',
      'Fortune', 'Gift', 'Glory', 'Guard', 'Guardian', 'Headguard',
      'Headpiece', 'Heirloom', 'Helm', 'Hero', 'Hood', 'Hope', 'Incarnation',
      'Keeper', 'Last Hope', 'Last Stand', 'Legacy', 'Mask', 'Memory',
    ...
    names4 = ['Adamantite', 'Plate', 'Scaled', 'Bone', 'Bronze', 'Bronzed',
      'Ivory', 'Ebon', 'Golden', 'Iron', 'Mithril', 'Obsidian', 'Silver',
      'Skeletal', 'Steel', 'Titanium', 'Demon'];
    names5 = ['Casque', 'Crown', 'Faceguard', 'Gaze', 'Greathelm', 'Headcover',
      'Headguard', 'Helm', 'Helmet', 'Jaws', 'Visage'];
    names6 = ['Armament', 'Bane', 'Birth', 'Blessing', 'Blight', 'Bond', 'Boon',
      'Burden', 'Call', 'Casque', 'Champion', 'Conqueror', 'Crown',
      'Crusader', 'Cry', 'Curator', 'Dawn', 'Death', 'Defender', 'Defiler',
      'Deflector', 'Demise', 'Destroyer', 'Edge', 'Emissary', 'End', 'Ender',
      'Faceguard', 'Fall', 'Favor', 'Foe', 'Fortune', 'Gaze', 'Gift', 'Glory',
      'Greathelm', 'Guard', 'Guardian', 'Headcover', 'Headguard', 'Heirloom',
      'Helm', 'Helmet', 'Hero', 'Hope', 'Incarnation', 'Jaws', 'Keeper',
      'Last Hope', 'Last Stand', 'Legacy', 'Memory', 'Might', 'Oath', 'Pact',
      'Pledge', 'Promise', 'Protection', 'Protector', 'Reach', 'Shepherd',
