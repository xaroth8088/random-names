export default function gauntlets() {
  ...
  const names1 = ['Ancient', 'Binding', 'Blessed', 'Blind', 'Broken', 'Burning',
    ...
    'Twisted', 'Unholy'];
  const names2 = ['Ancestors', 'Bloodlust', 'Comrades', 'Damnation', 'Dreams',
    ...
    'Whispers', 'Worlds'];
  const names3 = ['Ancient', 'Arcane', 'Atuned', 'Bandit\'s', 'Baneful',
    ...
    'Zealous', '', '', '', '', '', '', '', '', ''];
  let names4 = ['Adamantite', 'Scaled', 'Bone', 'Bronze', 'Bronzed', 'Ivory',
    'Ebon', 'Golden', 'Iron', 'Mithril', 'Obsidian', 'Silver', 'Skeletal',
    'Steel', 'Mail', 'Chain', 'Chainmail', 'Titanium', 'Demon'];
  let names5 = ['Gauntlets', 'Grips', 'Gloves', 'Handguards', 'Fists', 'Hands',
    'Grasps', 'Warfists'];
  const names7 = ['Absorption', 'Grips', 'Tight Grips', 'the Archer', 'Archer',
    'Keen Aim', 'Precision', 'Perseverance', 'Firmness', 'Stability',
    'Steady Hands', 'Fidelity', 'Silence', 'Muffled Steps', 'Fleet Feet',
    'the Phoenix', 'Adventure', 'Agony', 'Ancient Power', 'Ancient Powers',
    'Anger', 'Anguish', 'Annihilation', 'Arcane Magic', 'Arcane Power',
    'Arcane Resist', 'Archery', 'Ashes', 'Assassination', 'Assassins',
    'Assaults', 'Auras', 'Awareness', 'Barriers', 'Beginnings', 'Binding',
    'Black Magic', 'Blast Protection', 'Blessed Fortune', 'Blessed Fortunes',
    'Blessings', 'Blight', 'Blood', 'Bloodlust', 'Bloodshed', 'Bravery',
    'Broken Bones', 'Broken Dreams', 'Broken Families', 'Broken Worlds',
    'Burdens', 'Carnage', 'Cataclysms', 'Chaos', 'Clarity',
    'Conquered Worlds', 'Corruption', 'Courage', 'Creation', 'Cunning',
    'Danger', 'Dark Magic', 'Dark Powers', 'Dark Souls', 'Darkness', 'Dawn',
    'Decay', 'Deception', 'Defiance', 'Deflection', 'Delirium', 'Delusions',
    'Demon Fire', 'Demons', 'Denial', 'Desecration', 'Despair', 'Destruction',
    'Devotion', 'Diligence', 'Discipline', 'Dishonor', 'Dismay', 'Dominance',
    'Domination', 'Doom', 'Dragons', 'Dragonsouls', 'Dread', 'Dreams',
    'Due Diligence', 'Duels', 'Dusk', 'Echoes', 'Enchantments',
    'Ended Dreams', 'Ending Hope', 'Ending Misery', 'Ends',
    'Eternal Bloodlust', 'Eternal Damnation', 'Eternal Glory',
    'Eternal Justice', 'Eternal Rest', 'Eternal Sorrow', 'Eternal Struggles',
    'Eternity', 'Executions', 'Extinction', 'Faded Memories', 'Fallen Kings',
    'Fallen Souls', 'Fire', 'Fire Magic', 'Fire Power', 'Fire Protection',
    'Fire Resist', 'Fools', 'Forging', 'Fortitude', 'Fortune', 'Frost',
    'Frost Power', 'Frost Resist', 'Frozen Hells', 'Fury', 'Ghosts', 'Giants',
    'Giantslaying', 'Glory', 'Grace', 'Greed', 'Grieving Widows', 'Guardians',
    'Hate', 'Hatred', 'Healing', 'Hell', 'Hell\'s Games', 'Hellfire',
    'Hellish Torment', 'Heroes', 'Holy Might', 'Honor', 'Hope', 'Horrors',
    'Ice', 'Ice Magic', 'Illusions', 'Immortality', 'Inception',
    'Infinite Trials', 'Infinity', 'Insanity', 'Justice', 'Kings', 'Life',
    'Lifemending', 'Lifestealing', 'Light\'s Hope', 'Limbo', 'Lost Comrades',
    'Lost Hope', 'Lost Souls', 'Lost Voices', 'Lost Worlds', 'Mercy', 'Might',
    'Miracles', 'Misery', 'Mists', 'Moonlight', 'Mysteries', 'Mystery',
    'Nature', 'Necromancy', 'Nightmares', 'Oblivion', 'Paradise', 'Patience',
    'Phantoms', 'Power', 'Prayers', 'Pride', 'Pride\'s Fall', 'Prophecies',
    'Protection', 'Putrefaction', 'Reckoning', 'Recoil', 'Redemption',
    'Regret', 'Regrets', 'Resilience', 'Respect', 'Riddles', 'Ruins', 'Runes',
    'Salvation', 'Secrecy', 'Secrets', 'Serenity', 'Shadows',
    'Shifting Sands', 'Silence', 'Slaughter', 'Slaying', 'Smite', 'Solitude',
    'Souls', 'Stealth', 'Stone', 'Storms', 'Strength', 'Subtlety',
    'Suffering', 'Suffering\'s End', 'Sunfire', 'Sunlight', 'Swordbreaking',
    'Tears', 'Terror', 'Terrors', 'Thieves', 'Thorns', 'Thunder', 'Thunders',
    'Titans', 'Torment', 'Traitors', 'Trust', 'Truth', 'Truths', 'Twilight',
    'Twilight\'s End', 'Twisted Visions', 'Undoing', 'Unholy Blight',
    'Unholy Might', 'Valiance', 'Valor', 'Vengeance', 'Vigor', 'Visions',
    'War', 'Whispers', 'Wisdom', 'Woe', 'Wonders', 'Wraiths', 'Zeal',
    'the Ancients', 'the Archer', 'the Banished', 'the Basilisk', 'the Bear',
    'the Beast', 'the Berserker', 'the Blessed', 'the Boar',
    'the Breaking Storm', 'the Brotherhood', 'the Burning Sun',
    'the Caged Mind', 'the Cataclysm', 'the Champion', 'the Claw',
    'the Corrupted', 'the Covenant', 'the Crown', 'the Crusader',
    ...
    'the Wretched'];
  if (type === 2) {
    names4 = ['Cloth', 'Heavy Hide', 'Heavy Leather', 'Hide', 'Leather',
      'Linen', 'Padded', 'Quilted', 'Rugged Leather', 'Scaled', 'Silk',
      'Wool', 'Embroided'];
