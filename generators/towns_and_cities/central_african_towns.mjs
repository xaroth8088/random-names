export default function central_african_towns() {
  let rnd;
  ...
  const nm4 = ['ba', 'bam', 'ban', 'bang', 'bati', 'be', 'bi', 'bo', 'bong', 'bot', 'da', 'de', 'der', 'dere', 'djock', 'djoun', 'dou', 'douma', 'fe', 'fia', 'foussam', 'fut', 'ga', 'ganga', 'gangte', 'gem', 'gene', 'gie', 'goua', 'gwi', 'ji', 'kenene', 'ko', 'kolo', 'la', 'labo', 'le', 'li', 'lima', 'linga', 'lo', 'long', 'loudou', 'lowa', 'ma', 'mako', 'mayo', 'melima', 'menda', 'mie', 'mingie', 'nam', 'nau', 'nene', 'nolinga', 'po', 'ra', 're', 'roa', 'roua', 'sam', 'samba', 'seri', 'tap', 'te', 'tele', 'ti', 'toua', 'touri', 'wa', 'yo', 'zangue'];
  /* Central African Republic */
  const nm5 = ['Ali', 'Alin', 'Ba', 'Babo', 'Baha', 'Bam', 'Bamba', 'Ban', 'Bando', 'Banga', 'Bao', 'Bata', 'Batan', 'Be', 'Ber', 'Berbe', 'Bi', 'Bim', 'Bo', 'Boa', 'Boba', 'Boban', 'Bos', 'Bossan', 'Bossem', 'Bou', 'Boua', 'Bria', 'Ca', 'Car', 'Da', 'Dama', 'Ga', 'Gam', 'Gambou', 'Gue', 'Ip', 'Ka', 'Kaga', 'Ke', 'Kem', 'Koua', 'Kouan', 'Mba', 'Mbai', 'Mo', 'Moba', 'Mon', 'Mongou', 'Mongoum', 'Nde', 'No', 'Oua', 'Ouad', 'Ouan', 'Ra', 'Rafa', 'Si', 'Sibu', 'Ze', 'Zemi', 'Zi', 'Zin'];
  const nm6 = ['bangui', 'bari', 'baye', 'be', 'bele', 'berati', 'bo', 'boua', 'boula', 'but', 'ca', 'da', 'dao', 'doro', 'fai', 'gafo', 'gassou', 'go', 'goa', 'goumbe', 'gui', 'hamo', 'ki', 'la', 'le', 'li', 'lindao', 'mara', 'mio', 'mo', 'not', 'py', 'ra', 'rao', 'rati', 'ri', 'ro', 'sangoa', 'sembele', 'sou', 'tangafo', 'ti', 'ye', 'zoum'];
  /* Chad */
  const nm7 = ['Abé', 'Adé', 'Ao', 'Aou', 'Bé', 'Bébé', 'Bébo', 'Bén', 'Béno', 'Ba', 'Bar', 'Be', 'Bei', 'Beina', 'Beno', 'Bi', 'Bil', 'Bilti', 'Bit', 'Bo', 'Boko', 'Bon', 'Bou', 'Dja', 'Djeme', 'Do', 'Dour', 'Fa', 'Fia', 'Gaou', 'Gou', 'Goun', 'Gué', 'Guélen', 'Guéré', 'Iri', 'Ké', 'Ko', 'Kou', 'Koum', 'Kya', 'Lé', 'Li', 'Ma', 'Mao', 'Massa', 'Masse', 'Massen', 'Mbou', 'Mbour', 'Me', 'Mel', 'Mo', 'Mois', 'Moissa', 'Mon', 'Mou', 'Moun', 'Nga', 'Oua', 'Pa', 'Sa', 'Zoua'];
  const nm8 = ['bé', 'ba', 'bali', 'boto', 'ché', 'dé', 'da', 'dai', 'deng', 'di', 'dja', 'djer', 'djia', 'dou', 'fi', 'ga', 'go', 'gor', 'guet', 'kine', 'koro', 'kory', 'la', 'lengdeng', 'li', 'lo', 'ma', 'mar', 'mena', 'namar', 'ne', 'nia', 'noy', 'ré', 'réda', 'ra', 'riba', 'ro', 'ry', 'saguet', 'sala', 'senya', 'so', 'soro', 'sou', 'ti', 'tine', 'to', 'ya', 'zou'];
  /* D.R. Congo */
  const nm9 = ['Ake', 'Ba', 'Baf', 'Bafwa', 'Baga', 'Bak', 'Bala', 'Balam', 'Bam', 'Bana', 'Bandu', 'Bandun', 'Bara', 'Basan', 'Baso', 'Befa', 'Be', 'Biko', 'Bin', 'Boen', 'Boko', 'Bokun', 'Bolo', 'Bolom', 'Bomon', 'Bon', 'Bongan', 'Boso', 'Bosobo', 'Bud', 'Buka', 'Bulun', 'Bum', 'Bu', 'Busin', 'Bu', 'Butem', 'De', 'Deke', 'Dem', 'Di', 'Diba', 'Dilo', 'Dulun', 'Dum', 'Dumbe', 'Dhu', 'Dun', 'Du', 'Fe', 'Fi', 'Fungu', 'Fun', 'Ga', 'Gan', 'Ganda', 'Gba', 'Gbado', 'Ge', 'Geme', 'Go', 'Gun', 'Gwa', 'Idi', 'Idio', 'Ike', 'Ile', 'In', 'Ingen', 'Inki', 'Inon', 'Iru', 'Isa', 'Isan', 'Isi', 'Kaba', 'Kabam', 'Kaba', 'Kabe', 'Kabin', 'Kabon', 'Kahem', 'Kale', 'Kali', 'Kam', 'Kambo', 'Kami', 'Kampe', 'Kana', 'Kanan', 'Kania', 'Kan', 'Kante', 'Kanya', 'Kapan', 'Kasan', 'Kasen', 'Kason', 'Kata', 'Katan', 'Kat', 'Kay', 'Kazum', 'Ken', 'Ki', 'Kibom', 'Kik', 'Kim', 'Kin', 'Kunsha', 'Kin', 'Kupam', 'Kipu', 'Ki', 'Kirum', 'Kisan', 'Kito', 'Kitu', 'Kol', 'Kon', 'Kongo', 'Kun', 'Ku', 'Liben', 'Lika', 'Lisa', 'Lod', 'Lome', 'Lu', 'Lube', 'Lubu', 'Lubum', 'Lue', 'Lui', 'Luko', 'Luku', 'Luo', 'Lupa', 'Lupata', 'Lupu', 'Lusa', 'Lusam', 'Lwam', 'Maha', 'Malem', 'Man', 'Mangi', 'Mankan', 'Mano', 'Masi', 'Manim', 'Masi', 'Mata', 'Mban', 'Mbanda', 'Mban', 'Mbu', 'Mbuji', 'Mia', 'Mitwa', 'Mo', 'Moba', 'Mokam', 'Mong', 'Mon', 'Mua', 'Muan', 'Mulon', 'Mu', 'Mutsha', 'Mwe', 'Nian', 'nio', 'Nyun', 'Oi', 'Opa', 'Po', 'Popo', 'Pu', 'Pwe', 'Ru', 'Rutshu', 'Sa', 'Saka', 'San', 'Sed', 'Sha', 'Shabun', 'Shin', 'Shinko', 'Songo', 'Tshe', 'Tshi', 'Tshika', 'Tshilen', 'Tshim', 'Ubu', 'Ubun', 'Uvi', 'Vi', 'Wali', 'Walun', 'Wam', 'Wa', 'Yahu', 'Yako', 'Yanga', 'Za', 'Zon'];
  const nm10 = ['ba', 'baka', 'balo', 'bambare', 'bao', 'bare', 'bashi', 'baya', 'bayi', 'bayonge', 'befu', 'belenge', 'benge', 'bero', 'besa', 'beya', 'bi', 'binda', 'bo', 'bolo', 'bombo', 'bongo', 'bove', 'budi', 'bulu', 'bumbashi', 'bunda', 'bundu', 'butu', 'bwalu', 'cha', 'da', 'daka', 'dhala', 'diofa', 'do', 'doa', 'du', 'dundu', 'fale', 'ga', 'gai', 'gambi', 'gandanga', 'gani', 'gara', 'gata', 'gende', 'gina', 'go', 'gololo', 'gu', 'gulu', 'gurume', 'hagi', 'hemba', 'huma', 'ka', 'kabaka', 'kale', 'kama', 'kambo', 'kania', 'kanza', 'kapa', 'kasi', 'kavu', 'kela', 'kese', 'keti', 'ki', 'kisi', 'ko', 'kolela', 'kolobwe', 'koma', 'koro', 'koto', 'kula', 'kungu', 'kusu', 'kwa', 'kwit', 'la', 'lamba', 'lebo', 'lela', 'lemba', 'lemie', 'lenge', 'lima', 'lo', 'lobo', 'lobwe', 'lolo', 'lombo', 'longo', 'lonji', 'lunga', 'lungu', 'ma', 'mela', 'mena', 'mina', 'mongo', 'na', 'nana', 'nanga', 'ne', 'nia', 'niama', 'nimba', 'nongo', 'nono', 'pala', 'pamba', 'panga', 'pata', 'pene', 'pese', 'pushi', 'puta', 'raka', 'ri', 'ru', 'rumba', 'rumu', 'sala', 'sambo', 'sangi', 'sangulu', 'sende', 'senga', 'shasa', 'shatsha', 'shi', 'shie', 'shuru', 'singa', 'siro', 'sisi', 'sobolo', 'soko', 'songo', 'ta', 'tadi', 'tako', 'tanda', 'tapata', 'teba', 'tembo', 'to', 'tona', 'tuga', 'tuku', 'twa', 'twaba', 'vi', 'vira', 'wanga', 'wasende', 'we', 'wezi', 'wi', 'za', 'zau', 'zi', 'zu', 'zumba', 'zzo'];
  /* Gabon */
  ...
  const nm12 = ['ba', 'banga', 'barene', 'bo', 'bona', 'coni', 'da', 'de', 'dja', 'do', 'douneu', 'foun', 'ga', 'gamou', 'go', 'gou', 'kambo', 'kata', 'ke', 'kok', 'kokou', 'koni', 'kou', 'koumba', 'la', 'lara', 'labona', 'le', 'linga', 'ma', 'mo', 'mongo', 'mou', 'moutou', 'na', 'nana', 'ne', 'ni', 'nis', 'ra', 'rene', 'ta', 'tam', 'teke', 'tou', 'touala', 'voul', 'yem', 'yumba', 'zic'];
  /* R. Congo */
  const nm13 = ['Be', 'Bou', 'Boua', 'Bouan', 'Boukie', 'Boun', 'Bra', 'Dja', 'Djam', 'Do', 'Doli', 'Don', 'En', 'Enye', 'Etou', 'Etoum', 'Ewo', 'Ga', 'Gam', 'Gambo', 'Imp', 'Impfo', 'Impfon', 'Ka', 'Kaye', 'Ke', 'Kel', 'Ki', 'Kin', 'Kinda', 'Kindam', 'Kinka', 'Ko', 'Komo', 'Le', 'Leka', 'Loa', 'Loan', 'Loandji', 'Lou', 'Loudi', 'Louko', 'Loute', 'Ma', 'Madi', 'Madin', 'Maka', 'Mbi', 'Mbin', 'Mi', 'Min', 'Mindou', 'Mo', 'Mos', 'Mossa', 'Mosse', 'Mossen', 'Mou', 'Mouyo', 'Mouyon', 'Ngo', 'Nka', 'Nza', 'Ollo', 'Ollom', 'Oue', 'Oues', 'Owa', 'Owan', 'Oyo', 'Po', 'Poko', 'Se', 'Sem', 'Si', 'Sibi', 'Tcha', 'Tcham', 'Za', 'Zana'];
  const nm14 = ['ba', 'bala', 'bana', 'be', 'bi', 'binda', 'biti', 'bo', 'boma', 'da', 'damba', 'dima', 'dingou', 'dji', 'djo', 'do', 'douli', 'fondo', 'ga', 'gou', 'jili', 'ka', 'kabana', 'kala', 'kana', 'kiero', 'kola', 'kolela', 'koua', 'la', 'le', 'lela', 'li', 'lisie', 'lombo', 'ma', 'mono', 'na', 'naga', 'no', 'ro', 'sa', 'saka', 'sendjo', 'si', 'sie', 'so', 'te', 'tete', 'ti', 'tou', 'toumbi', 'wo', 'ya', 'yelle', 'yes', 'yondzi', 'zi'];
  /* Zambia */
