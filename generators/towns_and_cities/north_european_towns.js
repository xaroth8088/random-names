export default function north_european_towns() {
  ...
  /* Estonia */
  const nm3 = ['Ab', 'Ant', 'El', 'Haap', 'Jõge', 'Jõh', 'Kär', 'Kal', 'Kar', 'Keh', 'Kei', 'Ki', 'Kiviõ', 'Koht', 'Kun', 'Kure', 'Li', 'Lihu', 'Lok', 'Mõisa', 'Maar', 'Must', 'Nar', 'Ote', 'Pär', 'Põl', 'Pai', 'Pal', 'Rä', 'Räpi', 'Rak', 'Rap', 'Silla', 'Sin', 'Suur', 'Tõr', 'Tü', 'Ta', 'Tal', 'Tam', 'Tar', 'Võ', 'Võh', 'Val', 'Vil'];
  const nm4 = ['de', 'di', 'diski', 'duu', 'ga', 'geva', 'hula', 'ja', 'jandi', 'küla', 'la', 'lamäe', 'li', 'lin', 'lingi', 'linn', 'luoja', 'mäe', 'ma', 'me', 'mme', 'na', 'ngi', 'nu', 'pää', 'pa', 'pina', 'ra', 'ri', 'ru', 'sa', 'saare', 'salu', 'samaa', 'si', 'ski', 'ssaare', 'ssi', 'ste', 'suu', 'tu', 'va', 'vee', 'vere', 'viõli', 'vi'];
  /* Finland */
