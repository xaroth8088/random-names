export default function elven_citys() {
  const nm1 = ['A', 'A\'', 'Af', 'Al', 'All', 'Aly', 'Am', 'Amy', 'An', 'Any', 'Ar', 'As', 'Ash', 'Asy', 'Ay', 'Ca', 'Cy', 'E', 'E\'', 'Ef', 'El', 'Ell', 'Ely', 'Em', 'Emy', 'En', 'Eny', 'Er', 'Es', 'Esh', 'Esy', 'Ey', 'F', 'Fa', 'Fel', 'Fil', 'Fy', 'Fyl', 'Ga', 'Gal', 'Ha', 'He', 'Hy', 'I', 'If', 'Il', 'Ill', 'Ily', 'Im', 'Imy', 'In', 'Iny', 'Ir', 'Is', 'Ish', 'Isy', 'Iy', 'Ja', 'Ji', 'K', 'Ka', 'Ke', 'Ky', 'L', 'La', 'Le', 'Lel', 'Lil', 'Ly', 'Lyl', 'M', 'Ma', 'Math', 'Me', 'Mel', 'Mil', 'Mor', 'My', 'Myl', 'Myt', 'Myth', 'N', 'Na', 'Ne', 'Nel', 'Nil', 'Ny', 'Nyl', 'Nyt', 'Nyth', 'O', 'O\'', 'Of', 'Ol', 'Oll', 'Oly', 'Om', 'Omy', 'On', 'Ony', 'Or', 'Os', 'Osh', 'Osy', 'Oy', 'Ra', 'Re', 'Ry', 'S', 'Sa', 'Sel', 'Sh', 'Sha', 'She', 'Shyl', 'Sil', 'Sy', 'Syl', 'Th', 'Tha', 'The', 'Thel', 'Thil', 'Thy', 'Thyl', 'U', 'Ul', 'Ull', 'Uly', 'Um', 'Umy', 'Un', 'Uny', 'Uy', 'W', 'Wa', 'We', 'Y', 'Y\'', 'Ya', 'Ye', 'Yl', 'Yll'];
