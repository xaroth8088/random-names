export default function mongolians() {
  ...
  const namesMale = ['Abaka', 'Achighhirun', 'Achujam Bugural', 'Adarkidai',
  ...
  const namesFemale = ['Alagh Yid', 'Alan', 'Alan Ghoa', 'Alaqa', 'Altan',
    'Altani', 'Altantsetseg', 'Altun', 'Barghujin', 'Battsetseg', 'Bayarma',
    'Bayarmaa', 'Berude', 'Bolormaa', 'Boragchin', 'Borte', 'Borte Jusin',
