export default function mandalorians() {
  ...
  const nm3 = ['b', 'bb', 'd', 'dd', 'g', 'gg', 'j', 'k', 'kk', 'l', 'll', 'm', 'n', 'nn', 'p', 'r', 'rr', 's', 'ss', 't', 'v', 'y', 'b', 'd', 'g', 'j', 'k', 'l', 'm', 'n', 'p', 'r', 's', 't', 'v', 'y', 'b', 'bb', 'br', 'bz', 'd', 'dd', 'dz', 'dr', 'g', 'gg', 'gb', 'gd', 'ht', 'j', 'k', 'kk', 'kb', 'kd', 'kr', 'ksh', 'l', 'll', 'lm', 'lr', 'm', 'mz', 'n', 'nd', 'ng', 'nn', 'nt', 'nz', 'p', 'ps', 'r', 'rbr', 'rd', 'rg', 'rk', 'rr', 'rst', 'rt', 'rth', 's', 'sc', 'ss', 't', 'ty', 'v', 'y', 'zd'];
  const nm4 = ['', '', '', '', '', '', '', 'c', 'ck', 'd', 'dth', 'g', 'gg', 'gr', 'j', 'k', 'l', 'ld', 'm', 'n', 'ng', 'nk', 'nn', 'nx', 'r', 'rk', 'rr', 'rt', 's', 't', 'th', 'ts', 'x', 'z'];
  const nm5 = ['', '', '', '', '', 'b', 'bh', 'd', 'f', 'h', 'j', 'jh', 'k', 'kh', 'l', 'm', 'n', 'ph', 'r', 's', 'sh', 't', 'th', 'v', 'vh', 'w', 'wh', 'x', 'z', 'zh'];
  const nm6 = ['a', 'e', 'i', 'o', 'u', 'a', 'i', 'a', 'e', 'i', 'o', 'u', 'a', 'i', 'a', 'e', 'i', 'o', 'u', 'a', 'i', 'a', 'e', 'i', 'o', 'u', 'a', 'i', 'aa', 'ao', 'ay', 'oo', 'ae', 'ai', 'ia'];
  const nm7 = ['b', 'bb', 'd', 'dd', 'g', 'gg', 'j', 'k', 'kk', 'l', 'll', 'm', 'n', 'nn', 'p', 'r', 'rr', 's', 'ss', 't', 'v', 'y', 'b', 'd', 'g', 'j', 'k', 'l', 'm', 'n', 'p', 'r', 's', 't', 'v', 'y', 'b', 'c', 'g', 'k', 'n', 'r', 's', 't', 'th', 'v', 'b', 'c', 'g', 'k', 'n', 'r', 's', 't', 'th', 'v', 'b', 'c', 'g', 'k', 'n', 'r', 's', 't', 'th', 'v', 'b', 'bb', 'c', 'ch', 'd', 'dh', 'f', 'ff', 'g', 'h', 'hh', 'k', 'l', 'll', 'm', 'mm', 'mn', 'mr', 'ms', 'n', 'nr', 'nm', 'nt', 'ph', 'r', 'rr', 'rs', 'rt', 'rn', 'rm', 'rl', 's', 'ss', 'sh', 'st', 'sth', 'sm', 'sn', 'sl', 'sk', 't', 'th', 'v', 'vl'];
  const nm8 = ['', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'c', 'h', 'k', 'l', 'lk', 'm', 'n', 'rn', 's', 'sh', 'th'];
  const nm9 = ['', '', '', '', '', 'b', 'bl', 'br', 'c', 'ch', 'cr', 'd', 'dr', 'f', 'g', 'h', 'j', 'k', 'kr', 'l', 'm', 'n', 'p', 'q', 'r', 's', 'sh', 'sk', 'sp', 'st', 'str', 't', 'tr', 'v', 'w', 'wr', 'z'];
  const nm10 = ['a', 'e', 'i', 'o', 'u', 'a', 'o', 'u', 'y', 'a', 'e', 'i', 'o', 'u', 'a', 'o', 'u', 'y', 'a', 'e', 'i', 'o', 'u', 'a', 'o', 'u', 'y', 'oo', 'ou', 'ai', 'ua', 'au', 'uu'];
