export default function ithorians() {
  ...
  const nm3 = ['\'kl', '\'tr', 'b', 'bb', 'c', 'd', 'dl', 'ff', 'g', 'gg', 'ggj', 'h', 'k', 'kk', 'kl', 'kn', 'l', 'ld', 'lj', 'll', 'lln', 'lm', 'ln', 'lr', 'lt', 'm', 'mf', 'ml', 'mw', 'n', 'nc', 'nd', 'nf', 'ngt', 'nst', 'nt', 'nw', 'pl', 'r', 'rf', 'rgl', 'rl', 'rm', 'rn', 'rr', 'rt', 'rth', 's', 'sh', 'sh\'t', 'sm', 'ss', 'sthm', 't', 'th', 'thw', 'tr', 'tt', 'v', 'vv', 'w', 'wb', 'x', 'xx', 'z', 'zl', 'zz'];
  const nm4 = ['', '', '', '', '', 'b', 'bb', 'bs', 'c', 'cl', 'd', 'g', 'gg', 'hp', 'j', 'k', 'l', 'ls', 'm', 'mm', 'n', 'nk', 'ph', 'r', 'rd', 'rg', 'rl', 'rn', 'rr', 's', 'ss', 't', 'th', 'v', 'w', 'wl', 'x', 'z'];
  const nm5 = ['', '', '', '', 'b', 'bh', 'ch', 'cw', 'd', 'dh', 'f', 'fr', 'gh', 'gw', 'h', 'kh', 'kl', 'l', 'm', 'n', 'ph', 'pl', 'pw', 'r', 'rh', 's', 'sh', 'sw', 'sl', 't', 'th', 'tw', 'v', 'vl', 'vh', 'w', 'wh', 'y'];
  const nm6 = ['a', 'e', 'i', 'o', 'u', 'y', 'a', 'e', 'i', 'o', 'u', 'y', 'a', 'e', 'i', 'o', 'u', 'y', 'a', 'e', 'i', 'o', 'u', 'y', 'a', 'e', 'i', 'o', 'u', 'y', 'a', 'e', 'i', 'o', 'u', 'y', 'ee', 'oo', 'uu', 'ii'];
  const nm7 = ['\'sh', '\'th', 'bl', 'ch', 'dh', 'dw', 'f', 'ff', 'gh', 'gw', 'h', 'hh', 'kh', 'kw', 'ks', 'l', 'ls', 'll', 'ln', 'lm', 'lth', 'lsh', 'lw', 'm', 'mm', 'mf', 'mw', 'mn', 'ml', 'mw', 'n', 'nd', 'ndr', 'nf', 'nw', 'nsh', 'ph', 'rsh', 'rs', 'rf', 'rl', 'rh', 'r', 'rw', 'rn', 'rm', 'rth', 'sh', 'sf', 'sv', 'sw', 'shw', 'ss', 'sn', 'sm', 'th', 'thw', 'thl', 'v', 'w', 'wh', 'wl', 'ws', 'wsh'];
  const nm8 = ['', '', '', '', '', '', '', '', '', 'b', 'f', 'g', 'h', 'l', 'm', 'mm', 'n', 'ph', 'r', 's', 'sh', 'ss', 'th', 'w'];
  const nm9 = ['', '', '', '', 'b', 'c', 'ch', 'cr', 'd', 'fl', 'fr', 'h', 'l', 'm', 'n', 'nh', 'p', 'pw', 'r', 's', 'sl', 't', 'v', 'w', 'z'];
