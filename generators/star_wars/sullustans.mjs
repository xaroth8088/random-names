export default function sullustans() {
  ...
  const nm3 = ['b', 'bb', 'br', 'd', 'dm', 'fr', 'g', 'ggl', 'gl', 'hs', 'j', 'kk', 'l', 'll', 'llr', 'lth', 'm', 'md', 'n', 'nb', 'nch', 'nd', 'ng', 'nn', 'nr', 'pl', 'r', 'rg', 'rk', 'rl', 'rn', 'rr', 'rth', 'rw', 'shr', 'ss', 'st', 't', 'th', 'w', 'xt', 'z'];
  const nm4 = ['', '', '', '', '', 'b', 'bb', 'c', 'd', 'dt', 'gg', 'k', 'kk', 'l', 'ld', 'lld', 'ln', 'lss', 'm', 'n', 'nb', 'nt', 'pt', 'r', 'rm', 'rs', 'rt', 's', 'sh', 'ss', 't', 'tz', 'v', 'vv', 'x'];
  const nm5 = ['', '', '', '', '', '', '', '', '', '', 'b', 'ch', 'd', 'f', 'fr', 'g', 'h', 'j', 'k', 'l', 'm', 'n', 'r', 's', 't', 'tr', 'v', 'w', 'z'];
  const nm6 = ['a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'ia', 'ee', 'uo', 'ee', 'aa', 'uu', 'ae', 'ya', 'yu'];
  const nm7 = ['b', 'bb', 'f', 'ff', 'fr', 'gr', 'gg', 'gl', 'hl', 'hn', 'hm', 'l', 'll', 'lb', 'lm', 'ln', 'ld', 'm', 'md', 'mb', 'ml', 'mm', 'n', 'nb', 'nm', 'ng', 'nd', 'p', 'pp', 'r', 'rr', 'rb', 'rd', 'rl', 'rn', 's', 'st', 'sth', 'sd', 'sh', 'ss', 't', 'th', 'tt', 'vv'];
  const nm8 = ['', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'l', 'n', 'nn', 'r', 's', 'ss', 'th', 'v', 'x'];
  const nm9 = ['', '', '', '', '', 'b', 'bd', 'br', 'f', 'fr', 'g', 'gh', 'h', 'j', 'k', 'l', 'm', 'n', 'nh', 'nr', 'p', 'pl', 'r', 's', 'sch', 'sn', 'sq', 'st', 'sw', 't', 'ts', 'v', 'vh', 'w', 'y', 'z'];
