export default function duross() {
  ...
  const nm1 = ['', '', '', 'c', 'd', 'f', 'g', 'h', 'j', 'l', 'm', 'n', 'r',
    's', 'z'];
  const nm2 = ['a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i',
    'o', 'u', 'a', 'e', 'i', 'o', 'u', 'ei', 'aa', 'ai', 'oo'];
  const nm3 = ['d', 'dw', 'hw', 'l', 'lz', 'ls', 'ld', 'lw', 'm', 'ms', 'mz',
    'n', 'ns', 'nz', 'nss', 'nt', 'rw', 'z', 'd', 'l', 'm', 'n', 'z'];
  const nm4 = ['d', 'l', 'm', 'n', 'r'];
  const nm5 = ['ch', 'd', 'f', 'h', 'j', 'l', 'm', 'n', 'r', 's', 't', 'z'];
  const nm6 = ['ch', 'd', 'dw', 'h', 'hl', 'hn', 'hm', 'm', 'mm', 'mn', 'md',
    'ms', 'n', 'nd', 'nl', 'nw', 'ns', 'nt', 'nn', 'rl', 'sl', 'd', 'h', 'm',
    'n', 'l', 'll'];
  const nm7 = ['b', 'd', 'h', 'j', 'k', 'l', 'm', 's', 'st', 't', 'tr', 'v',
    'zh'];
  const nm8 = ['b', 'bb', 'c', 'ch', 'ggl', 'gw', 'gl', 'gn', 'gg', 'g', 'h',
    'kt', 'll', 'lm', 'lw', 'md', 'm', 'mp', 'nw', 'nd', 'nt', 'ns', 'n',
    'rd', 'rl', 'rr', 'z'];
