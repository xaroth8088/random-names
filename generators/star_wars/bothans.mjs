export default function bothans() {
  ...
  const nm1 = ['', '', 'b', 'c', 'd', 'g', 'gr', 'h', 'k', 'n', 'r', 'tr', 'v',
    'y', 'z'];
  const nm2 = ['a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i',
    'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i',
    'o', 'u', 'ae', 'aa', 'ee', 'ai', 'ia'];
  const nm3 = ['b', 'br', 'c', 'ct', 'd', 'dr', 'g', 'h', 'kr', 'k', 'm', 'nt',
    'r', 'ry', 'tr', 'v'];
  const nm4 = ['c', 'g', 'gt', 'k', 'm', 'n', 'r', 'rc', 'rd', 'rsk', 'sc',
    'sk', 'st', 'th'];
  const nm5 = ['', '', '', 'c', 'dh', 'g', 'gn', 'gl', 'h', 'k', 'kn', 'l', 'm',
    'n', 's', 'th', 'v', 'y'];
  const nm6 = ['c', 'g', 'h', 'kh', 'l', 'm', 'n', 'nt', 'nd', 'q', 'qh', 'r',
    'rr', 's', 't', 'th', 'tr', 'v'];
  const nm7 = ['h', 'l', 'm', 'n', 'nn', 'r', 's', 't', 'th'];
  const nm8 = ['bw', 'd', 'f', 'g', 'gr', 'h', 'k', 'kr', 'l', 'm', 'n', 's',
    'tr', 'v'];
  const nm9 = ['a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i',
    'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i',
    'o', 'u', 'ae', 'aa', 'ee', 'ai', 'ia', 'ua', 'ea'];
  const nm10 = ['d', 'd\'h', 'f\'l', '\'f', 'h\'r', 'h', '\'h', 'k', '\'k', 'l',
    '\'l', 'n', 'n\'d', 'nr', 'n\'q', 'nd', 'n\'n', 'q', 'r', 'rr', '\'r',
    's', 's\'', '\'t', 't', 'th', 'v\'', 'y\'l'];
