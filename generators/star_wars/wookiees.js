function generator$star_wars$wookiees() {
  ...
  const nm4 = ['', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'c', 'ch', 'ck', 'drr', 'drrl', 'h', 'hn', 'hr', 'hrr', 'k', 'kk', 'kk', 'kkk', 'l', 'll', 'm', 'n', 'nch', 'nk', 'r', 'rd', 'rk', 'rl', 'rm', 'rph', 'rr', 'rrr', 's', 'sch', 'sh', 'shk', 'ss', 'st', 't', 'v', 'vv', 'w', 'wk', 'wl', 'wn', 'wr'];
  const nm5 = ['', '', '', '', '', '', '', '', '', '', '', 'b', 'br', 'bh', 'c', 'd', 'dr', 'dh', 'dhr', 'f', 'fr', 'g', 'gch', 'ghr', 'gr', 'gw', 'h', 'hw', 'hwr', 'j', 'k', 'kr', 'kh', 'l', 'm', 'n', 'p', 'r', 'rr', 'rh', 'rhr', 's', 'shr', 't', 'w', 'wh', 'wr', 'whr'];
