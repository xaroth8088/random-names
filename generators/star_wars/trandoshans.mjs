export default function trandoshans() {
  ...
  const nm3 = ['ch', 'cr', 'd', 'dfr', 'dg', 'g', 'gg', 'gr', 'hhm', 'hs', 'k', 'khss', 'kk', 'kr', 'ks', 'kt', 'l', 'ld', 'lf', 'll', 'lt', 'm', 'mr', 'n', 'nd', 'ng', 'nk', 'nn', 'nt', 'nv', 'ph', 'qz', 'r', 'rd', 'rk', 'rn', 'rr', 'rth', 'rtsn', 's', 'sd', 'sh', 'sn', 'ss', 'sskr', 't', 'tl', 'tt', 'v', 'vr', 'z', 'zzm'];
  const nm4 = ['', '', '', '', '', '', '', '', '', '', 'b', 'c', 'd', 'ff', 'g', 'gg', 'h', 'hk', 'hssk', 'k', 'kk', 'kss', 'kt', 'l', 'll', 'mx', 'n', 'nk', 'pp', 'q', 'r', 'rg', 'rj', 'rk', 'rkh', 'rq', 'rr', 'rrng', 'rrsk', 'rsk', 'rssk', 'rst', 'rt', 'rth', 's', 'sh', 'shk', 'sk', 'ss', 'ssc', 'ssh', 'ssk', 'sskk', 'sst', 't', 'tch', 'tt', 'v', 'w', 'x', 'xx', 'z'];
  const nm5 = ['', '', '', '', '', '', '', '', '', '', 'b', 'bh', 'bl', 'cl', 'ch', 'cr', 'dh', 'dr', 'f', 'fr', 'fl', 'g', 'gh', 'gr', 'h', 'hs', 'k', 'kh', 'kl', 'kn', 'km', 'l', 'm', 'ms', 'mss', 'mh', 'n', 'ns', 'nh', 'p', 'pr', 'q', 'r', 'rh', 's', 'sh', 'ss', 'sl', 'sm', 'st', 't', 'th', 'tr', 'ts', 'v', 'w', 'z'];
  const nm6 = ['a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'y', 'y', 'y', 'uu', 'ee', 'aa', 'oo', 'ai'];
  const nm7 = ['ch', 'd', 'dw', 'f', 'ff', 'g', 'gg', 'gl', 'h', 'hh', 'hr', 'hs', 'hss', 'k', 'ks', 'khs', 'l', 'ls', 'lss', 'll', 'lf', 'lm', 'ln', 'ld', 'm', 'ml', 'n', 'nl', 'nd', 'nc', 'ph', 'r', 'rs', 'rl', 'rt', 'rth', 'rg', 'sl', 'ss', 'sh', 'st', 't', 'th', 'tt', 'tl', 'v', 'z'];
  const nm8 = ['', '', '', '', '', '', '', '', '', '', 'c', 'd', 'f', 'ff', 'h', 'k', 'kss', 'l', 'm', 'n', 'nn', 'rkh', 's', 'ss', 'sh', 'ssh', 't', 'th'];
  const nm9 = ['', '', '', '', '', '', '', 'b', 'br', 'd', 'dr', 'f', 'g', 'gr', 'h', 'hs', 'hss', 'hsk', 'j', 'jh', 'jhc', 'k', 'kl', 'm', 'n', 'r', 's', 'ss', 'sm', 'st', 'sv', 't', 'tr', 'ts', 'v', 'vl', 'z'];
