function generator$star_wars$gungans() {
  ...
  const nm3 = ['b', 'bb', 'bl', 'bs', 'd', 'dr', 'g', 'gg', 'k', 'kf', 'kn', 'l', 'll', 'llb', 'lsb', 'lsk', 'ly', 'm', 'mb', 'mf', 'n', 'nb', 'nk', 'nn', 'nt', 'p', 'pp', 'r', 'rk', 'rs', 'rt', 'rv', 's', 'sm', 'ss', 't', 'tt', 'v', 'x', 'z', 'zz'];
  const nm4 = ['', '', '', 'b', 'c', 'd', 'f', 'ff', 'gg', 'h', 'k', 'l', 'm', 'n', 'nn', 'p', 'r', 'rd', 'rt', 's', 'sh', 'sk', 'ss', 'w'];
  const nm5 = ['', '', '', '', '', 'b', 'bl', 'c', 'cl', 'd', 'dh', 'f', 'fl', 'fr', 'h', 'j', 'kl', 'kh', 'l', 'm', 'n', 'p', 'r', 's', 'sh', 'spl', 't', 'th', 'w', 'y'];
  const nm6 = ['bl', 'bb', 'b', 'bs', 'd', 'dd', 'dh', 'f', 'ff', 'g', 'l', 'll', 'ls', 'lb', 'ls', 'm', 'mm', 'mb', 'mf', 'n', 'nb', 'nn', 'nd', 'p', 'pf', 'pd', 'pp', 'r', 'rt', 'rs', 's', 'ss', 'sm', 'sn', 'sd', 't', 'th', 'tt', 'w', 'x', 'z'];
  const nm7 = ['', '', '', '', '', 'b', 'd', 'f', 'ff', 'g', 'h', 'l', 'm', 'n', 'rs', 's', 'ss', 'w'];
