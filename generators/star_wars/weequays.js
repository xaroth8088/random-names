function generator$star_wars$weequays() {
  ...
  const nm7 = ['c', 'cr', 'cn', 'cm', 'g', 'gg', 'gm', 'gr', 'gs', 'h', 'hm', 'hn', 'hr', 'hs', 'km', 'kn', 'kr', 'kl', 'ks', 'l', 'll', 'lm', 'lk', 'lc', 'lr', 'ls', 'mk', 'mr', 'n', 'mm', 'm', 'nn', 'nd', 'nk', 'r', 'rk', 'rm', 'rr', 's', 'ss', 'sk', 'sm'];
  const nm8 = ['', '', '', '', '', '', '', '', '', '', 'c', 'g', 'h', 'k', 'l', 'm', 'n', 'r', 's', 't', 'x', 'z'];
  const nm9 = ['', '', '', '', '', '', 'b', 'bl', 'br', 'd', 'dr', 'dl', 'f', 'fr', 'fl', 'g', 'gr', 'gl', 'gh', 'k', 'kr', 'kl', 'kh', 'l', 'm', 'n', 'r', 's', 'sh', 'st', 'sv', 'sw', 'sl', 't', 'th', 'tr', 'tl', 'v', 'vr', 'vl'];
