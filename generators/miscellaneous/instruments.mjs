export default function instruments() {
  ...
  const names2 = ['b', 'c', 'd', 'f', 'g', 'h', 'j', 'k', 'l', 'm', 'n', 'p',
    'q', 'r', 's', 't', 'v', 'w', 'x', 'y', 'z', 'br', 'cr', 'gr', 'pr', 'tr',
    'ch', 'bl', 'cl', 'fl', 'gl', 'kl', 'pl', 'sl', 'vl', 'st', 'str'];
  const names3 = ['a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'ia', 'ie',
    'io', 'ai', 'ea', 'ei', 'eo'];
  const names4 = ['b', 'd', 'f', 'g', 'h', 'k', 'l', 'm', 'n', 'p', 'q', 'r',
    's', 't', 'w', 'x', 'y', 'ld', 'lf', 'lk', 'lm', 'ln', 'lp', 'ls', 'lt',
    'ck', 'cs', 'ct', 'ft', 'mn', 'ms', 'ng', 'ns', 'ps', 'rd', 'rg', 'rk',
    'rs', 'rt', 'sk', 'ss', 'll', 'st', 'sh'];
  const names5 = ['a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'ia', 'ie',
    'io', 'ai', 'ea', 'ei', 'eo'];
  const names6 = ['b', 'c', 'd', 'f', 'g', 'h', 'j', 'k', 'l', 'm', 'n', 'p',
    'q', 'r', 's', 't', 'v', 'w', 'x', 'y', 'z', 'bb', 'cc', 'dd', 'ff', 'gg',
    'kk', 'll', 'mm', 'nn', 'pp', 'rr', 'ss', 'tt', 'zz', 'br', 'cr', 'gr',
    'pr', 'tr', 'ch', 'bl', 'cl', 'fl', 'gl', 'kl', 'pl', 'sl', 'vl', 'st',
    'str'];
  const names7 = ['a', 'e', 'i', 'o', 'u', 'ia', 'io', 'ea', 'ei', 'eo'];
  const names8 = [' Accordion', ' Bass', ' Bow', ' Clarinet', ' Drum', ' Drums',
    ' Flute', ' Guitar', ' Harmonica', ' Horn', ' Organ', ' Pipe',
    ' Saxophone', ' Trombone', ' Trumpet', ' Tuba', ' Violin', ' Whistle',
    'horn', 'phone', 'pipe', 'horn', 'phone', 'phone', 'phone', 'phone',
    'pipe'];
