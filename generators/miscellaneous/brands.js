export default function brands() {
  ...
  const nm3 = ['a', 'e', 'i', 'o', 'u'];
  const nm4 = ['ee', 'eu', 'eo', 'ea', 'ei', 'aa', 'ai', 'au', 'ae', 'io', 'ia', 'iu', 'ie', 'oo', 'oa', 'ou', 'oe', 'oi', 'uu', 'ua', 'ue', 'ui', 'uo'];
  const nm5 = ['bb', 'bd', 'bh', 'br', 'cc', 'ch', 'ck', 'cl', 'cr', 'cs', 'csh', 'ct', 'cth', 'cz', 'dd', 'dg', 'dn', 'dr', 'ff', 'fk', 'fn', 'fr', 'ft', 'gb', 'gd', 'gg', 'gh', 'gm', 'gn', 'gr', 'hh', 'hk', 'hl', 'hm', 'hn', 'hr', 'kh', 'kk', 'kn', 'kr', 'ks', 'kt', 'kz', 'lb', 'lc', 'ld', 'lf', 'lg', 'lh', 'lk', 'll', 'lm', 'ln', 'lp', 'lph', 'lq', 'lr', 'ls', 'lsh', 'lt', 'lw', 'lz', 'mb', 'md', 'mh', 'mk', 'ml', 'mm', 'mn', 'mp', 'mph', 'mr', 'ms', 'msh', 'mt', 'nc', 'nd', 'ng', 'nk', 'nl', 'nn', 'np', 'nq', 'nr', 'ns', 'nt', 'nw', 'nz', 'ph', 'pm', 'pn', 'pp', 'pq', 'pr', 'phr', 'pt', 'ps', 'pz', 'rb', 'rc', 'rd', 'rf', 'rg', 'rh', 'rk', 'rl', 'rm', 'rn', 'rp', 'rph', 'rq', 'rr', 'rs', 'rst', 'rt', 'rw', 'rz', 'sb', 'sc', 'sd', 'sh', 'sk', 'sl', 'sm', 'sn', 'sp', 'sph', 'sr', 'ss', 'st', 'str', 'sz', 'th', 'tl', 'tm', 'tn', 'tr', 'thr'];
  ...
  const nm9 = ['', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'ee', 'eu', 'eo', 'ea', 'ei', 'aa', 'ai', 'au', 'ae', 'io', 'ia', 'iu', 'ie', 'oo', 'oa', 'ou', 'oe', 'oi', 'uu', 'ua', 'ue', 'ui', 'uo'];
