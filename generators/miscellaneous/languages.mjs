export default function languages() {
  ...
  let rnd5;
  let rnd6;
  const nm1 = ['b', 'c', 'd', 'f', 'g', 'h', 'j', 'k', 'l', 'm', 'n', 'p', 'q', 'r', 's', 't', 'v', 'w', 'x', 'y', 'z', 'b', 'c', 'd', 'f', 'g', 'h', 'j', 'k', 'l', 'm', 'n', 'p', 'q', 'r', 's', 't', 'v', 'w', 'x', 'y', 'z', 'b', 'c', 'd', 'f', 'g', 'h', 'j', 'k', 'l', 'm', 'n', 'p', 'q', 'r', 's', 't', 'v', 'w', 'x', 'y', 'z', 'bh', 'bl', 'br', 'ch', 'cl', 'cr', 'cy', 'dh', 'dr', 'fh', 'fl', 'fr', 'gh', 'gn', 'gl', 'gr', 'kh', 'kl', 'kn', 'kr', 'mh', 'my', 'nh', 'ph', 'pl', 'pr', 'pn', 'rh', 'sc', 'sh', 'sl', 'sm', 'sn', 'sp', 'sr', 'st', 'str', 'th', 'tr', 'ty', 'vh', 'wh', 'zh'];
  const nm2 = ['a', 'e', 'o', 'i', 'u', 'a', 'e', 'o', 'i', 'u', 'a', 'e', 'o', 'i', 'u', 'a', 'e', 'o', 'i', 'u', 'ae', 'ao', 'ai', 'au', 'ea', 'eo', 'ei', 'eu', 'oa', 'oe', 'oi', 'ou', 'ia', 'ie', 'io', 'iu', 'ua', 'ue', 'uo', 'ui', 'aa', 'ee', 'oo', 'uu'];
