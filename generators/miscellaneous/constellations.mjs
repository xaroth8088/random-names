export default function constellations() {
  ...
  let rnd;
  let rnd2;
  const nm1 = ['Acanthuridae', 'Achatina', 'Achatinoidea', 'Acidalia',
  ...
  const nm2 = ['Major', 'Minor', 'Australis', 'Borealis', 'Occidentalis',
    'Orientalis'];
  const nm3 = ['Amaranth', 'Amber', 'Amethyst', 'Aquamarine', 'Azure', 'Black',
    'Blue', 'Brown', 'Cerulean', 'Citrine', 'Cobalt', 'Crimson', 'Diamond',
    'Ebony', 'Emerald', 'Green', 'Harlequin', 'Ivory', 'Jade', 'Jasmine',
    'Malachite', 'Maroon', 'Onyx', 'Orange', 'Pearl', 'Red', 'Ruby',
    'Sapphire', 'Scarlet', 'Vermilion', 'Violet', 'White'];
  const nm4 = ['Albatross', 'Alligator', 'Ant', 'Antelope', 'Horse',
    'Armadillo', 'Baboon', 'Badger', 'Bandicoot', 'Bat', 'Bear', 'Starfish',
    'Beaver', 'Bee', 'Bird', 'Bison', 'Boar', 'Buffalo', 'Butterfly', 'Cat',
    'Catfish', 'Chameleon', 'Chipmunk', 'Cobra', 'Cow', 'Crab', 'Crane',
    'Crow', 'Deer', 'Dog', 'Donkey', 'Dove', 'Dragon', 'Dragonfly', 'Duck',
    'Eagle', 'Elephant', 'Flamingo', 'Fox', 'Frog', 'Gazelle', 'Gecko',
    'Gerbil', 'Goat', 'Goose', 'Hare', 'Hawk', 'Hedgehog', 'Hippo',
    'Hummingbird', 'Hyena', 'Ibis', 'Iguana', 'Jackal', 'Kangaroo', 'Koala',
    'Lemur', 'Leopard', 'Lion', 'Lizard', 'Llama', 'Lobster', 'Lynx', 'Macaw',
    'Mockingbird', 'Mongoose', 'Monkey', 'Mouse', 'Mule', 'Ocelot', 'Ostrich',
    'Otter', 'Owl', 'Ox', 'Parror', 'Pelican', 'Penguin', 'Pheasant', 'Pig',
    ...
    'Whale', 'Wolf', 'Yak'];
  const nm5 = ['Big', 'Small', 'Southern', 'Northern', 'Western', 'Eastern',
    'Tiny', 'Large'];
  const nm6 = ['Helmet', 'Shield', 'Sword', 'Compass', 'Ship', 'Hammer',
    'Chisel', 'Crown', 'Cup', 'Cross', 'River', 'Furnace', 'Bridge', 'Fire',
    'Flame', 'Gem', 'Diamond', 'Clock', 'Table', 'Arrow', 'Temple', 'Archer',
    'Knight', 'Telescope', 'Pyramid', 'Triangle', 'Robe', 'Scarf', 'Chair',
    'Candle', 'Tower', 'House', 'Castle', 'Torch', 'Feather', 'Rod', 'Leaf',
    'Tree', 'Flower', 'Petal', 'Droplet', 'Gate', 'Spear', 'Dagger',
    'Fountain', 'Horn', 'Tooth', 'Claw', 'Lantern', 'Light', 'Drum', 'Cart',
    'Axe', 'Hatchet', 'Pickaxe', 'Eye', 'Mountain', 'River', 'Flute', 'Wheel',
    'Altar', 'Skull', 'Throne', 'Flag', 'Boulder', 'Wave', 'Maze', 'Scepter',
    'Soldier', 'Spade', 'Wing', 'Couldron', 'Broom', 'Lance', 'Spear',
    'Tiara', 'Cannon', 'Cannonball', 'Pistol', 'Rifle', 'Anvil', 'Airplane',
    'Wrench', 'Horseshoe', 'Needle', 'Screw', 'Sapling', 'Pipe', 'Hat',
