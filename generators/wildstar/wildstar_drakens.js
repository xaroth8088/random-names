function generator$wildstar$wildstar_drakens() {
  const type = Math.random() > 0.5 ? 0 : 1;
  const nm1 = ['', '', '', '', '', 'b', 'd', 'g', 'h', 'j', 'k', 'm', 'n', 'r', 'v', 'z'];
  const nm2 = ['a', 'i', 'o', 'u', 'a', 'i', 'o', 'u', 'a', 'i', 'o', 'u', 'a', 'i', 'o', 'u', 'a', 'i', 'o', 'u', 'a', 'i', 'o', 'u', 'a', 'i', 'o', 'u', 'aa', 'ua', 'ia', 'uu'];
  const nm3 = ['c', 'cr', 'dr', 'g', 'gg', 'gr', 'gh', 'k', 'kr', 'kk', 'l', 'n', 'nk', 'ng', 'q', 'r', 'rr', 'rk', 'rg', 'rq', 'v', 'vr', 'vh', 'z', 'zg', 'c', 'g', 'k', 'l', 'n', 'q', 'r', 'v', 'z', 'c', 'g', 'k', 'l', 'n', 'q', 'r', 'v', 'z', 'c', 'g', 'k', 'l', 'n', 'q', 'r', 'v', 'z', 'c', 'g', 'k', 'l', 'n', 'q', 'r', 'v', 'z'];
  const nm4 = ['d', 'n', 'r', 's', 'th', 'z'];
  const nm5 = ['c', 'g', 'j', 'k', 'm', 'n', 'r', 's', 't', 'v', 'z'];
  const nm6 = ['a', 'e', 'i', 'o', 'a', 'e', 'i', 'o', 'a', 'e', 'i', 'o', 'a', 'e', 'i', 'o', 'ia', 'ee', 'ae', 'ie'];
