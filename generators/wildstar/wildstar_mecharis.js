export default function wildstar_mecharis() {
  ...
  const nm3 = ['c', 'cr', 'chr', 'ct', 'g', 'gn', 'gz', 'kr', 'kt', 'kx', 'kn', 'l', 'lb', 'll', 'mph', 'n', 'ph', 'pr', 'ps', 'r', 'rx', 'rc', 'rct', 'rm', 'rv', 'rz', 'st', 'sp', 't', 'tr', 'v', 'x', 'xt', 'c', 'g', 'l', 'n', 'r', 't', 'v', 'x'];
  const nm4 = ['', 'c', 'cs', 'n', 'm', 'r', 's', 't', 'x'];
  const nm5 = ['', '', '', '', '', 'c', 'd', 'h', 'l', 'm', 'n', 'ph', 'phr', 's', 'sh', 't', 'th', 'v', 'z'];
  const nm6 = ['a', 'e', 'i', 'o', 'a', 'e', 'i', 'o', 'a', 'e', 'i', 'o', 'a', 'e', 'i', 'o', 'a', 'e', 'i', 'o', 'a', 'e', 'i', 'o', 'y', 'y', 'y', 'ia', 'au', 'ie', 'io'];
  const nm7 = ['b', 'br', 'c', 'd', 'dr', 'f', 'fr', 'fn', 'fl', 'gh', 'lv', 'ln', 'lm', 'lz', 'lph', 'lf', 'm', 'mz', 'mr', 'mn', 'n', 'nv', 'nz', 'r', 'rk', 'rv', 'rz', 'rs', 't', 'th', 'v', 'x', 'z', 'zn', 'b', 'c', 'd', 'f', 'm', 'n', 'r', 't', 'v', 'x', 'z', 'b', 'c', 'd', 'f', 'm', 'n', 'r', 't', 'v', 'x', 'z'];
