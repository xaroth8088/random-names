export default function nephalems() {
  ...
  const nm1 = ['', '', '', '', 'b', 'c', 'd', 'g', 'j', 'k', 'l', 'm', 'n',
    'ph', 'r', 't', 'v', 'w', 'z'];
  const nm2 = ['a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i',
    'o', 'u', 'a', 'e', 'i', 'o', 'u', 'ia', 'oe', 'io', 'y'];
  const nm3 = ['c', 'dr', 'gr', 'l', 'ld', 'lm', 'ln', 'm', 'md', 'mn', 'n',
    'nd', 'r', 'rl', 'rd', 's', 'ss', 'th', 'thm', 'z'];
  const nm4 = ['', '', '', '', '', 'b', 'c', 'd', 'k', 'l', 'ln', 'lm', 'n',
    'r', 's'];
  const nm5 = ['', '', '', '', '', 'ch', 'h', 'j', 'l', 'm', 'n', 'ph', 'r',
    'rh', 's', 'sh', 'w', 'z'];
  const nm6 = ['a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i',
    'o', 'u', 'y'];
  const nm7 = ['dr', 'l', 'll', 'lm', 'ln', 'ld', 'm', 'mn', 'n', 'nm', 'nn',
    'nr', 'mr', 'lgr', 'n', 'r', 'rl', 'rn', 'rm', 'rsh', 's', 'sh', 'ss',
    'th'];
