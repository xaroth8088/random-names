export default function mirialans() {
  ...
  const nm1 = ['i', 'a', 'o', 'e', 'u', '', '', '', '', '', '', '', '', '', '',
    '', '', '', '', '', '', '', '', '', ''];
  const nm2 = ['b', 'c', 'ch', 'd', 'f', 'fl', 'g', 'h', 'j', 'k', 'l', 'm',
    'n', 'p', 'q', 'r', 's', 'sh', 't', 'v', 'v', 'w', 'y', 'z', 'z'];
  const nm3 = ['i', 'a', 'o', 'e', 'u'];
  const nm4 = ['b', 'c', 'd', 'f', 'g', 'h', 'k', 'l', 'm', 'n', 'p', 'q', 'r',
    's', 't', 'v', 'v', 'w', 'y', 'z', 'z'];
  const nm5 = ['b', 'c', 'd', 'f', 'g', 'h', 'k', 'l', 'm', 'n', 'p', 'q', 'r',
    's', 't', 'v', 'v', 'w', 'y', 'z', 'z', '', '', '', '', '', '', '', '',
    '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '',
    '', '', '', '', '', '', '', '', '', '', '', '', '', ''];
  const nm6 = ['i', 'a', 'o', 'e', 'u', '', '', '', '', '', '', '', '', '', ''];
  const nm7 = ['b', 'c', 'ch', 'd', 'f', 'g', 'h', 'k', 'l', 'm', 'n', 'p', 'q',
    'r', 's', 'sh', 't', 'v', 'v', 'w', 'y', 'z', 'z', '', '', '', '', '', '',
    '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '',
    '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''];
  const nm8 = ['b', 'c', 'ch', 'd', 'f', 'fl', 'g', 'h', 'i', 'j', 'k', 'l',
    'm', 'n', 'p', 'q', 'r', 's', 'sh', 't', 'v', 'w', 'y', 'z'];
  const nm9 = ['b', 'c', 'ch', 'd', 'f', 'g', 'h', 'i', 'k', 'l', 'm', 'n', 'p',
