function generator$warhammer_40k$eldars() {
  ...
  const names2 = ['baer', 'ban', 'bas', 'bryn', 'byn', 'davar', 'deer', 'dor', 'drad', 'dras', 'duin', 'gan', 'gard', 'gen', 'groth', 'hidon', 'hith', 'hyn', 'kas', 'kin', 'kon', 'kyn', 'las', 'lath', 'leath', 'leth', 'lim', 'lion', 'lon', 'lyth', 'maer', 'mar', 'mas', 'men', 'mes', 'mon', 'more', 'naer', 'nar', 'nedor', 'nel', 'nyl', 'rad', 'ran', 'ranel', 'rendil', 'rian', 'riel', 'rion', 'rith', 'ros', 'roth', 'ruin', 'rys', 'saar', 'san', 'seith', 'sen', 'seth', 'shin', 'shor', 'sys', 'tar', 'tari', 'telar', 'thanil', 'tharal', 'thorn', 'tien', 'tyr', 'van', 'var', 'vel', 'vor', 'vyn'];
  const names3 = ['Al', 'Aem', 'Ami', 'Aeme', 'Ali', 'Ara', 'Aris', 'Arre', 'Ashe', 'Baha', 'Bela', 'Baer', 'Baera', 'Balan', 'Bel', 'Baele', 'Behne', 'Bore', 'Caen', 'Cela', 'Caella', 'Cel', 'Dil', 'Dera', 'Den', 'Daen', 'El', 'Ela', 'Elra', 'Elsar', 'Faen', 'Fen', 'Fir', 'Fo', 'Fae', 'Gela', 'Gellan', 'Gil', 'Gilsa', 'Gen', 'Gil', 'Ilra', 'Ilro', 'Irli', 'Ise', 'Isen', 'Kae', 'Khel', 'Kaera', 'Kay', 'Kel', 'Lae', 'Lana', 'Lae', 'Len', 'Li', 'Mes', 'Mae', 'Mena', 'Mene', 'Menel', 'Meh', 'Mello', 'Ola', 'One', 'Ore', 'Osi', 'Oasa', 'Tae', 'Tel', 'Taphe', 'Ten', 'Yl', 'Yna', 'Yse'];
