export default function krogans() {
  ...
  const names1 = ['B', 'Br', 'C', 'Cr', 'Ch', 'D', 'Dr', 'F', 'G', 'Gr', 'H',
    ...
    'Str', 'T', 'Tr', 'V', 'Vr', 'W', 'Wr', 'Zr'];
  const names2 = ['a', 'e', 'u', 'i', 'o', 'a', 'u'];
  const names3 = ['rr', 'x', 'nd', 'nk', 'yas', 'rm', 'rn', 'rk', 'tack', 'rg',
    'g', 'gg', 'sk', 'zk', 'nd', 'd', 'rd', 'xx', 'yak', 'yax', 'rak', 'nak',
    'kar', 'kor', 'lak', 'gor', 'gar', 'gas', 'r'];
  const names5 = ['ash', 'bakur', 'brakir', 'dark', 'drak', 'drax', 'dtar', 'k',
    'kador', 'karor', 'kirum', 'kmar', 'kmor', 'krax', 'ksan', 'ksar', 'kson',
    'ksor', 'l', 'lot', 'mar', 'nar', 'ndok', 'ntor', 'rax', 'rbok', 'rbon',
    'rdak', 'rdan', 'rdok', 'rdon', 'rgal', 'rgon', 'rkan', 'rloc', 'rlok',
    'rsan', 'rtak', 'tarog', 'tarok', 'tarum', 'tarun', 'tatog', 'tilak',
    'vanor', 'varog', 'vrak', 'x', 'yrdok', 'yrloc'];
  if (type === 1) {
    names4 = [''];
  } else {
    names4 = ['a', 'e', 'u', 'i', 'o', 'a'];
