export default function unsullieds() {
  const names1 = ['Ash', 'Awful', 'Bad', 'Black', 'Blue', 'Bottom', 'Broken', 'Brown', 'Cheap', 'Dirt', 'Dirty', 'Down', 'Drab', 'Dreck', 'Dust', 'Feeble', 'Filthy', 'Foul', 'Fragile', 'Frail', 'Garbage', 'Grease', 'Grey', 'Grim', 'Grime', 'Grisly', 'Gross', 'Grotesque', 'Hideous', 'Horrid', 'Ill', 'Inferior', 'Infirm', 'Junk', 'Lesser', 'Little', 'Lousy', 'Low', 'Meager', 'Measly', 'Mediocre', 'Menial', 'Messy', 'Minor', 'Monstrous', 'Muck', 'Mud', 'Murky', 'Nasty', 'Paltry', 'Peon', 'Pesky', 'Poor', 'Puny', 'Raunchy', 'Red', 'Repulsive', 'Revolting', 'Sad', 'Scant', 'Scrap', 'Shame', 'Shoddy', 'Sick', 'Slag', 'Slimey', 'Slop', 'Smut', 'Soil', 'Soot', 'Stink', 'Tiny', 'Trash', 'Trashy', 'Trivial', 'Ugly', 'Vile', 'Waste', 'Worthless', 'Wracked', 'Wretched'];
