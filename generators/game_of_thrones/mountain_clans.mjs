export default function mountain_clans() {
  ...
  const names3 = ['Bi', 'Bra', 'Bre', 'Bu', 'Cha', 'Che', 'Cru', 'Cwe', 'Da', 'De', 'Dre', 'Dri', 'Fa', 'Fe', 'Fra', 'Fri', 'Ge', 'Gi', 'Gre', 'Gri', 'Gwe', 'Ma', 'Mhe', 'Mi', 'Pha', 'Phu', 'Pre', 'Pru', 'Ra', 'Re', 'Ri', 'Ru', 'Sha', 'Sre', 'Sta', 'Ste', 'Ta', 'Tra', 'Tre', 'Tri'];
