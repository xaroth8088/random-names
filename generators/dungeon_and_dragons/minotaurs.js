function generator$dungeon_and_dragons$minotaurs() {
  ...
  const namesMaleF = ['Ar', 'Are', 'Aste', 'Bjor', 'Car', 'Cod', 'Da', 'Djar', 'Djun', 'Doen', 'Dor', 'Dur', 'Foos', 'Gar', 'Goe', 'Gra', 'Gran', 'Gun', 'Hun', 'Ja', 'Jar', 'Kar', 'Kin', 'Kir', 'Koo', 'Koor', 'Krum', 'Kur', 'Man', 'Min', 'Mir', 'Noo', 'Pod', 'Rak', 'Te', 'Toon', 'Trak', 'Tur', 'Zam', 'Zun'];
  const namesMaleL = ['ban', 'baran', 'bur', 'dak', 'daran', 'dor', 'fajar', 'faruk', 'furan', 'gajan', 'garak', 'gur', 'jar', 'kan', 'kar', 'karat', 'kun', 'kurat', 'kus', 'manuk', 'maruk', 'nark', 'narun', 'paran', 'raduk', 'rak', 'rakar', 'ranak', 'rapak', 'ras', 'rat', 'rios', 'ron', 'rus', 'rut', 'tagar', 'taruk', 'toron', 'turok', 'tus'];
