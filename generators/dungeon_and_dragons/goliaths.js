function generator$dungeon_and_dragons$goliaths() {
  ...
  const namesMaleF = ['Ag', 'Apa', 'Au', 'Aug', 'Eg', 'Gau', 'Gea', 'Gha', 'Ili', 'Kana', 'Kava', 'Keo', 'Khu', 'La', 'Ma', 'Mau', 'Mea', 'Mo', 'Na', 'Neo', 'Pa', 'Pu', 'Tha', 'Thava', 'Tho', 'Va', 'Vau', 'Vega', 'Vi', 'Vo'];
