export default function romulans() {
  ...
  const nm1 = ['b', 'ch', 'c', 'd', 'h', 'j', 'k', 'l', 'm', 'n', 'p', 'r', 's',
    't', 'th', 'v', 'vr', 'x', '', ''];
  const nm2 = ['a', 'e', 'i', 'o', 'u'];
  const nm3 = ['b', 'c', 'chr', 'j', 'k', 'l', 'j', 'k', 'l', 'lm', 'ld', 'm',
    'm', 'ns', 'nd', 'ncl', 'r', 'r', 'rr', 't', 't', 'v'];
  const nm4 = ['a', 'e', 'i', 'o', 'u', 'ai', 'ee', 'iu'];
  const nm5 = ['', 'b', 'hk', 'k', 'l', 'm', 'n', 'r', 's', 't', 'th', 'x'];
  const nm6 = ['', 'a', 'e', 'o', '', '', '', '', '', '', '', '', '', ''];
  const nm7 = ['b', 'c', 'd', 'h', 'k', 'l', 'm', 'n', 'p', 'r', 's', 't', 'th',
    'v'];
  ...
  const nm11 = ['', 'a', 'a']; {
    if (type === 1) {
      ...
      names = nm7[rnd] + nm2[rnd2] + nm8[rnd3] + nm9[rnd4] + nm10[rnd5] + nm11[
        rnd6];
    } else {
