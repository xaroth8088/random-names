export default function benzites() {
  ...
  const nm2 = ['a', 'e', 'u', 'i', 'o'];
  const nm3 = ['b', 'd', 'r', 'rr', 'dd', 'zz', 'rb', 'rd', 'rg', 'rj', 'rk',
    'rq', 'rt', 'rh', 'rl', 'rs', 'rv', 'nd', 'ng', 'nd', 'nr', 'nt', 'nv',
    'dg', 'zd', 'zg', 'zr'];
  const nm4 = ['ck', 'n', 'k', 'd', 'r', 'z', 't', 'g'];
  const nm5 = ['ar', 'or', 'ur', 'an', 'on', 'un', 'at', 'ot', 'ut', 'az', 'oz',
    'uz', 'ab', 'ob', 'ub', 'ad', 'od', 'ud', 'ak', 'ok', 'uk', '', '', '',
    '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '',
    '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '',
    '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '',
    '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''];
  const nm6 = ['b', 'c', 'd', 'g', 'j', 'k', 'm', 'p', 'q', 'r', 't', 'v', 'z'];
  const nm7 = ['b', 'c', 'd', 'g', 'h', 'j', 'k', 'l', 'p', 'q', 'r', 't', 'v',
    'x', 'y', 'z', 'cc', 'dd', 'gg', 'kk', 'pp', 'qq', 'rr', 'tt', 'vv', 'xx',
    'zz'];
