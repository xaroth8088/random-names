export default function rigelians() {
  ...
  const nm1 = ['B', 'C', 'Ch', 'D', 'G', 'Gr', 'K', 'Kr', 'M', 'Pr', 'R', 'Sr',
    'Sch', 'T', 'V', 'Vr', 'W', 'Z'];
  const nm2 = ['a', 'ae', 'ei', 'i', 'o', 'ou', 'u', 'a', 'u', 'a', 'u', 'o',
    'ii', 'ea', 'oo', 'aa', 'a', 'u'];
  const nm3 = ['b', 'b', 'ch', 'd', 'g', 'd', 'g', 'gr', 'k', 'l', 'm', 'n',
    't', 'v', 'w', 'k', 'l', 'm', 'n', 't', 'v', 'w', 'xt', 'y', 'z', 'y',
    'z', 'zy'];
  const nm4 = ['d', 'k', 'l', 'lr', 'n', 'p', 'r', 't', 'v', '', ''];
  const nm5 = ['B', 'C', 'H', 'J', 'K', 'Kh', 'R', 'S', 'Sh', 'X', 'Y', 'Z',
    'Zh'];
  const nm6 = ['a', 'ae', 'ei', 'i', 'o', 'ou', 'u', 'a', 'u', 'a', 'u', 'o',
    'ii', 'ea', 'oo', 'aa', 'oi', 'ee'];
  const nm7 = ['c', 'ch', 'gg', 'gr', 'l', 'll', 'ln', 'ngy', 'ng', 'n', 'm',
