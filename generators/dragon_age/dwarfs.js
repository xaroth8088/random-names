function generator$dragon_age$dwarfs() {
  ...
  const namesMale = ['Ade', 'Adema', 'Ahre', 'Ali', 'An', 'Ba', 'Bai', 'Bande', 'Bar', 'Be', 'Bera', 'Bere', 'Bhe', 'Bhele', 'Bo', 'Boda', 'Boe', 'Bro', 'Bru', 'Bu', 'Czi', 'Da', 'Dai', 'De', 'Dene', 'Dou', 'Du', 'Duli', 'Dwo', 'Dwy', 'Emry', 'En', 'Endri', 'Eve', 'Fi', 'Figo', 'Fra', 'Ga', 'Gar', 'Gari', 'Garte', 'Ge', 'Ger', 'Gera', 'Gla', 'Go', 'Goi', 'Gor', 'Gori', 'Gwi', 'Hi', 'Hir', 'Hiro', 'Hu', 'Hugi', 'Iwa', 'Ja', 'Jana', 'Java', 'Je', 'Jer', 'Ju', 'Ka', 'Kar', 'Le', 'Lo', 'Loi', 'Lu', 'Luc', 'Ma', 'Mai', 'Me', 'Mer', 'Meri', 'Mi', 'Min', 'Na', 'Nal', 'Ne', 'Nevi', 'Og', 'Ola', 'Or', 'Oski', 'Pi', 'Pio', 'Py', 'Pyr', 'Pyra', 'Re', 'Ren', 'Rha', 'Ro', 'Ru', 'Sa', 'San', 'Se', 'Sewe', 'Te', 'Tem', 'Tha', 'Thati', 'Thau', 'To', 'Tri', 'Tria', 'Tu', 'Va', 'Var', 'Ve', 'Vel', 'Vo', 'Vol', 'Wi', 'Wo', 'Wor', 'Ye'];
