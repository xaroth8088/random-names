export default function rifles() {
  ...
  let rnd2;
  let rnd3;
  const nm1 = ['Abomination', 'Agony', 'Allegiance', 'Alpha', 'Amigo',
    'Amnesia', 'Apocalypse', 'Armageddon', 'Ash', 'Ashes', 'Atomic Annie',
    'Baby', 'Battery', 'Battlestar', 'Betrayal', 'Betrayer', 'Big Bertha',
    ...
    'Boomer', 'Boomstick', 'Brass Rain', 'Brutality', 'Brutalizer', 'Bulldog',
    'Burn', 'Burp', 'Cataclysm', 'Catastrophe', 'Chance', 'Chaos', 'Comet',
    'Corpsemaker', 'Corruption', 'Cosmos', 'Crash', 'Crimson', 'Crossfire',
    'Cruiser', 'Crush', 'Cyclone', 'Daddy', 'Damnation', 'Darkness', 'Dawn',
    'Deadeye', 'Deathbringer', 'Deathraze', 'Decimation', 'Demise',
    'Desolation', 'Despair', 'Destiny', 'Destruction', 'Devastation',
    'Devotion', 'Devourer', 'Discharge', 'Disturbance', 'Divine', 'Dominance',
    'Dominion', 'Doom', 'Downpour', 'Dragonmaw', 'Dragonstrike',
    'Dreamhunter', 'Due Diligence', 'Early Retirement', 'Echo', 'Eclipse',
    'Emergency', 'End of Dreams', 'Endbringer', 'Enigma', 'Envy', 'Epilogue',
  ...
  const nm4 = ['Rifle', 'Carbine', 'Blaster', 'Fusil', 'Launcher', 'Shooter',
    'Repeater', 'Sniper', 'Longrifle'];
  const nm5 = ['Agent', 'Allegiance', 'Ambassador', 'Annihilation', 'Bearer',
    'Betrayer', 'Blaster', 'Bond', 'Boomstick', 'Boon', 'Breaker', 'Bringer',
    'Bruiser', 'Butcher', 'Call', 'Carbine', 'Carrier', 'Champion',
    'Conqueror', 'Courier', 'Crier', 'Crusader', 'Crusher', 'Cry', 'Cunning',
    'Dawn', 'Defender', 'Defiler', 'Delegate', 'Destroyer', 'Dispatcher',
    'Disposer', 'Emissary', 'Ender', 'Envoy', 'Executioner', 'Favor',
    'Ferocity', 'Foe', 'Fusil', 'Gift', 'Glory', 'Guardian', 'Harbinger',
    'Heirloom', 'Herald', 'Hope', 'Incarnation', 'Last Hope', 'Last Stand',
    'Launcher', 'Legacy', 'Longrifle', 'Memory', 'Messenger', 'Might',
    'Musket', 'Oath', 'Pact', 'Pledge', 'Pounder', 'Promise', 'Prophecy',
    'Protector', 'Queller', 'Ravager', 'Reach', 'Reaper', 'Repeater', 'Rifle',
    'Scepter', 'Sculptor', 'Secret', 'Shooter', 'Shotgun', 'Slayer',
    'Smasher', 'Sniper', 'Soul', 'Suppressor', 'Terror', 'Token', 'Tribute',
  ...
  const nm7 = ['Abomination', 'Agony', 'Allegiance', 'Alpha', 'Amigo',
    'Amnesia', 'Apocalypse', 'Armageddon', 'Ash', 'Ashes', 'Atomic Annie',
    'Baby', 'Battery', 'Battlestar', 'Betrayal', 'Betrayer', 'Big Bertha',
    'Mighty Mouse', 'Betty', 'Quick Fix', 'Swiftscope', 'Bad Medicine',
    'Toots', 'Enterprise', 'Big Rhonda', 'Crowd Control', 'Intervention',
