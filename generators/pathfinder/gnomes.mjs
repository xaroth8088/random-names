export default function gnomes() {
  ...
  const nm1 = ['', '', '', '', 'b', 'br', 'c', 'ch', 'd', 'dr', 'f', 'g', 'gr',
    'h', 'k', 'kr', 'n', 'p', 'q', 'r', 'shm', 't', 'tr', 'v', 'vr', 'z'];
  const nm2 = ['a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i',
    'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i',
    'o', 'u', 'a', 'e', 'i', 'o', 'u', 'ie', 'iu', 'ou', 'ee', 'uo', 'ua'];
  const nm3 = ['b', 'b', 'b', 'br', 'bn', 'ck', 'cr', 'cd', 'dp', 'dq', 'dw',
    'k', 'k', 'k', 'kq', 'kr', 'kw', 'l', 'l', 'l', 'll', 'll', 'lm', 'lz',
    'lb', 'ld', 'm', 'm', 'm', 'mb', 'mz', 'n', 'n', 'n', 'nn', 'nd', 'ndr',
    'ng', 'nt', 'nz', 'nq', 'p', 'p', 'p', 'pq', 'pr', 'r', 'r', 'r', 'rgr',
    'rn', 'rw', 'rz', 'shm', 'sht', 'sn', 'st', 't', 't', 't', 'th', 'tq',
    'tr', 'v', 'v', 'v', 'z', 'z', 'z', 'zz', 'zn'];
  const nm4 = ['', '', '', 'ck', 'd', 'm', 'n', 'nt', 'r', 'rd', 's', 'st', 't',
    'tt', 'x'];
  const nm5 = ['', '', '', '', 'b', 'd', 'f', 'g', 'h', 'l', 'm', 'n', 'p', 'q',
    'r', 's', 'sn', 't', 'tr', 'y', 'v', 'w', 'z'];
  const nm6 = ['a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i',
    'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i',
    'o', 'u', 'a', 'e', 'i', 'o', 'u', 'ue', 'io', 'ie', 'ia', 'ai'];
  const nm7 = ['b', 'b', 'b', 'b', 'bl', 'c', 'c', 'c', 'c', 'd', 'd', 'd', 'f',
    'f', 'f', 'ff', 'ff', 'fl', 'fn', 'fr', 'fl', 'g', 'g', 'g', 'g', 'gn',
    'gg', 'h', 'h', 'h', 'hh', 'hh', 'j', 'j', 'j', 'k', 'k', 'k', 'k', 'kn',
    'kz', 'l', 'l', 'l', 'l', 'l', 'lm', 'ln', 'lz', 'lb', 'lf', 'm', 'm',
    'm', 'm', 'mm', 'mm', 'mz', 'ml', 'mb', 'mp', 'n', 'n', 'n', 'n', 'nn',
    'nk', 'np', 'nz', 'nl', 'ns', 'nk', 'p', 'p', 'p', 'p', 'ph', 'pr', 'pn',
    'r', 'r', 'r', 'r', 'rz', 'rl', 'rs', 'rr', 's', 's', 's', 's', 'sh',
    'sl', 'sn', 'sm', 't', 't', 't', 'th', 'thr', 'tr', 'v', 'v', 'v', 'vr',
    'vl', 'vn', 'x', 'x', 'x', 'z', 'z', 'z', 'z', 'zz', 'zn', 'zl'];
  const nm8 = ['ck', 'g', 'm', 'n', 's', 'sh', 't', 'th'];
  const nm9 = ['', '', '', '', '', 'b', 'bl', 'ch', 'd', 'f', 'fr', 'g', 'gl',
    'gr', 'h', 'j', 'k', 'kl', 'kr', 'm', 'n', 'p', 'q', 'qr', 'r', 's', 'sh',
    't', 'th', 'v', 'w', 'z'];
  const nm10 = ['a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i',
    'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i',
    'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i',
    'o', 'u', 'a', 'e', 'i', 'o', 'u', 'aa', 'ee', 'ae', 'oo', 'ie', 'ua',
    'uo', 'io', 'ia'];
  const nm11 = ['b', 'bbl', 'bl', 'br', 'c', 'cl', 'cn', 'd', 'ddl', 'dl', 'dn',
    'dr', 'df', 'gn', 'g', 'gl', 'ggl', 'gw', 'l', 'lp', 'lf', 'lb', 'ld',
    'ldr', 'lm', 'ln', 'll', 'm', 'mb', 'nd', 'n', 'nc', 'ngn', 'ns', 'nt',
    'nz', 'p', 'pl', 'pp', 'ppl', 'pr', 'pn', 'psw', 'r', 'rl', 'rnd', 'rnf',
    'sn', 'tr', 'th', 'tl', 'ttl', 'v', 'vr', 'w', 'wl', 'z', 'zb', 'zl'];
  const nm12 = ['', '', '', '', '', 'b', 'bs', 'd', 'ck', 'cks', 'g', 'h', 'm',
    'ms', 'n', 'ng', 'r', 'sp', 'ss', 'st', 'th'];
