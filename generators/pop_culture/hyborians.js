function generator$pop_culture$hyborians() {
  ...
  const nm4 = ['a', 'abel', 'acia', 'aedra', 'ameia', 'ana', 'andra', 'antia', 'are', 'ata', 'atea', 'ea', 'ede', 'ele', 'elia', 'elle', 'ena', 'ene', 'enta', 'era', 'eria', 'eta', 'ia', 'iana', 'ianne', 'ice', 'ida', 'idna', 'ige', 'ilia', 'ilis', 'imede', 'ina', 'inome', 'iona', 'ione', 'iope', 'ita', 'ithea', 'ona', 'onia', 'ophile', 'ota', 'uba', 'unda', 'uta', 'ya', 'ydice', 'yne', 'ynia', 'ys'];
  const nm5 = ['Adai', 'Ahe', 'Ama', 'Ao', 'Aonghu', 'Ba', 'Bai', 'Bea', 'Bra', 'Bro', 'Ca', 'Cae', 'Chu', 'Co', 'Cona', 'Concho', 'Conle', 'Conna', 'Crua', 'Cruai', 'Cu', 'Cula', 'Curai', 'Dai', 'Dea', 'Do', 'Domna', 'Doo', 'Duba', 'Ea', 'Eio', 'Eithria', 'Ere', 'Fe', 'Fechi', 'Fio', 'Ga', 'Gae', 'Gi', 'Gia', 'Ima', 'Iu', 'Ke', 'Kea', 'Kee', 'La', 'Lo', 'Lochlai', 'Lu', 'Ma', 'Mala', 'Me', 'Mo', 'Mu', 'Ne', 'Pa', 'Phe', 'Ra', 'Raga', 'Re', 'Ri', 'Ro', 'Rua', 'Sca', 'Si', 'Sloa', 'Sua', 'Ta', 'Tia', 'To', 'Tua'];
  const nm6 = ['bar', 'ch', 'chan', 'char', 'cht', 'chtan', 'chy', 'ddoc', 'dh', 'fer', 'gan', 'gh', 'han', 'l', 'lan', 'lbha', 'ldar', 'll', 'llach', 'llain', 'llan', 'llean', 'lroy', 'ltach', 'ltam', 'lvin', 'mghan', 'mha', 'mon', 'n', 'nal', 'nan', 'ne', 'nlon', 'nn', 'nnet', 'nus', 'nyon', 'r', 'rach', 'rann', 'rc', 'rcan', 'rchad', 'rg', 'rgain', 'rgal', 'rkin', 'rlach', 'rmac', 'rmey', 'rn', 'rnahn', 'rram', 's', 'th', 'thal', 'thchean', 'traic'];
  const nm7 = ['A', 'Ai', 'Be', 'Bi', 'Boa', 'Bri', 'Bria', 'Cai', 'Casi', 'Clio', 'Coma', 'Crei', 'Dai', 'De', 'Dea', 'Do', 'E', 'Ea', 'Ei', 'Erni', 'Fa', 'Fene', 'Fia', 'Fli', 'Go', 'Gra', 'Ka', 'Ke', 'Kea', 'Lia', 'Lui', 'Ma', 'Mae', 'Moni', 'Mu', 'Mui', 'Nao', 'Ne', 'Nea', 'Nia', 'No', 'Rio', 'Ry', 'Rya', 'Sa', 'Sao', 'Sha', 'Sho', 'Si', 'Sio', 'So', 'Ta', 'Tai', 'Tre', 'Tui'];
  const nm8 = ['bhan', 'cey', 'cuma', 'dais', 'dan', 'deen', 'deh', 'dne', 'la', 'le', 'lee', 'lis', 'lla', 'llon', 'llte', 'lma', 'lva', 'mh', 'na', 'nach', 'nda', 'ne', 'neele', 'nia', 'nley', 'nn', 'nne', 'raid', 'rcha', 'reann', 'ren', 'rgreg', 'rine', 'rla', 'rlene', 'rmlaith', 'rra', 'rtis', 'seach', 'ssa', 'van', 've', 'vin', 'vina', 'vy', 'vyn'];
  const nm9 = ['Aba', 'Agu', 'Akhu', 'Ala', 'Ama', 'Amba', 'Ana', 'Ara', 'Arabu', 'Arga', 'Arina', 'Ariu', 'Aru', 'Asu', 'Ba', 'Baa', 'Bai', 'Baru', 'Be', 'Bi', 'Bu', 'Ca', 'Cai', 'Cha', 'Chagu', 'Chi', 'Cho', 'Chu', 'Chua', 'Di', 'Do', 'E', 'Ga', 'Ge', 'Geu', 'Gha', 'Ghu', 'Gu', 'Hu', 'Je', 'Ji', 'Jo', 'Kha', 'Khe', 'Kho', 'Ko', 'Ku', 'Me', 'Mo', 'Na', 'Ne', 'Qori', 'Sa', 'Se', 'Sha', 'Shi', 'Si', 'Su', 'Ta', 'Tai', 'Tama', 'To', 'Togo', 'Tu'];
  const nm10 = ['ban', 'bke', 'bucha', 'bun', 'buqa', 'ccha', 'cenur', 'cha', 'chag', 'char', 'chi', 'chu', 'chugur', 'ci', 'da', 'dagan', 'dai', 'dar', 'de', 'der', 'des', 'du', 'durgu', 'gadai', 'gar', 'gbal', 'ger', 'gh', 'ghagan', 'ghai', 'ghlug', 'ghoril', 'ghtoga', 'gi', 'gibal', 'gra', 'gshin', 'gtemur', 'gter', 'gtomor', 'gu', 'gun', 'har', 'hingor', 'hntomor', 'jam', 'ju', 'ka', 'ke', 'kegei', 'kh', 'kha', 'khatu', 'khii', 'khta', 'kidai', 'kochu', 'ktai', 'kun', 'kunaisi', 'la', 'lagachi', 'laqadar', 'latai', 'ldan', 'legu', 'lge', 'lgetei', 'lig', 'lme', 'lon', 'ltechu', 'ltger', 'ltu', 'lugan', 'lui', 'lun', 'luun', 'mbinai', 'nan', 'nbaatar', 'nbataar', 'nbish', 'nbold', 'ndek', 'ngay', 'nget', 'nggum', 'ngis', 'ngke', 'ngkhai', 'ngkim', 'ngu', 'nkshi', 'nkur', 'nsukh', 'ntomor', 'ntulga', 'nzorig', 'qatai', 'randai', 'rba', 'rbon', 'rdam', 'rdeni', 'rel', 'rgen', 'rghadai', 'rke', 'rkhai', 'rmakhan', 'rtan', 'rtu', 'sai', 'san', 'sar', 'semur', 'sen', 'ser', 'shi ', 'shimur', 'shin', 'slen', 'sun', 'sutei', 'taar', 'tagt', 'tai', 'tei', 'tu', 'tukhan', 'tyan', 'vgai', 'yaga', 'yan', 'yantai', 'yar', 'yuk ', 'zan', 'zhuk'];
  ...
  const nm14 = ['bo', 'chuan', 'dong', 'guo', 'hai', 'hao', 'hua', 'huan', 'jian', 'jin', 'jing', 'k', 'ko', 'li', 'liang', 'lin', 'lun', 'min', 'ming', 'n', 'ncheng', 'nchu', 'nfan', 'ng', 'ngan', 'ngbang', 'ngfei', 'ngge', 'ngguang', 'ngguo', 'nghai', 'nghis', 'nghui', 'ngjie', 'ngkun', 'nglei', 'ngli', 'ngliang', 'nglin', 'ngmeng', 'ngming', 'ngnian', 'ngpei', 'ngpu', 'ngqi', 'ngrui', 'ngshan', 'ngsheng', 'nguang', 'nguo', 'ngwei', 'ngwen', 'ngxiang', 'ngzhe', 'ngzheng', 'ngzhong', 'nhai', 'ning', 'njie', 'njing', 'njun', 'nlai', 'nli', 'nliang', 'nlin', 'nming', 'nsheng', 'nshu', 'nxu', 'nyan', 'nyu', 'nyuan', 'nzhe', 'nzu', 'p', 'qiang', 'qin', 'quiang', 'ren', 'rk', 'rong', 'shan', 'sheng', 'shi', 'si', 'tin', 'ting', 'wan', 'wei', 'wen', 'win', 'xiang', 'xin', 'yi', 'you', 'yu', 'yuan', 'zhe', 'zhi', 'zhou', 'zu'];
