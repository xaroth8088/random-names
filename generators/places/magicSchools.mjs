export default function magicSchools() {
  ...
  const names1 = ['a', 'e', 'i', 'o', 'u', '', '', '', '', '', '', '', '', '',
    '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''];
  const names2 = ['b', 'd', 'k', 'l', 'm', 'n', 'p', 'r', 's', 't', 'b', 'd',
    'f', 'g', 'h', 'k', 'l', 'm', 'n', 'p', 'r', 's', 't', 'v', 'w', 'y', 'z',
    'br', 'dr', 'gr', 'kr', 'pr', 'str', 'tr', 'bl', 'cl', 'fl', 'gl', 'kl',
    'pl', 'sl'];
  const names3 = ['a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'ae', 'ea',
    'ou', 'au', 'a', 'e', 'o'];
  const names4 = ['d', 'f', 'g', 'k', 'l', 'm', 'n', 'p', 'r', 's', 't', 'x'];
  const names5 = ['w', 'n', 's', 'm', 'r', '', '', '', '', '', '', ''];
  const names6 = ['any', 'arry', 'arth', 'arths', 'arts', 'elts', 'erra',
    'erry', 'erth', 'eth', 'iams', 'ia', 'iara', 'ine', 'inns', 'iths',
    'iton', 'ity', 'onia', 'ons', 'ora', 'ore', 'orth', 'orths', 'ose', 'yce'];
  const names7 = ['Academy of Sorcery', 'Academy of Spells',
    'Academy of Magics', 'Academy of Witchcraft', 'Academy of Wizardry',
