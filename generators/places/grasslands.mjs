export default function grasslands() {
  ...
  const names1 = ['White', 'Black', 'Brown', 'Gray', 'Majestic', 'Pygmy', 'Little', 'Giant', 'Northern', 'Southern', 'Eastern', 'Western', 'Greater', 'Lesser', 'Masked', 'Grass', 'Water', 'Common', 'Mountain', 'Prairie', 'Grassland', 'Taiga', 'Tundra', 'Savanna', 'Alpine', 'Collared', 'Grand', 'Pacific', 'Oriental', 'Spotted', 'Speckled', 'Striped', 'Dotted', 'Rusty', 'Maned', 'Cloud', 'Long-tailed', 'Short-tailed', 'Crowned', 'Golden', 'Imperial', 'Royal', 'Noble', 'Laughing', 'Lined', 'Banded', 'Snow', 'Ivory', 'Ebony', 'Wild', 'Reagal'];
  const names2 = ['Aardvark', 'Alpaca', 'Anaconda', 'Ant', 'Anteater', 'Antelope', 'Armadillo', 'Baboon', 'Badger', 'Bandicoot', 'Bat', 'Bear', 'Bee', 'Beetle', 'Bird', 'Bison', 'Boa', 'Buffalo', 'Butterfly', 'Buzzard', 'Caterpillar', 'Chipmunk', 'Cobra', 'Cougar', 'Coyote', 'Crane', 'Cricket', 'Crow', 'Deer', 'Dingo', 'Dove', 'Duck', 'Eagle', 'Elephant', 'Elk', 'Fox', 'Frog', 'Gazelle', 'Grasshopper', 'Groundhog', 'Hawk', 'Hedgehog', 'Hyena', 'Jackal', 'Kangaroo', 'Ladybug', 'Lion', 'Meerkat', 'Mouse', 'Rabbit', 'Rat', 'Raven', 'Rhino', 'Snake', 'Toad', 'Tortoise', 'Warthog', 'Wasp', 'Weasel', 'Wild Dog'];

  const names3 = ['Grasslands', 'Grassland', 'Savanna', 'Pastures', 'Plains', 'Prairie', 'Steppe', 'Range', 'Fields', 'Meadow', 'Gardens', 'Terrain', 'Territory', 'Expanse', 'Plateau', 'Valley'];
  const names4 = ['Abandoned', 'Awesome', 'Beautiful', 'Big', 'Blooming', 'Blossoming', 'Broken', 'Calm', 'Colossal', 'Creepy', 'Curious', 'Deep', 'Deserted', 'Detailed', 'Dramatic', 'Dry', 'Earthy', 'Elegent', 'Enchanted', 'Exclusive', 'Faint', 'Fancy', 'Free', 'Gentle', 'Giant', 'Gigantic', 'Glistening', 'Glorious', 'Gorgeous', 'Green', 'Groovy', 'Healthy', 'Heavenly', 'High', 'Hissing', 'Hollow', 'Huge', 'Incredible', 'Jaded', 'Jagged', 'Light', 'Little', 'Lively', 'Lonely', 'Luscious', 'Lush', 'Magical', 'Magnificent', 'Majestic', 'Mammoth', 'Marvelous', 'Massive', 'Mellow', 'Mighty', 'Misty', 'Moldy', 'Mysterious', 'Narrow', 'Old', 'Panoramic', 'Parallel', 'Peaceful', 'Plain', 'Pleasant', 'Precious', 'Private', 'Quiet', 'Rainy', 'Reflecting', 'Romantic', 'Rotten', 'Round', 'Royal', 'Sacred', 'Scattered', 'Secret', 'Shimmering', 'Sickly', 'Simple', 'Special', 'Spectacular', 'Spiritual', 'Stormy', 'Teeny', 'Terrible', 'Terrific', 'Thick', 'Thin', 'Thundering', 'Tiny', 'Unknown', 'Violent', 'Violet', 'Wandering', 'Whimsical', 'Whispering', 'Wicked', 'Wild', 'Windy', 'Young'];

  const names5 = ['b', 'br', 'bl', 'c', 'cl', 'cr', 'd', 'dr', 'f', 'fr', 'fl', 'g', 'gr', 'gl', 'gn', 'h', 'j', 'k', 'kr', 'kl', 'kn', 'm', 'n', 'p', 'pr', 'pl', 'q', 'qr', 'ql', 'r', 's', 'st', 'sr', 'str', 'sl', 't', 'tr', 'tl', 'v', 'vl', 'vr', 'w', 'wr', 'x', 'z', '', '', '', '', ''];
  const names6 = ['a', 'e', 'i', 'o', 'u', 'y'];
  const names7 = ['b', 'c', 'd', 'f', 'g', 'h', 'j', 'k', 'l', 'm', 'n', 'p', 'q', 'r', 's', 't', 'v', 'w', 'x', 'z', '', '', '', '', '', ''];
  const names8 = ['a', 'e', 'i', 'o', 'u', 'y'];
  const names9 = ['b', 'd', 'g', 'gh', 'h', 'hr', 'hs', 'ht', 'hst', 'hsh', 'hn', 'hm', 'hl', 'hz', 'hx', 'hq', 'k', 'ks', 'kx', 'l', 'll', 'lk', 'ln', 'lm', 'lz', 'lp', 'lt', 'ls', 'lst', 'lf', 'm', 'mn', 'mm', 'mt', 'ms', 'n', 'nn', 'nt', 'ns', 'p', 'ps', 'pt', 'ph', 'q', 'r', 'rs', 'rt', 'rst', 'rq', 'rk', 'rc', 'rf', 'rb', 'rd', 's', 'st', 'ss', 'sh', 'sk', 'sp', 't', 'th', 'ts', 'w', 'wth', 'x', 'z'];
