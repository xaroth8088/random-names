export default function banks() {
  ...
  let rnd2;
  let names;
  const nm1 = ['Bancorp', 'Bancshares', 'Bank', 'Bank Corp.', 'Bank Group', 'Bank Inc.', 'Bank System', 'Banks', 'Banks Inc.', 'Corporation', 'Credit Union', 'Financial', 'Financial Corp.', 'Financial Group', 'Financial Holdings', 'Financial Inc.', 'Financial Services', 'Holding Company', 'Holdings', 'Holdings Inc.', 'Trust', 'Trust Corp.'];
