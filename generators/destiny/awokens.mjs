export default function awokens() {
  ...
  const nm2 = ['a', 'a', 'u', 'u', 'e', 'i', 'a', 'a', 'u', 'u', 'e', 'i', 'a',
    'a', 'u', 'u', 'e', 'i', 'oo', 'ou', 'uu', 'aa'];
  const nm3 = ['d', 'dr', 'g', 'gd', 'gr', 'h', 'j', 'ldr', 'lgr', 'ndr', 'ngr',
    'q', 'r', 'rg', 'rj', 'sg', 'v', 'vg', 'x', 'z', 'zg'];
  const nm4 = ['c', 'ch', 'g', 'l', 'n', 'x', 'z'];
  const nm5 = ['f', 'l', 'm', 'n', 'p', 'ph', 's', 't', 'th', 'v', 'z'];
  const nm6 = ['e', 'e', 'a', 'a', 'i', 'o', 'e', 'e', 'a', 'a', 'i', 'o', 'e',
    'e', 'a', 'a', 'i', 'o', 'ia', 'ua', 'ea', 'aa'];
  const nm7 = ['l', 'lm', 'ln', 'lr', 'm', 'mm', 'mn', 'n', 'nn', 'r', 'rh',
    'rl', 'rm', 'rn', 'rr', 'rt', 'sr', 'ss', 'tr', 'x', 'y', 'z'];
  const nm8 = ['f', 'n', 'nn', 'ph', 's', 'ss', 'sh', 'x'];
  const nm9 = ['c', 'g', 'j', 'm', 'q', 's', 'th', 'v', 'x', 'z'];
  const nm10 = ['a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'aa'];
  const nm11 = ['d', 'f', 'h', 'j', 'k', 'l', 'm', 'n', 'q', 'r', 'sh', 'v',
    'z'];
