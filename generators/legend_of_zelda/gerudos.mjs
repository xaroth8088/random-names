export default function gerudos() {
  ...
  const nm2 = ['a', 'e', 'i', 'o', 'u'];
  const nm3 = ['b', 'd', 'f', 'g', 'l', 'm', 'n', 'r', 't', 'v', 'z', 'b', 'd',
    'f', 'g', 'l', 'm', 'n', 'r', 't', 'v', 'z', 'b', 'd', 'f', 'g', 'l', 'm',
    'n', 'r', 't', 'v', 'z', 'b', 'd', 'f', 'g', 'l', 'm', 'n', 'r', 't', 'v',
    'z', 'b', 'd', 'f', 'g', 'l', 'm', 'n', 'r', 't', 'v', 'z', 'br', 'bl',
    'dr', 'dl', 'fl', 'fn', 'fm', 'fr', 'gr', 'gn', 'gm', 'lb', 'ld', 'lg',
    'lm', 'ln', 'lr', 'lt', 'lz', 'mb', 'md', 'ml', 'mn', 'mr', 'nb', 'nd',
    'ng', 'nl', 'nm', 'nr', 'nz', 'rb', 'rd', 'rg', 'rl', 'rm', 'rn', 'rt',
    'rs', 'tl', 'tm', 'tn', 'tr', 'vl', 'vm', 'zl'];
  const nm4 = ['g', 'l', 'lm', 'ln', 'm', 'n', 'r', 'rf', 'rg', 'rn', 'rm',
    'rt', 'ng'];
  const nm5 = ['', '', '', '', 'k', 'n', 'm', 'l', 't', 's', 'f', 'g', 'h',
    'r'];
  const nm6 = ['a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i',
    'o', 'u', 'a', 'e', 'i', 'o', 'u', 'a', 'e', 'i', 'o', 'u', 'ei', 'ea',
